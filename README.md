...
*Edited: 2024.01.08、2024.03.02、2024.03.10、2024.04.10*
...
2. 次要词性：给出 1 个最相关的汉语翻译，以免对次要的词类一无所知。如果还有第三个词性，也遵循这个规则。
...
2. 次要词性：给出 1 个最相关的汉语翻译，以免对次要的词类一无所知。如果还有第三个词性，也遵循这个规则。
#### 4. 示例列：
- 英文例句和中文翻译之间添加 `<br>`换行符。当单词的词性大于 1 个时，英文句子前添加相对应的词性简写。比如 noun 写成 n. 、verb 简写成 v. 
