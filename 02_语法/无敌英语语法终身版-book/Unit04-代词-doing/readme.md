...
| ---- | ---- | ---- | ---- | ---- | ---- |
| something | somebody `/ˈsʌmbɑːdi/` | someone | anything | anybody | anyone |
| nothing | nobody ` /ˈnoʊbɑːdi/` | none | both | either | neither |
...
> | --- | --- | --- | --- | --- | --- | --- |
> | both | `/boʊθ/` | Pronoun, determiner - 代词，限定词 | 两个都；两者都 | 表示“两个都；两者都”的意思，常用于描述两个或两个以上的人、事物或概念。 | both...and... （既...又...）| Both of my parents like to cook.（我父母两个都喜欢做饭。） |
