...
#### (5) 当 whom 跟在介词后面时，不能用 who 来代替。但是，当介词位于句尾 时，可以用 who 代替 whom。比较下面的句子：
...
all、each、every、everything、everybody、everyone、something、somebody、someone、anything、anybody、anyone、nothing 、nobody、none、、both、either、neither、one other、another、some、any、no、many、much、(a) little、(a) few 
