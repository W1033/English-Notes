...
> | 用法 | 表达                                   | 示例             |
> | ---- | -------------------------------------- | ---------------- |
> | 时间 | **"in" 用于较长的时间段。**            | in the morning   |
> |      | **"on" 用于具体的日子或日期。**        | on Monday        |
> |      | **"at" 用于具体的时间点。**            | at 5 o'clock     |
> | 地点 | **"in" 用于较大的区域或封闭空间。**    | in New York      |
> |      | **on" 用于表面、公共交通工具或街道。** | on the table     |
> |      | **"at" 用于具体的地点或活动地点。**    | at the door^(2)^ |
>
> (2) "At the door" 的意思是“在门口”或“在门边”。使用 "at" 是因为 "at" 用于表示具体的位置或地点。具体来说，"at" 表示某个点或位置，不强调它的内部或表面。
>
...
>
> <img src="./ReadMe.assets/640.png" alt="图片" style="zoom:50%;" />
>
