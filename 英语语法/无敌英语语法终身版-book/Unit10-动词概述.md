...
**系动词在句子中不能单独作谓语，它后面必须接表语，系动词与表语构成系表结构**。最常用的系动词是 be, 但是句子中很少出现 be，它一般是随着时态和主语人称的不同，变成不同的形式：**is, am, are, was, were, been**.
...
另外，be 也是助动词，可以帮助构成各种时态和被动语态，在有关时态、语 态的章节中将会详细论述。(详见：`unit12-助动词和情态动词.md`)
