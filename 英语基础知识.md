...
| 单词         | 美式发音           | 词类 + 汉语释义           | 例句                                                         |
| ------------ | ------------------ | ------------------------- | ------------------------------------------------------------ |
| plural       | `/ˈplʊrəl/`        | n. 复数；adj. 复数的      | → What is the plural of Man, Tom? <br/>汤姆, "男人" 这个词的复数形式是什么？<br />→ We use "those`/ðoz/`" and "these`/ðiːz/`" with plural nouns.<br/>我们用 "those" and "these" 去修饰复数名词. |
| noun         | `/naʊn/`           | n. 名词                   | → In English, we can use nouns to modify other nouns. <br/>在英语里面, 我们可以用名词来修饰名词. |
| verb         | `/vɜːrb/`          | n. 动词                   | → verb phrase 动词短语<br />→ How does this verb conjugate` /ˈˈkɑːndʒəɡeɪt/`?<br /> 这个动词有哪些词形变化？ |
| adjective    | `/ˈædʒəktɪv/`      | n. 形容词                 |                                                              |
| adverb       | `/ˈædvɜːrb/`       | n. 副词                   |                                                              |
| ==article==  | `/ˈɑːrtɪkl/`       | n. 冠词；文章；条款；论文 |                                                              |
| numeral      | `/ˈnjuːmərəl/`     | n. 数字；数词             |                                                              |
| interjection | `/ˌɪntərˈdʒɛkʃən/` | n. 感叹词                 |                                                              |
| pronoun      | `/ˈproʊnaʊn/`      | n. 代词                   |                                                              |
| conjunction  | `/kənˈdʒʌŋkʃən/`   | n. 连词                   |                                                              |
| participle   | `/ˈpɑːrtɪsɪpl/`    | n. 分词                   |                                                              |
| partial      | `/ˈpɑːrʃəl/`       | adj. 部分的；偏袒的       |                                                              |
| objective    | `/əbˈdʒɛktɪv/`     | adj. 客观的；n. 目标      |                                                              |
| indication   | `/ˌɪndɪˈkeɪʃən/`   | n. 指示；迹象             |                                                              |
