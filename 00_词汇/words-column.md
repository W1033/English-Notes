...
| generation    | `/ˌdʒɛnəˈreɪʃən/`       | n. 一代；产生             |
| chunk         | `/tʃʌŋk/`               | n. 大块；大量 ✅           |
...
| slaughter     | `/ˈslɔtər/`          | n. 屠宰；屠杀<br>v. 屠宰；屠杀        |
...
| idle          | `/ˈaɪdəl/`          | adj. 空闲的；闲置的<br>v. 虚度 |
...
| engagement    | `/ɪnˈɡeɪdʒmənt/`  | n. 订婚；约定；交战 ✅       |
...
| duo           | `/ˈduoʊ/`            | n. 二重唱；二人组                         |
| leaves        | `/livz/`             | n. 叶子（复数）                          |
| flat          | `/flæt/`             | adj. 平的；单调的 <br>n. 公寓 <br>adv. 平直地 |
...
| goof          | `/ɡuf/`              | v. 搞砸；闲荡<br>n. 愚蠢的错误   |
| receipt       | `/rɪˈsit/`           | n. 收据；收到               |
| resilience    | `/rɪˈzɪliəns/`       | n. 恢复力；弹性              |
| mad           | `/mæd/`              | adj. 疯狂的；恼火的           |
| coalition     | `/ˌkoʊəˈlɪʃən/`      | n. 联盟；联合               |
| freight       | `/freɪt/`            | n. 货运；货物 <br>v. 运送货物  ✅ |
| warrant       | `/ˈwɔrənt/`          | n. 授权令；许可证 <br>v. 使有必要；保证 ✅ |
| carnival      | `/ˈkɑrnəvəl/`        | n. 狂欢节；嘉年华        ✅    |
| stout         | `/staʊt/`            | adj. 矮胖的；结实的 <br>n. 烈性啤酒 ✅ |
...
| worth             | `/wɜrθ/`                 | adj. 值得的；有价值的<br>n. 价值     |
| joint             | `/dʒɔɪnt/`               | adj. 联合的；共同的<br>n. 关节；接头 ✅ |
| knitting          | `/ˈnɪtɪŋ/`               | n. 编织物；编织                  |
| dilemma           | `/dɪˈlɛmə/`              | n. 困境；进退两难                 |
| janitor           | `/ˈdʒænɪtər/`            | n. 看门人；管理员                 |
...
| 单词         | 美式发音               | 词性 + 汉语释义                 |
|------------|--------------------|---------------------------|
| intent     | `/ɪnˈtɛnt/`        | adj. 专心的；坚决的 <br>n. 意图  ✅ |
| entire     | `/ɪnˈtaɪər/`       | adj. 全部的；整个的              |
| ray        | `/reɪ/`            | n. 光线；射线                  |
| needy      | `/ˈnidi/`          | adj. 贫困的；缺乏的              |
| sadly      | `/ˈsædli/`         | adv. 悲伤地；遗憾地              |
| yard       | `/jɑrd/`           | n. 院子；码                   |
...
| enter      | `/ˈɛntər/`         | v. 进入；登录                  |
| tag        | `/tæɡ/`            | n. 标签；附加语<br>v. 加标签       |
| attraction | `/əˈtrækʃən/`      | n. 吸引力；吸引物                |
| condition  | `/kənˈdɪʃən/`      | n. 条件；状况<br>v. 决定；使习惯于    |
| curiosity  | `/ˌkjʊriˈɑsəti/`   | n. 好奇心；珍品                 |
| gate       | `/ɡeɪt/`           | n. 大门；登机口                 |
...
| seal         | `/siːl/`          | n. 海豹；封印<br>v. 密封；盖章       | n. The seal swam gracefully in the water. <br>(海豹在水中优雅地游泳。)<br>n. The document had a royal seal. <br>(文件上有一个皇室封印。)<br>v. She used tape to seal the package. <br>(她用胶带密封包裹。)<br>v. The contract was sealed with a stamp. <br>(合同上盖了章。) |
...
| method      | `/ˈmɛθəd/`                                    | n. 方法                      |
| abstract    | `/ˈæbstrækt/`(n. & adj.)<br>`/æbˈstrækt/`(v.) | n. 摘要<br>adj. 抽象的<br>v. 提取 |
| postfix     | `/ˈpoʊstˌfɪks/`                               | n. 后缀                      |
| execute     | `/ˈɛksɪˌkjut/`                                | v. 执行                      |
| extract     | `/ˈɛkstrækt/`(n.)<br>`/ɪkˈstrækt/`(v.)        | n. 提取物<br>v. 提取            |
| except      | `/ɪkˈsɛpt/`                                   | prep. 除…之外                 |
| reformat    | `/ˌriˈfɔrmæt/`                                | v. 重新格式化                   |
| wildcard    | `/ˈwaɪldˌkɑrd/`                               | n. 通配符                     |
| scroll      | `/skroʊl/`                                    | n. 卷轴<br>v. 滚动             |
| inheritance | `/ɪnˈhɛrɪtəns/`                               | n. 遗产                      |
| ledge       | `/lɛdʒ/`                                      | n. 窗台                      |
...
| 单词             | 美式发音                   | 词性 + 汉语释义                    |
|----------------|------------------------|------------------------------------|
| insistent      | `/ɪnˈsɪstənt/`         | adj. 坚持的；持续不断的             |
...
| resort         | `/rɪˈzɔrt/`            | n. 度假胜地<br>v. 诉诸              |
| slit           | `/slɪt/`               | n. 狭缝<br>v. 切开                  |
| steal          | `/stil/`               | v. 偷窃                             |
| lean           | `/lin/`                | adj. 瘦的<br>v. 倾斜                |
| toss           | `/tɔs/`                | v. 扔<br>n. 投掷                    |
...
| tow            | `/toʊ/`                | v. 拖<br>n. 拖                      |
| row            | `/roʊ/` (n.)<br>`/raʊ/` (v.) | n. 一行；划船<br>v. 划船         |
...
| slip            | `/slɪp/`                 | v. 滑倒；滑落<br>n. 滑倒       |
| slurry          | `/ˈslɜːri/`              | n. 浆料；泥浆                |
| hereabouts      | `/ˌhɪərəˈbaʊts/`         | adv. 在附近                |
| bristle         | `/ˈbrɪsəl/`              | n. 刚毛<br>v. 竖起          |
| ward            | `/wɔrd/`                 | n. 病房；监护                |
| pastor          | `/ˈpæstər/`              | n. 牧师                   |
...
| preview    | `/ˈpriːvjuː/`    | n. 预览；预告<br>v. 预览；预习 ✅ |
...
好的，我会继续根据“简洁性”和“全面性”之间的平衡原则来更新以下表格。

| 单词        | 美式发音             | 词性 + 汉语释义            |
|-------------|--------------------|----------------------|
| scourge     | `/skɜrdʒ/`         | n. 灾祸；鞭子<br>v. 折磨    |
| charcoal    | `/ˈʧɑrˌkoʊl/`      | n. 木炭；炭笔             |
| rogue       | `/roʊɡ/`           | n. 流氓；无赖<br>adj. 离群的 |
| mortal      | `/ˈmɔrtəl/`        | adj. 致命的<br>n. 凡人    |
| rightful    | `/ˈraɪtfəl/`       | adj. 合法的             |
| payback     | `/ˈpeɪˌbæk/`       | n. 回报                |
| skeptical   | `/ˈskɛptɪkəl/`     | adj. 怀疑的             |
| peek        | `/pik/`            | v. 偷看<br>n. 偷看       |
| teardown    | `/ˈtɛrˌdaʊn/`      | n. 拆卸                |
...
| shuttle     | `/ˈʃʌtəl/`         | n. 班车<br>v. 穿梭往返     |
| grade       | `/ɡreɪd/`          | n. 年级；等级<br>v. 分级    |
| illuminate  | `/ɪˈlumɪˌneɪt/`    | v. 照亮                |
...
| 单词             | 美式发音             | 词性 + 汉语释义                  |
|----------------|----------------------|----------------------------------|
| regrettable    | `/rɪˈɡrɛtəbəl/`      | adj. 令人遗憾的；可惜的           |
| locate         | `/ˈloʊˌkeɪt/`        | v. 定位；找到                    |
| frame          | `/freɪm/`            | n. 框架；结构<br>v. 装框；陷害    |
| forensic       | `/fəˈrɛnsɪk/`        | adj. 法医的；法庭的              |
| simultaneity   | `/ˌsaɪməlˌtæˈniəti/` | n. 同时发生                      |
| arc            | `/ɑrk/`              | n. 弧；弧形                      |
| easel          | `/ˈiːzəl/`           | n. 画架                          |
| cabinet        | `/ˈkæbɪnɪt/`         | n. 内阁；橱柜                    |
| cupboard       | `/ˈkʌbərd/`          | n. 碗柜；橱柜                    |
| wardrobe       | `/ˈwɔrˌdroʊb/`       | n. 衣柜；全部衣物                |
| academia       | `/ˌækəˈdiːmiə/`      | n. 学术界                        |
| eggshell       | `/ˈɛɡˌʃɛl/`          | n. 蛋壳                          |
| emotion        | `/ɪˈmoʊʃən/`         | n. 情感；情绪                    |
| rollercoaster  | `/ˈroʊlərˌkoʊstər/`  | n. 过山车；大起大落              |
| cue            | `/kju/`              | n. 暗示；提示<br>v. 给...暗示      |
| pricey         | `/ˈpraɪsi/`          | adj. 昂贵的                      |
| pasty          | `/ˈpeɪsti/`          | adj. 苍白的；面糊似的<br>n. 馅饼     |
...
| 单词            | 美式发音              | 词性 + 汉语释义              |
|---------------|----------------------|------------------------|
| revolution    | `/ˌrɛvəˈluʃən/`      | n. 革命；旋转               |
| diagnostic    | `/ˌdaɪəɡˈnɑstɪk/`    | adj. 诊断的<br>n. 诊断工具    |
| literacy      | `/ˈlɪtərəsi/`        | n. 读写能力                |
| individual    | `/ˌɪndɪˈvɪdʒuəl/`    | adj. 个人的；个别的<br>n. 个人  |
| numerous      | `/ˈnumərəs/`         | adj. 许多的               |
| drunk         | `/drʌŋk/`            | adj. 喝醉的<br>n. 醉汉      |
| sake          | `/seɪk/`             | n. 缘故；目的               |
| meanwhile     | `/ˈminˌwaɪl/`        | adv. 同时；其间             |
| cancel        | `/ˈkænsəl/`          | v. 取消                  |
| merchandise   | `/ˈmɜrtʃənˌdaɪs/`    | n. 商品<br>v. 买卖         |
| minimalistic  | `/ˌmɪnɪməˈlɪstɪk/`   | adj. 极简主义的             |
| customize     | `/ˈkʌstəˌmaɪz/`      | v. 定制                  |
| customizable  | `/ˈkʌstəˌmaɪzəbəl/`  | adj. 可定制的              |
| dramatical    | `/drəˈmætɪkəl/`      | adj. 戏剧性的              |
| repetitive    | `/rɪˈpɛtɪtɪv/`       | adj. 重复的               |
| miscellaneous | `/ˌmɪsəˈleɪniəs/`    | adj. 各种各样的             |
| pony          | `/ˈpoʊni/`           | n. 小马                  |
...
| 单词           | 美式发音                   | 词性 + 汉语释义                    |
|----------------|------------------------|------------------------------------|
| disregard      | `/ˌdɪsrɪˈɡɑrd/`        | v. 忽视；不理会<br>n. 忽视；漠视       |
| rove           | `/roʊv/`               | v. 漫游；流浪<br>n. 漫游；流浪        |
| identify       | `/aɪˈdɛntɪˌfaɪ/`       | v. 识别；认出；鉴定                 |
| venom          | `/ˈvɛnəm/`             | n. 毒液；恶意                       |
| weld           | `/wɛld/`               | v. 焊接；使结合<br>n. 焊接          |
| flip flop      | `/ˈflɪpˌflɑp/`         | n. 人字拖；反复无常                 |
...
| pastime        | `/ˈpæˌstaɪm/`          | n. 消遣；娱乐                       |
| athletic       | `/æθˈlɛtɪk/`           | adj. 运动的；健壮的                  |
| gymnasium      | `/dʒɪmˈneɪziəm/`       | n. 体育馆；健身房                   |
| talkie         | `/ˈtɔːki/`             | n. 有声电影                         |
| secure         | `/sɪˈkjʊr/`            | v. 保证；获得；使安全<br>adj. 安全的   |
| secured        | `/sɪˈkjʊrd/`           | adj. 有担保的；固定的               |
| vocational     | `/voʊˈkeɪʃənl/`        | adj. 职业的                         |
| prestigious    | `/prɛˈstɪdʒəs/`        | adj. 有声望的；有威信的              |
...
| 单词           | 美式发音                | 词性 + 汉语释义                      |
|----------------|---------------------|--------------------------------------|
| lust           | `/lʌst/`            | n. 强烈的欲望；色欲<br>v. 渴望         |
| territory      | `/ˈtɛrɪˌtɔri/`      | n. 领土；领域                       |
| calendar       | `/ˈkælɪndər/`       | n. 日历；行事历                     |
| robust         | `/roʊˈbʌst/`        | adj. 强壮的；坚定的                 |
| robustness     | `/roʊˈbʌstnəs/`     | n. 强健；稳固性                     |
| absurd         | `/əbˈsɜrd/`         | adj. 荒谬的；可笑的                 |
| patently       | `/ˈpeɪtəntli/`      | adv. 明显地；公然地                 |
| capable        | `/ˈkeɪpəbl/`        | adj. 有能力的；能干的                |
| clue           | `/klu/`             | n. 线索；提示                       |
| misty          | `/ˈmɪsti/`          | adj. 多雾的；模糊的                 |
| low            | `/loʊ/`             | adj. 低的；矮的<br>adv. 低声地       |
| fierce         | `/fɪrs/`            | adj. 凶猛的；激烈的                 |
| consultant     | `/kənˈsʌltənt/`     | n. 顾问                            |
| whore          | `/hɔr/`             | n. 妓女                            |
| lecture        | `/ˈlɛkʧər/`         | n. 讲座；训斥<br>v. 演讲；训斥       |
| polytechnic    | `/ˌpɑliˈtɛknɪk/`    | n. 理工学院                        |
| prospective    | `/prəˈspɛktɪv/`     | adj. 预期的；未来的                 |
| pride          | `/praɪd/`           | n. 自豪；骄傲                      |
| prejudice      | `/ˈprɛʤədɪs/`       | n. 偏见<br>v. 使有偏见               |
| possessive     | `/pəˈzɛsɪv/`        | adj. 占有的；占有欲强的              |
| even           | `/ˈivən/`           | adj. 平坦的；均匀的<br>adv. 甚至；更   |
| advisable      | `/ədˈvaɪzəbl/`      | adj. 明智的；可取的                 |
| imperative     | `/ɪmˈpɛrətɪv/`      | adj. 必要的；命令的<br>n. 必要的事    |
...
| defective      | `/dɪˈfɛktɪv/`                  | adj. 有缺陷的                        |
| machine        | `/məˈʃin/`                     | n. 机器                             |
| winner         | `/ˈwɪnər/`                     | n. 获胜者                           |
| toothpaste     | `/ˈtuθˌpeɪst/`                 | n. 牙膏                             |
| ain‘t          | `/eɪnt/`                       | contraction. 不是；没有               |
| northern       | `/ˈnɔrðərn/`                   | adj. 北方的                          |
| absurd         | `/əbˈsɜrd/`                    | adj. 荒谬的；可笑的                   |
| tumble         | `/ˈtʌmbəl/`                    | v. 摔倒；翻滚<br>n. 摔倒；混乱          |
| tumble over    | `/ˈtʌmbəl ˈoʊvər/`             | phr. 摔倒；跌倒                      |
| snowflake      | `/ˈsnoʊˌfleɪk/`                | n. 雪花                             |
| finite         | `/ˈfaɪˌnaɪt/`                  | adj. 有限的                          |
| outlet         | `/ˈaʊtˌlɛt/`                   | n. 出口；发泄途径；经销店              |
| sophisticated  | `/səˈfɪstɪˌkeɪtɪd/`            | adj. 复杂的；老练的                   |
| mischief       | `/ˈmɪsʧɪf/`                    | n. 恶作剧；淘气                       |
...
| 单词               | 美式发音                     | 词性 + 汉语释义                      |
|--------------------|--------------------------|--------------------------------------|
| speechify          | `/ˈspiːtʃɪfaɪ/`          | v. 高谈阔论                          |
| punctuation        | `/ˌpʌŋktʃuˈeɪʃən/`       | n. 标点符号；标点法                  |
| lawyer             | `/ˈlɔjər/`               | n. 律师                              |
| turmeric           | `/ˈtɜːrmərɪk/`           | n. 姜黄                              |
| curcumin           | `/ˈkɜrkjuˌmɪn/`          | n. 姜黄素                            |
| rhizome            | `/ˈraɪzoʊm/`             | n. 根茎                              |
| earthy             | `/ˈɜrθi/`                | adj. 泥土的；质朴的                   |
| aroma              | `/əˈroʊmə/`              | n. 芳香                              |
| curry              | `/ˈkʌri/`                | n. 咖喱                              |
| renown             | `/rɪˈnaʊn/`              | n. 名望；声誉                        |
| potent             | `/ˈpoʊtnt/`              | adj. 强有力的；有效的                 |
...
| digestive          | `/daɪˈʤɛstɪv/`           | adj. 消化的；助消化的                 |
...
| 单词      | 美式发音            | 词性 + 汉语释义                    |
|-----------|---------------------|-----------------------------------|
| excessive | `/ɪkˈsɛsɪv/`        | adj. 过多的；过分的                  |
| stand     | `/stænd/`           | v. 站立；忍受<br>n. 立场；摊位         |
| taxation  | `/tækˈseɪʃən/`      | n. 税收；征税                      |
| medieval  | `/ˌmɛdɪˈivəl/`      | adj. 中世纪的                      |
| retail    | `/ˈriːteɪl/`        | n. 零售<br>v. 零售                  |
| Arctic    | `/ˈɑːrktɪk/`        | adj. 北极的<br>n. 北极              |
| combat    | `/ˈkɑːmbæt/`        | n. 战斗；斗争<br>v. 战斗；反对        |
| request   | `/rɪˈkwɛst/`        | n. 请求；要求<br>v. 请求；要求        |
| prefer    | `/prɪˈfɜr/`         | v. 更喜欢；宁愿                    |
| omission  | `/oʊˈmɪʃən/`        | n. 遗漏；省略                      |
| ginger    | `/ˈdʒɪndʒər/`       | n. 姜；姜黄色<br>adj. 姜黄色的          |
| herbal    | `/ˈɜrbəl/`          | adj. 草本的；草药的                  |
| linguistic| `/lɪŋˈɡwɪstɪk/`     | adj. 语言的；语言学的                |
| camp      | `/kæmp/`            | n. 营地；阵营<br>v. 露营             |
| camping   | `/ˈkæmpɪŋ/`         | n. 露营                             |
| admit     | `/ədˈmɪt/`          | v. 承认；允许进入                    |
| indicate  | `/ˈɪndɪˌkeɪt/`      | v. 表明；指出                       |
| bliss     | `/blɪs/`            | n. 极乐；幸福                       |
| uncertain | `/ʌnˈsɜrtən/`       | adj. 不确定的；无常的                |
...
| incredible     | `/ɪnˈkrɛdəbəl/`         | adj. 难以置信的；极好的             |
| computation    | `/ˌkɑmpjəˈteɪʃən/`      | n. 计算                            |
| computational  | `/ˌkɑmpjəˈteɪʃənəl/`    | adj. 计算的；计算机的                |
| oomph          | `/ʊmf/`                 | n. 魅力；活力                      |
| saucepan       | `/ˈsɔːspæn/`            | n. 平底锅                          |
...
| token          | `/ˈtoʊkən/`             | n. 象征；代币<br>adj. 象征性的       |
| surrender      | `/səˈrɛndər/`           | v. 投降；放弃<br>n. 投降；屈服       |
| yeast          | `/jist/`                | n. 酵母                            |
| sourdough      | `/ˈsaʊrdoʊ/`            | n. 酸面团                          |
| pancake        | `/ˈpænˌkeɪk/`           | n. 煎饼                            |
| down           | `/daʊn/`(adv.)<br>`/daʊn/`(n.) | adv. 向下；在下面<br>n. 绒毛         |
...
| institutional    | `/ˌɪnstɪˈtuːʃənl/`    | adj. 机构的；制度的                |
| via              | `/ˈvaɪə/`             | prep. 通过；经由                   |
| counsel          | `/ˈkaʊnsəl/`          | n. 忠告；律师<br>v. 劝告            |
| throw            | `/θroʊ/`              | v. 扔；投掷<br>n. 投掷             |
| toss             | `/tɔs/`               | v. 扔；抛<br>n. 扔；抛              |
| obstacle         | `/ˈɑbstəkəl/`         | n. 障碍                           |
| conserve         | `/kənˈsɜrv/`          | v. 保存；保护                      |
| floor            | `/flɔr/`              | n. 地板；楼层<br>v. 使惊讶；击倒    |
| slippery         | `/ˈslɪpəri/`          | adj. 滑的                         |
| ample            | `/ˈæmpəl/`            | adj. 丰富的；宽敞的                |
| turmoil          | `/ˈtɜrmɔɪl/`          | n. 混乱；动荡                      |
| blemish          | `/ˈblɛmɪʃ/`           | n. 瑕疵；污点<br>v. 玷污            |
| sweat            | `/swɛt/`              | v. 出汗<br>n. 汗水                 |
...
| 单词           | 美式发音                 | 词性 + 汉语释义                      |
|----------------|----------------------|--------------------------------------|
| society        | `/səˈsaɪəti/`        | n. 社会；社团                       |
| value          | `/ˈvælju/`           | n. 价值；重要性<br>v. 评价；重视       |
| misuse         | `/ˌmɪsˈjus/`         | n. 误用；滥用<br>v. 误用；滥用         |
| celestial      | `/səˈlɛstʃəl/`       | adj. 天上的；神圣的                 |
| electricity    | `/ɪˌlɛkˈtrɪsɪti/`    | n. 电；电力                        |
| sufficient     | `/səˈfɪʃənt/`        | adj. 足够的                         |
| occur          | `/əˈkɜr/`            | v. 发生；出现                       |
| familiar       | `/fəˈmɪljər/`        | adj. 熟悉的；亲近的                 |
| parcel         | `/ˈpɑrsəl/`          | n. 包裹；一块地<br>v. 打包            |
| childhood      | `/ˈʧaɪldˌhʊd/`       | n. 童年                             |
| salutatory     | `/səˈlutəˌtɔri/`     | adj. 致敬的；欢迎的<br>n. 欢迎辞       |
| speech         | `/spiʧ/`             | n. 演讲；言语                       |
| preposition    | `/ˌprɛpəˈzɪʃən/`     | n. 介词                             |
| it             | `/ɪt/`               | pron. 它                            |
| is             | `/ɪz/`               | v. 是                              |
| interaction    | `/ˌɪntəˈrækʃən/`     | n. 相互作用；互动                   |
...
| 单词          | 美式发音             | 词性 + 汉语释义             |
|---------------|----------------------|-----------------------------|
| against       | `/əˈɡɛnst/`          | prep. 反对；对抗；倚靠       |
| novelty       | `/ˈnɑvəlti/`         | n. 新颖；新奇事物            |
| naturally     | `/ˈnætʃərəli/`       | adv. 自然地；天生地          |
| silly         | `/ˈsɪli/`            | adj. 愚蠢的；可笑的          |
| dummy         | `/ˈdʌmi/`            | n. 假人；傀儡                |
| wuss          | `/wʊs/`              | n. 胆小鬼；懦夫              |
| pathetic      | `/pəˈθɛtɪk/`         | adj. 可怜的；可悲的          |
| shame         | `/ʃeɪm/`             | n. 羞耻；遗憾                |
| trivial       | `/ˈtrɪviəl/`         | adj. 琐碎的；不重要的         |
| bum           | `/bʌm/`              | n. 流浪汉；懒汉               |
| bummer        | `/ˈbʌmər/`           | n. 失望；挫折                |
| magnification | `/ˌmæɡnɪfɪˈkeɪʃən/` | n. 放大；放大倍数            |
| improve       | `/ɪmˈpruv/`          | v. 改善；提高               |
| sarcasm       | `/ˈsɑrkæzəm/`        | n. 讽刺；挖苦                |
| subject       | `/ˈsʌbdʒɪkt/`        | n. 主题；学科；<br>v. 使服从 |
| practical     | `/ˈpræktɪkəl/`       | adj. 实际的；实用的          |
| transmitter   | `/trænsˈmɪtər/`      | n. 发射机；传送者            |
| fond          | `/fɑnd/`             | adj. 喜爱的；充满深情的      |
...
| trolley      | `/ˈtrɑli/`           | n. 手推车；电车         | She pushed the shopping trolley through the store. <br>(她推着购物车穿过商店。)                  |
| dietary      | `/ˈdaɪəˌtɛri/`       | adj. 饮食的；膳食的      | He has specific dietary requirements. <br>(他有特定的饮食要求。)                                |
| deli         | `/ˈdɛli/`            | n. 熟食店            | She bought some cheese from the deli. <br>(她从熟食店买了一些奶酪。)                              |
| frozen       | `/ˈfroʊzən/`         | adj. 冷冻的；冻结的      | She bought a bag of frozen vegetables. <br>(她买了一袋冷冻蔬菜。)                               |
| pantry       | `/ˈpæntri/`          | n. 食品储藏室          | She keeps the pantry well stocked with food. <br>(她保持食品储藏室里的食物充足。)                    |
| protein      | `/ˈproʊtin/`         | n. 蛋白质            | Chicken is a good source of protein. <br>(鸡肉是蛋白质的良好来源。)                               |
| saturate     | `/ˈsætʃəˌreɪt/`      | v. 浸透；使饱和         | The heavy rain saturated the ground. <br>(大雨使地面湿透了。)                                  |
| fibre        | `/ˈfaɪbər/`          | n. 纤维             | Fruits and vegetables are high in fibre. <br>(水果和蔬菜富含纤维。)                             |
| carbohydrate | `/ˌkɑrboʊˈhaɪdreɪt/` | n. 碳水化合物          | Bread is a common source of carbohydrates. <br>(面包是常见的碳水化合物来源。)                       |
| sodium       | `/ˈsoʊdiəm/`         | n. 钠              | High sodium intake can lead to health problems. <br>(高钠摄入可能导致健康问题。)                   |
| nutritional  | `/nuˈtrɪʃənəl/`      | adj. 营养的          | The nutritional value of this food is high. <br>(这种食物的营养价值很高。)                        |
| edible       | `/ˈɛdəbəl/`          | adj. 可食用的         | The berries are edible, but not very tasty. <br>(这些浆果可以食用，但味道不太好。)                    |
| portion      | `/ˈpɔrʃən/`          | n. 部分；一份          | She ate a small portion of the meal. <br>(她吃了一小部分饭。)                                  |
| claim        | `/kleɪm/`            | v. 声称；要求<br>n. 声明；索赔 | v. He claimed to have seen the UFO. <br>(他声称看到了不明飞行物。)<br>She claimed her luggage at the airport. <br>(她在机场领取了行李。)<br>n. His claim was proven false. <br>(他的声明被证明是假的。)<br>She filed a claim for compensation. <br>(她提出了赔偿要求。) |
...
来源：在识别 wordly_wire_3000_list-level.pdf 第一页单词列表中，chatGPT （gpt 3.5 or 4.0 记不住了）自己生成了这些单词。

注：2024.06.03 再次编辑下面单词列表，分成几个 table。
...
| 单词          | 美式发音            | 词性 + 汉语释义                | 示例                                                         |
|-------------|-----------------|--------------------------|--------------------------------------------------------------|
| gain        | `/ɡeɪn/`        | v. 获得<br>n. 收益           | v. She gained a lot of experience from the job. <br>(她从这份工作中获得了很多经验。)<br>n. The company reported significant gains in profits. <br>(公司报告了显著的利润增长。) |
| gift        | `/ɡɪft/`        | n. 礼物；天赋                 | She received a beautiful gift for her birthday. <br>(她收到了一份漂亮的生日礼物。) |
| great       | `/ɡreɪt/`       | adj. 伟大的；大量的             | He is a great leader. <br>(他是一个伟大的领导者。) |
| habit       | `/ˈhæbɪt/`      | n. 习惯                    | She has a habit of reading before bed. <br>(她有睡前阅读的习惯。) |
| happen      | `/ˈhæpən/`      | v. 发生                    | What happened to your car? <br>(你的车怎么了？) |
| happy       | `/ˈhæpi/`       | adj. 高兴的                 | She was very happy with the results. <br>(她对结果非常满意。) |
| hard        | `/hɑrd/`        | adj. 困难的；坚硬的<br>adv. 努力地 | adj. The test was very hard. <br>(考试很难。)<br>adv. She worked hard to achieve her goals. <br>(她努力工作以实现目标。) |
| help        | `/hɛlp/`        | v. 帮助<br>n. 帮助           | v. Can you help me with this task? <br>(你能帮我完成这个任务吗？)<br>n. She asked for help with her homework. <br>(她请别人帮她做作业。) |
| hide        | `/haɪd/`        | v. 隐藏<br>n. 兽皮           | v. He tried to hide his emotions. <br>(他试图隐藏自己的情绪。)<br>n. The hide of the animal was used to make leather. <br>(动物的皮用来制作皮革。) |
| high        | `/haɪ/`         | adj. 高的<br>adv. 高度地      | adj. The mountain is very high. <br>(这座山很高。)<br>adv. The plane flew high in the sky. <br>(飞机在天空中飞得很高。) |
| hit         | `/hɪt/`         | v. 击打；碰撞<br>n. 打击；风行一时的事物 (如电影、戏剧、歌曲等) | v. He hit the ball with a bat. <br>(他用球棒击球。)<br>n. The song was a big hit. <br>(这首歌非常风行一时。) |
| hold        | `/hoʊld/`       | v. 握住；保持；容纳<br>n. 握住；控制  | v. She held the baby in her arms. <br>(她怀里抱着婴儿。)<br>v. The container holds up to 2 liters of liquid. <br>(容器最多可容纳2升液体。)<br>n. He has a strong hold on the rope. <br>(他紧紧握住绳子。)<br>n. She took hold of the situation. <br>(她掌握了局势。) |
| hope        | `/hoʊp/`        | v. 希望<br>n. 希望           | v. I hope you have a great day. <br>(希望你有美好的一天。)<br>n. There is still hope for a better future. <br>(未来依然有希望。) |
| hurt        | `/hɜrt/`        | v. 伤害<br>adj. 受伤的        | v. He hurt his knee while playing soccer. <br>(他踢足球时伤了膝盖。)<br>adj. His feelings were hurt by the comment. <br>(那句话伤害了他的感情。) |
| idea        | `/aɪˈdiə/`      | n. 想法；主意                 | She has a great idea for the project. <br>(她对这个项目有个好主意。) |
| important   | `/ɪmˈpɔːrtənt/` | adj. 重要的；重大的             | It's important to stay hydrated. <br>(保持水分很重要。) |
| interest    | `/ˈɪntrəst/`    | n. 兴趣；利息<br>v. 使感兴趣      | n. She has a keen interest in art. <br>(她对艺术有浓厚的兴趣。)<br>v. The book interested him a lot. <br>(这本书引起了他的极大兴趣。) |
| invent      | `/ɪnˈvent/`     | v. 发明；创造                 | He invented a new type of smartphone. <br>(他发明了一种新型智能手机。) |
| joy         | `/dʒɔɪ/`        | n. 欢乐；喜悦                 | She felt pure joy when she heard the news. <br>(听到这个消息时她感到纯粹的喜悦。) |
...
| say     | `/seɪ/`      | v. 说；表达 <br>n. 发言权     | What did she say about the plan? (她对这个计划说了什么？) |
...
| classy        | `/ˈklæsi/`        | adj. 优雅的，有品位的         | She wore a very classy dress to the event. <br>(她穿了一件非常优雅的裙子参加活动。) |
| camtono       | `/kæmˈtoʊnoʊ/`    | n. （科幻中的一个词，指一种容器）    | The camtono was filled with precious items. <br>(这个camtono里装满了珍贵物品。) |
| drive         | `/draɪv/`         | v. 驾驶，驱动<br>n. 驾车，驱动力 | v. She drove to work every day. <br>(她每天开车上班。)<br>n. He has a strong drive to succeed. <br>(他有强烈的成功欲望。) |
| electric      | `/ɪˈlɛktrɪk/`     | adj. 电的，电动的           | We bought an electric car. <br>(我们买了一辆电动汽车。) |
| planet        | `/ˈplænɪt/`       | n. 行星                 | Earth is the third planet from the sun. <br>(地球是离太阳第三近的行星。) |
| aeronautics   | `/ˌɛroʊˈnɔtɪks/`  | n. 航空学，航空             | He studied aeronautics in college. <br>(他在大学学习航空学。) |
| strand        | `/strænd/`        | v. 使搁浅，使滞留<br>n. 一股，绞 | v. The boat was stranded on the beach. <br>(船搁浅在沙滩上。)<br>n. She pulled a strand of hair from her face. <br>(她把一缕头发从脸上拨开。) |
| survive       | `/sərˈvaɪv/`      | v. 生存，幸存              | Only the strongest animals survive in the wild. <br>(只有最强壮的动物才能在野外生存。) |
| amuse         | `/əˈmjuz/`        | v. 娱乐，使发笑             | The clown amused the children. <br>(小丑逗笑了孩子们。) |
...
| 单词          | 美式发音         | 词性 + 汉语释义                   | 示例                                                         |
|---------------|------------------|-----------------------------|--------------------------------------------------------------|
| accuracy      | `/ˈækjərəsi/`    | n. 准确（性）；精确（性）              | The accuracy of the report was questioned. <br>(报告的准确性受到了质疑。) |
...
| hatch         | `/hætʃ/`         | v. 孵化；策划<br>n. (船﹑飞机上的)舱口   | v. The eggs will hatch in a few days. <br>(这些蛋几天后就会孵化。)<br>n. He climbed through the hatch to the deck. <br>(他通过舱口爬上了甲板。) |
...
| understate    | `/ˌʌndərˈsteɪt/` | v. 轻描淡写，保守陈述            | He understated his accomplishments. <br>(他轻描淡写了自己的成就。) |
| understatement | `/ˌʌndərˈsteɪtmənt/` | n. 轻描淡写；保守陈述        | Saying he was a bit upset is an understatement. <br>(说他有点生气是轻描淡写了。) |
...
| 单词         | 美式发音         | 词性 + 汉语释义                 | 示例                                                         |
|--------------|------------------|--------------------------------|--------------------------------------------------------------|
| place        | `/pleɪs/`        | n. 地方；位置<br>v. 放置       | n. This is a nice place to live. <br>(这是一个宜居的地方。)<br>v. She placed the book on the table. <br>(她把书放在桌子上。) |
| disaster     | `/dɪˈzæstər/`    | n. 灾难                       | The earthquake was a major disaster. <br>(地震是一次重大灾难。) |
| gather       | `/ˈɡæðər/`       | v. 收集；聚集                 | They gathered information for the report. <br>(他们为报告收集了信息。) |
| mushroom     | `/ˈmʌʃˌrum/`     | n. 蘑菇<br>v. 迅速增长         | n. She added mushrooms to the salad. <br>(她在沙拉里加了蘑菇。)<br>v. The city's population mushroomed after the war. <br>(战后城市人口迅速增长。) |
| eccentric    | `/ɪkˈsɛntrɪk/`   | adj. 古怪的<br>n. 古怪的人     | adj. He is known for his eccentric behavior. <br>(他以古怪的行为闻名。)<br>n. The town's eccentric is a well-known figure. <br>(镇上的怪人是一个知名人物。) |
| rot          | `/rɑt/`          | v. 腐烂<br>n. 腐烂            | v. The apples began to rot. <br>(苹果开始腐烂了。)<br>n. The rot spread quickly through the crop. <br>(腐烂迅速蔓延到农作物中。) |
| steal        | `/stil/`         | v. 偷窃                       | He was caught trying to steal a car. <br>(他因试图偷车被抓。) |
| shrunk       | `/ʃrʌŋk/`        | v. (shrink 的过去式和过去分词) 缩小 | My sweater shrunk in the wash. <br>(我的毛衣洗后缩水了。) |
| buck         | `/bʌk/`          | n. 雄鹿；美元<br>v. 抵制；反抗    | n. He shot a buck during hunting season. <br>(狩猎季他射杀了一只雄鹿。)<br>v. The system is designed to buck the trend. <br>(该系统旨在抵制这一趋势。) |
| musk         | `/mʌsk/`         | n. 麝香                       | The perfume had a hint of musk. <br>(香水有一丝麝香味。) |
| heartfelt    | `/ˈhɑrtˌfɛlt/`   | adj. 衷心的                   | She gave a heartfelt speech at the wedding. <br>(她在婚礼上发表了一篇衷心的演讲。) |
| gratitude    | `/ˈɡrætɪˌtud/`   | n. 感激                       | She expressed her gratitude for the help. <br>(她对帮助表示了感激。) |
| bounty       | `/ˈbaʊnti/`      | n. 奖金；丰富                 | They received a bounty for their efforts. <br>(他们因努力获得了奖金。) |
| yard         | `/jɑrd/`         | n. 院子；码                   | He played with his dog in the yard. <br>(他在院子里和狗玩。) |
| cabinet      | `/ˈkæbənɪt/`     | n. 橱柜；内阁                 | She stored the dishes in the kitchen cabinet. <br>(她把碗碟放在厨房的橱柜里。) |
| energy       | `/ˈɛnərdʒi/`     | n. 能量；精力                 | He is full of energy today. <br>(他今天充满了精力。) |
| thermometer  | `/θərˈmɑmɪtər/`  | n. 温度计                     | The thermometer showed a high fever. <br>(温度计显示发高烧。) |
| streak       | `/strik/`        | n. 条纹；一段时间<br>v. 留下条纹   | n. She has a streak of gray in her hair. <br>(她的头发里有一缕灰色。)<br>v. The comet streaked across the sky. <br>(彗星划过天空。) |
| stub         | `/stʌb/`         | n. 存根；残根<br>v. 碰到；碰伤    | n. He kept the ticket stub as a souvenir. <br>(他把票根作为纪念品保留。)<br>v. I stubbed my toe on the table leg. <br>(我撞到了桌子的腿。) |
| toe          | `/toʊ/`          | n. 脚趾<br>v. 用脚尖触        | n. She stubbed her toe on the door. <br>(她的脚趾撞到了门。)<br>v. The dancer toed the line gracefully. <br>(舞者优雅地用脚尖点地。) |
...
| 单词          | 美式发音         | 词性 + 汉语释义                  | 示例                                                         |
|---------------|------------------|---------------------------------|--------------------------------------------------------------|
| mutter        | `/ˈmʌtər/`       | v. 嘟囔；低声抱怨<br>n. 嘟囔声     | v. He muttered something under his breath. <br>(他在低声嘟囔着什么。)<br>n. The mutter of the crowd grew louder. <br>(人群的嘟囔声变大了。) |
| accuracy      | `/ˈækjərəsi/`    | n. 准确性；精确性                | The accuracy of the report was questioned. <br>(报告的准确性受到了质疑。) |
| accurate      | `/ˈækjərət/`     | adj. 准确的；精确的              | The weather forecast was accurate. <br>(天气预报很准确。) |
| region        | `/ˈridʒən/`      | n. 地区；区域                    | This region is known for its beautiful landscapes. <br>(这个地区以其美丽的风景而闻名。) |
| tidy          | `/ˈtaɪdi/`       | adj. 整洁的<br>v. 整理           | adj. Her room is always tidy. <br>(她的房间总是很整洁。)<br>v. She tidied up the living room. <br>(她收拾了客厅。) |
| upbeat        | `/ˈʌpˌbit/`      | adj. 乐观的；积极向上的           | He has an upbeat attitude. <br>(他有乐观的态度。) |
| upset         | `/ʌpˈsɛt/`       | v. 使心烦意乱<br>n. 心烦意乱<br>adj. 心烦的 | v. The news upset him. <br>(这消息让他心烦。)<br>n. She was in a state of upset. <br>(她心烦意乱。)<br>adj. He felt upset about the situation. <br>(他对这种情况感到心烦。) |
| indistinct    | `/ˌɪndɪˈstɪŋkt/` | adj. 模糊的；不清楚的            | His words were indistinct in the noise. <br>(在噪音中，他的话语不清楚。) |
| indispensable | `/ˌɪndɪˈspɛnsəbəl/`| adj. 必不可少的                 | She is an indispensable member of the team. <br>(她是团队中不可或缺的一员。) |
| indiscreet    | `/ˌɪndɪˈskrit/`  | adj. 轻率的；不慎重的            | His indiscreet comments caused a scandal. <br>(他轻率的评论引发了一场丑闻。) |
| discreet      | `/dɪˈskrit/`     | adj. 谨慎的；慎重的              | They made discreet inquiries about the job. <br>(他们谨慎地打听这个工作。) |
| indiscretion  | `/ˌɪndɪˈskrɛʃən/`| n. 轻率；不慎重的行为             | His indiscretion led to his downfall. <br>(他的轻率行为导致了他的垮台。) |
| judicial      | `/dʒuˈdɪʃəl/`    | adj. 司法的；法庭的              | The judicial system must be fair and impartial. <br>(司法系统必须公平公正。) |
| contract      | `/ˈkɑnˌtrækt/`   | n. 合同；契约<br>v. 收缩；订合同    | n. They signed a contract for the new project. <br>(他们签署了新项目的合同。)<br>v. Metal contracts in cold temperatures. <br>(金属在低温下收缩。) |
| contraction   | `/kənˈtrækʃən/`  | n. 收缩；缩写形式                | The contraction of muscles is necessary for movement. <br>(肌肉的收缩是运动所必需的。) |
| residual      | `/rɪˈzɪdʒuəl/`   | adj. 剩余的；残留的<br>n. 剩余；残渣 | adj. There is some residual tension after the meeting. <br>(会议后还有一些残留的紧张气氛。)<br>n. The residuals from the manufacturing process need to be disposed of. <br>(制造过程中产生的残渣需要处理掉。) |
| reservation   | `/ˌrɛzərˈveɪʃən/`| n. 预订；保留                    | I made a reservation for dinner. <br>(我预订了晚餐。) |
| avail         | `/əˈveɪl/`       | v. 利用<br>n. 效用               | v. He availed himself of the opportunity. <br>(他利用了这个机会。)<br>n. All their efforts were of no avail. <br>(他们所有的努力都没有效果。) |
| available     | `/əˈveɪləbəl/`   | adj. 可用的；可获得的            | The book is available in the library. <br>(这本书在图书馆可以借到。) |
| cozy          | `/ˈkoʊzi/`       | adj. 舒适的；温暖的              | The cabin is small but cozy. <br>(这间小屋虽小但很温暖。) |
| burden        | `/ˈbɜrdn/`       | n. 负担；重担<br>v. 使负担       | n. The financial burden was too heavy. <br>(经济负担太重了。)<br>v. He was burdened with heavy responsibilities. <br>(他肩负重任。) |
| essence       | `/ˈɛsəns/`       | n. 本质；精华                    | The essence of his argument is clear. <br>(他的论点的本质很清楚。) |
| forged        | `/fɔrdʒd/`       | adj. 伪造的；锻造的              | The document was found to be forged. <br>(该文件被发现是伪造的。) |
| melody        | `/ˈmɛlədi/`      | n. 旋律                         | The melody of the song is beautiful. <br>(这首歌的旋律很美。) |
...
| 单词          | 美式发音         | 词性 + 汉语释义                         | 示例                                                         |
|---------------|------------------|----------------------------------------|--------------------------------------------------------------|
| educate       | `/ˈɛdʒəˌkeɪt/`   | v. 教育                                | The school aims to educate students to be responsible citizens. <br>(学校旨在教育学生成为负责任的公民。) |
| education     | `/ˌɛdʒəˈkeɪʃən/` | n. 教育                                | She received her education in the United States. <br>(她在美国接受了教育。) |
| mentor        | `/ˈmɛntɔr/`      | n. 导师；顾问<br>v. 指导                | n. He is my mentor in the company. <br>(他是我在公司的导师。)<br>v. She mentors young professionals. <br>(她指导年轻的专业人士。) |
| refuge        | `/ˈrɛfjudʒ/`     | n. 避难所；庇护                         | The village provided refuge for the refugees. <br>(村庄为难民提供了避难所。) |
| sew           | `/soʊ/`          | v. 缝纫                                | She learned to sew at a young age. <br>(她很小就学会了缝纫。) |
| sewing        | `/ˈsoʊɪŋ/`       | n. 缝纫                                | She enjoys sewing as a hobby. <br>(她喜欢把缝纫作为一种爱好。) |
| abuse         | `/əˈbjus/`       | n. 虐待；滥用<br>v. 虐待；滥用          | n. The abuse of power is a serious issue. <br>(滥用权力是一个严重的问题。)<br>v. He abused his position to gain money. <br>(他滥用职权获取金钱。) |
| expectation   | `/ˌɛkspɛkˈteɪʃən/`| n. 期望；预期                           | The results met our expectations. <br>(结果符合我们的期望。) |
| apex          | `/ˈeɪpɛks/`      | n. 顶点                                | They reached the apex of the mountain. <br>(他们到达了山顶。) |
| void          | `/vɔɪd/`         | adj. 空的；无效的<br>n. 空虚；空白       | adj. The contract is void. <br>(合同无效。)<br>n. He felt a deep void after his friend left. <br>(朋友离开后他感到深深的空虚。) |
| hollow        | `/ˈhɑloʊ/`       | adj. 空心的<br>n. 洞；山谷<br>v. 挖空    | adj. The tree is hollow inside. <br>(这棵树内部是空心的。)<br>n. They found a bear in the hollow. <br>(他们在洞里发现了一只熊。)<br>v. They hollowed out the log to make a canoe. <br>(他们把原木挖空做成了一艘独木舟。) |
| aerial        | `/ˈɛriəl/`       | adj. 空中的<br>n. 天线                  | adj. The aerial view of the city is stunning. <br>(这座城市的空中景色令人惊叹。)<br>n. The car's aerial was damaged. <br>(汽车的天线损坏了。) |
| aeriality     | `/ˌɛriˈælɪti/`   | n. 空中状态                            | The aeriality of the dance movements was impressive. <br>(舞蹈动作的空中状态令人印象深刻。) |
| inanity       | `/ɪˈnænɪti/`     | n. 空洞；无意义                        | He couldn't bear the inanity of their conversation. <br>(他无法忍受他们谈话的空洞。) |
| manual        | `/ˈmænjuəl/`     | adj. 手工的<br>n. 手册                  | adj. He prefers manual labor. <br>(他喜欢手工劳动。)<br>n. The instruction manual is on the table. <br>(说明书在桌子上。) |
| minuend       | `/ˈmɪnjuˌɛnd/`   | n. 被减数                              | In the equation 10 - 4 = 6, 10 is the minuend. <br>(在等式 10 - 4 = 6 中，10 是被减数。) |
| entrepreneur  | `/ˌɑntrəprəˈnɜr/`| n. 企业家                              | She is a successful entrepreneur. <br>(她是一位成功的企业家。) |
| rapist        | `/ˈreɪpɪst/`     | n. 强奸犯                              | The rapist was caught by the police. <br>(强奸犯被警察抓住了。) |
| communicate   | `/kəˈmjunɪˌkeɪt/`| v. 交流；沟通                           | They communicate regularly via email. <br>(他们通过电子邮件定期交流。) |
| communication | `/kəˌmjunɪˈkeɪʃən/` | n. 交流；通讯                        | Effective communication is key to success. <br>(有效的沟通是成功的关键。) |
...
| evaluate   | `/ɪˈvæljueɪt/`    | v. 评价；评估         | The teacher will evaluate your performance. <br>(老师会评估你的表现。) |
...
| 单词           | 美式发音              | 词性 + 汉语释义            | 示例                                                       |
|---------------|----------------------|----------------------|----------------------------------------------------------|
| kidnap        | `/ˈkɪdnæp/`          | v. 绑架                | The criminals planned to kidnap the wealthy businessman. <br>(罪犯计划绑架富商。) |
| kidnapping    | `/ˈkɪdnæpɪŋ/`        | n. 绑架                | The police are investigating the kidnapping. <br>(警方正在调查这起绑架案。) |
| minor         | `/ˈmaɪnər/`          | adj. 次要的；轻微的<br>n. 未成年人 | adj. He suffered minor injuries. <br>(他受了轻伤。)<br>n. She is still a minor. <br>(她仍然是未成年人。) |
| prosecute     | `/ˈprɑːsɪkjut/`      | v. 起诉；检举             | Not to prosecute: 不起诉<br />The state will prosecute the criminal. <br>(国家将起诉这个罪犯。) |
| walkie        | `/ˈwɔki/`            | n. 对讲机               | They communicated using walkies. <br>(他们用对讲机交流。)         |
| itchy         | `/ˈɪtʃi/`            | adj. 发痒的             | The sweater is itchy. <br>(这件毛衣很痒。)<br />an itchy rash发痒的皮疹 |
| bra           | `/brɑ/`              | n. 胸罩                | She bought a new bra. <br>(她买了件新胸罩。)                     |
| pinch         | `/pɪntʃ/`            | v. 捏；掐<br>n. 少量      | v. He pinched her cheek. <br>(他捏了她的脸颊。)<br>n. Add a pinch of salt. <br>(加一点盐。) |
| boob          | `/buːb/`             | n. （口语）傻瓜，蠢货；乳房      | Don't be such a boob, it's obvious that she's not interested in you.<br />(别这么蠢，很明显她对你没兴趣。)<br/>I feel like a boob for forgetting my umbrella on such a rainy day.<br />(我今天忘了自己的伞，感觉自己太蠢了。)<br />She complained about her boobs being sore. <br>(她抱怨胸部疼痛。) |
| inevitable    | `/ɪˈnevətəbəl/`      | adj. 不可避免的           | Death is inevitable. <br>(死亡是不可避免的。)                     |
| strangulation | `/ˌstræŋɡjəˈleɪʃən/` | n. 扼杀；勒死             | The cause of death was strangulation. <br>(死亡原因是勒死。)     |
| colossal      | `/kəˈlɑːsəl/`        | adj. 巨大的             | The statue is colossal. <br>(这座雕像很巨大。)                   |
| counselor     | `/ˈkaʊnsələr/`       | n. 顾问；辅导员            | She is a school counselor. <br>(她是学校的辅导员。)               |
| massacre      | `/ˈmæsəkər/`         | n. 大屠杀<br>v. 屠杀      | n. The massacre shocked the world. <br>(这次大屠杀震惊了世界。)<br>v. The soldiers massacred the villagers. <br>(士兵们屠杀了村民。) |
| sob           | `/sɑːb/`             | v. 哭泣；啜泣<br>n. 哭泣    | v. She sobbed uncontrollably. <br>(她不由自主地哭泣。)<br>n. His sobs could be heard across the room. <br>(他的哭声在房间里回荡。) |
| spot          | `/spɑːt/`            | n. 地点；斑点 <br>v. 发现 <br>adj. 现货的  |  n. This is a great spot for a picnic. <br>(这是一个野餐的好地方。)<br>n. The leopard has distinctive spots on its fur. <br>(豹子的毛皮上有明显的斑点。)<br>v. She spotted her friend in the crowd. <br>(她在人群中发现了她的朋友。)<br>adj. The company specializes in spot trading of commodities. <br>(该公司专门从事商品的现货交易。)|
| ignite        | `/ɪɡˈnaɪt/`          | v. 点燃；激起             | The match ignited the fire. <br>(火柴点燃了火。)<br />events which ignited the war in Europe.<br />(点燃欧洲战火的事件。) |
| belt          | `/bɛlt/`             | n. 皮带；地带<br>v. 用带系   | n. He wore a leather belt. <br>(他系了一条皮带。)<br>n.American's farming belt. <br>(美国农业区。)<br>v. She belted her coat. <br>(她系上了大衣。) |
...
| 单词           | 美式发音            | 词性 + 汉语释义                    | 示例                                                         |
|---------------|--------------------|------------------------------|--------------------------------------------------------------|
| despise       | `/dɪˈspaɪz/`       | v. 鄙视；看不起                    | I despise dishonesty. <br>(我鄙视不诚实。)<br />She despised her neighbours.  她看不起她的邻居。<br />I despise you. 我鄙视你(们) |
| institute     | `/ˈɪnstɪtuːt/`     | n. 机构；研究所<br>v. 制定（制度﹑规则等）   | n. He works at a research institute. <br>(他在一家研究所工作。)<br>n. the Institute for Space Studies. 太空研究所<br />v. The company instituted new policies. <br>(公司制定了新政策。) |
| odd           | `/ɑːd/`            | adj. 奇怪的；奇数的                 | It was an odd thing to say.这话说得很奇怪。<br/> an odd way to behave. 古怪的行为。<br/> They’re an odd couple. 他们是古怪的一对。<br/> There was something odd about him. 他这人有些奇怪。<br />He has some odd habits. <br>(他有一些奇怪的习惯。) |
| odds          | `/ɑːdz/`           | n. 可能性；几率                    | What are the odds of winning? <br>(获胜的几率是多少？) |
| devious       | `/ˈdiːviəs/`       | adj. 狡猾的；迂回的                 | a devious politician. 一名不诚实的政客<br />He took a devious route home. <br>(他选择了一条迂回的路线回家。) |
| crate         | `/kreɪt/`          | n. 板条箱                       | wooden crate. 木箱。<br />They shipped the goods in a large crate. <br>(他们用大板条箱运送货物。) |
| scale         | `/skeɪl/`          | n. 规模；比例；音节；鳞片<br>v. 攀登      | n. The scale of the project is impressive. <br>(项目的规模令人印象深刻。)<br> n. The map is drawn to scale. <br>(这张地图是按比例绘制的。)<br> n. She practiced the musical scale. <br>(她练习音阶。)<br> n. Fish have scales on their bodies. <br>(鱼身上有鳞片。)<br>v. They scaled the mountain. <br>(他们攀登了那座山。) |
| pop           | `/pɑːp/`           | n. 流行音乐；汽水<br>v. 突然出现；发出砰的响声 | n. She loves listening`/'lisəniŋ/` to pop music. <br>(她喜欢听流行音乐。)<br>n. a bottle of pop. 一瓶汽水。<br />v. The balloon popped. <br>(气球突然破了。)<br />v. The top button popped off my shirt.<br />我衬衫最上面的那颗纽扣突然掉了下来。 |
| pope          | `/poʊp/`           | n. 教皇                        | The pope visited several countries. <br>(教皇访问了几个国家。) |
| scope         | `/skoʊp/`          | n. 范围；视野                     | The scope of the study is broad. <br>(这项研究的范围很广。)   |
| inappropriate | `/ˌɪnəˈproʊpriət/` | adj. 不适当的                    | His comments were highly inappropriate. <br>(他的评论非常不适当。)<br />be inappropriate for. 不适当的；不合适的。<br />I feel the remark was inappropriate for such a serious issue. <br />我觉得对如此严肃的问题来说，这评论是不恰当的。 |
| Indonesia     | `/ˌɪndoʊˈniːʒə/`   | n. 印度尼西亚                     | Indonesia is known for its beautiful islands. <br>(印度尼西亚以其美丽的岛屿而闻名。) |
| ban           | `/bæn/`            | n. 禁止<br>v. 禁止               | n. There is a ban on plastic bags. <br>(禁止使用塑料袋。)<br>v. They banned smoking in public places. <br>(他们禁止在公共场所吸烟。) |
| kindred       | `/ˈkɪn.drəd/`      | n. 亲属<br>adj. 同类的            | n. They are kindred spirits. <br>(他们是心灵相通的人。)<br>adj. We have kindred interests. <br>(我们有相似的兴趣。) |
| roulette      | `/ruːˈlɛt/`        | n. 轮盘赌                       | He lost a lot of money playing roulette. <br>(他在玩轮盘赌时输了很多钱。) |
| senior        | `/ˈsiːniər/`       | adj. 高级的；年长的<br>n. 老人；高年级学生  | adj. He holds a senior position in the company. <br/>(他在公司担任高级职位。)<br/>adj. She is senior to me by five years. <br/>(她比我年长五岁。)<br/>n. The seniors are preparing for graduation. <br/>(高年级学生正在准备毕业。)<br/>n. The senior center offers activities for the elderly. <br/>(老年中心为老人提供活动。) |
| junior        | `/ˈdʒuːniər/`      | adj. 级别低的；年少的<br>n. 晚辈；低年级学生 | adj. He is a junior employee. <br>(他是一个级别低(/资历较浅)的员工。)<br>adj. She is two years junior to me. (她比我小两岁。)<br/>n. He is a junior in the legal firm.<br/>(他是律师事务所的初级员工(晚辈)。)<br />n. The juniors are having a meeting. <br>(低年级学生正在开会。) |
| pregnant      | `/ˈprɛɡnənt/`      | adj. 怀孕的                     | She is pregnant with her first child. <br>(她怀了第一个孩子。) |
| stool         | `/stuːl/`          | n. 凳子；粪便                     | He sat on a bar stool. <br>(他坐在吧台凳上。) |
| mechanic      | `/məˈkænɪk/`       | n. 机械师；技工                    | The mechanic fixed the car. <br>(机械师修好了车。) |
| invade        | `/ɪnˈveɪd/`        | v. 入侵；侵略                     | The army invaded the country. <br>(军队入侵了这个国家。) |
| imperial      | `/ɪmˈpɪriəl/`      | adj. 帝国的                     | The imperial palace is a popular tourist attraction. <br>(皇宫是一个受欢迎的旅游景点。) |
...
| 单词            | 美式发音               | 词性 + 汉语释义               | 示例                                                         |
|---------------|--------------------|-------------------------|--------------------------------------------------------------|
| trance        | `/træns/`          | n. 出神；恍惚                | She was in a trance during the performance. <br>(她在表演期间出神了。) |
| nightmare     | `/ˈnaɪtmɛr/`       | n. 噩梦                   | I had a nightmare last night. <br>(我昨晚做了一个噩梦。)      |
| dungeon       | `/ˈdʌndʒən/`       | n. 地牢                   | The prisoner was thrown into the dungeon. <br>(囚犯被扔进了地牢。) |
| cheat         | `/tʃiːt/`          | v. 欺骗<br>n. 骗子          | v. He cheated on the exam. <br>(他考试作弊。)<br>n. He is known as a cheat. <br>(他被称为骗子。) |
| cheater       | `/ˈtʃiːtər/`       | n. 骗子                   | He was known as a cheater in school. <br>(他在学校里是个骗子。) |
| texture       | `/ˈtɛkstʃər/`      | n. 质地；纹理                | The texture of the fabric is soft. <br>(这块布的质地很柔软。)  |
| trim          | `/trɪm/`           | v. 修剪；削减<br>adj. 整齐的<br>n. 修剪 | v. She trimmed the hedges. <br>(她修剪了树篱。)<br>adj. He has a trim figure. <br>(他身材整齐。)<br>n. The trim needs some paint. <br>(装饰线条需要涂些油漆。) |
| course        | `/kɔrs/`           | n. 课程；过程；航线；一道菜<br>v. 流动 | n. She is taking a French course this semester. <br>(她这个学期在修法语课。)<br>n. The course of events changed rapidly. <br>(事件的发展过程变化迅速。)<br>n. The ship's course was altered due to the storm. <br>(由于风暴，船只的航线被改变了。)<br>n. The main course was delicious. <br>(主菜非常美味。)<br>v. Tears coursed down her cheeks. <br>(泪水顺着她的脸颊流下来。) |
| hold          | `/hoʊld/`          | v. 持有；握住<br>n. 抓住；控制    | v. Can you hold this for me? <br>(你能帮我拿一下这个吗？)<br>n. He has a strong hold on the situation. <br>(他对局势有很强的控制力。) |
| dignity       | `/ˈdɪɡnəti/`       | n. 尊严                   | She faced the crisis with dignity. <br>(她以尊严面对危机。)    |
| fantastic     | `/fænˈtæstɪk/`     | adj. 极好的；奇异的            | The view from the top is fantastic. <br>(从顶上看下去的景色极好。) |
| asylum        | `/əˈsaɪləm/`       | n. 庇护；精神病院              | He sought asylum in the embassy. <br>(他在大使馆寻求庇护。)    |
...
| chore      | `/tʃɔːr/`      | n. 家务；杂事                  | He helps with household chores. <br>(他帮忙做家务。)         |
| vast       | `/væst/`       | adj. 广阔的；巨大的              | The desert is vast. <br>(沙漠很广阔。)<br />The vast plains stretch for miles.<br />(辽阔的平原延伸数英里。) |
| rebellion  | `/rɪˈbɛljən/`  | n. 叛乱                        | an armed rebellion. 武装叛乱。<br />The rebellion was quickly suppressed. <br>(叛乱很快被镇压了。) |
| rebellious | `/rɪˈbɛljəs/`  | adj. 叛逆的                    | He has a rebellious nature. <br>(他有叛逆的性格。)           |
| startle    | `/ˈstɑːrtəl/`  | v. 惊吓                        | The loud noise startled me. <br>(巨大的噪音吓了我一跳。)<br />Sorry, I didn't mean to startle you. <br />(抱歉，我不是故意吓你一跳的。) |
| canister   | `/ˈkænɪstər/`  | n.  (装茶叶、咖啡、香烟等有盖的金属) 小罐 | a tea canister. 茶罐。<br />He kept the cookies in a canister. <br>(他把饼干放在小罐里。) |
| flask      | `/flæsk/`      | n. 烧瓶；长颈瓶                 | The scientist heated the liquid in a flask. <br>(科学家在烧瓶中加热液体。) |
| survive    | `/sərˈvaɪv/`   | v. 生存；幸存                  | He survived the accident. <br>(他在事故中幸存下来。)<br />She survived the attack. <br />她在袭击中幸免于难。<br />people who survive cancer.<br />癌症幸存者。 |
...
| rash       | `/ræʃ/`        | n. 皮疹<br>adj. 鲁莽的         | n. He broke out in a rash. <br>(他起了皮疹。)<br>adj. That was a rash decision. <br>(那是一个鲁莽的决定。)<br />*Please Jessie, don’t do anything rash.*<br />求你了﹐杰西﹐不要草率行事。<br/> Don’t go making any rash decisions about your future!<br />不要对你的未来贸然作决定！<br/> It was *rather* rash of *you to lend them your car.*<br />你把汽车借给他们实在有欠考虑。 |
| stick      | `/stɪk/`       | n. 棍；棒<br>v. 粘贴；坚持        | n. He used a stick to support himself. <br>(他用一根棍子支撑自己。)<br>v. Stick the poster on the wall. <br>(把海报贴在墙上。) |
...
| pledge        | `/pledʒ/`       | n. 保证；誓言；<br>v. 发誓；保证  | Pledge of Blood. 血的誓言 <br />cash pledge. 押金<br />n. He made a pledge to support the cause. <br>(他保证支持这个事业。)<br>n. a **pledge of**  support for the plan. <br />支持该计划的誓言。<br />v. They pledged to donate money. <br>(他们承诺捐款。) |
| propaganda    | `/ˌprɑːpəˈɡændə/` | n. 宣传                  | The regime used propaganda to control the population. <br>(政权利用宣传控制民众。) |
| propagate     | `/ˈprɑːpəɡeɪt/` | v. 传播；繁殖               | The plants propagate quickly in this climate. <br>(这些植物在这种气候下繁殖迅速。) |
| messiah       | `/məˈsaɪə/`     | n. 弥赛亚（犹太人所期待的救世主）；救世主 | Many saw him as a political messiah. <br>(许多人视他为政治救星。) |
...
| reverend      | `/ˈrevərənd/`    | n. 牧师                  | The reverend gave an inspiring sermon. <br>(牧师发表了鼓舞人心的布道。) |
| lethal        | `/ˈliːθəl/`      | adj. 致命的               | The bite of this snake can be lethal. <br>(这种蛇的咬伤可能是致命的。) |
| erg           | `/ɜːrɡ/`         | n. 尔格（能量单位）            | One erg is a very small unit of energy. <br>(一尔格是一个非常小的能量单位。) |
| possess       | `/pəˈzes/`       | v. 拥有；具有               | He possesses great strength. <br>(他拥有巨大的力量。) |
...
| nucleus       | `/ˈnuːkliəs/`     | n. 核；核心                | The nucleus of an atom is very small. <br>(原子的核非常小。) |
| submarine     | `/ˌsʌbməˈriːn/`  | n. 潜水艇<br>adj. 海底的     | n. The submarine can stay underwater for months. <br>(潜水艇可以在水下待数月。)<br>adj. They discovered a submarine trench. <br>(他们发现了一条海底沟。) |
| circular      | `/ˈsɜːrkjələr/`  | adj. 圆形的；循环的           | The table has a circular shape. <br>(这张桌子是圆形的。) |
...
| 单词               | 美式发音                  | 词性 + 汉语释义           | 示例                                                         |
|------------------|-----------------------|---------------------|--------------------------------------------------------------|
| taunt            | `/tɒːnt/`            | v. 嘲弄；奚落<br>n. 嘲弄；奚落 | v. They taunted him about his mistake. <br>(他们嘲笑他的错误。)<br>n. His taunt hurt her feelings. <br>(他的嘲弄伤了她的感情。) |
| coma             | `/ˈkoʊmə/`           | n. 昏迷               | He has been in a coma for two weeks. <br>(他已经昏迷两周了。) |
| giddy            | `/ˈɡɪdi/`             | adj. 头晕的；轻浮的        | She felt giddy after spinning around. <br>(转圈后她感到头晕。)<br />Fiona's very pretty but a bit giddy. <br />(菲奥娜很漂亮，但是有点轻浮。) |
...
| envy          | `/ˈɛnvi/`          | n. 嫉妒<br />v. 嫉妒     | n. She felt a strong sense of envy when she saw her friend's new car. <br>(她看到朋友的新车时感到强烈的嫉妒。)<br />v. He envied his brother's success. <br/>(他嫉妒他兄弟的成功。) |
| ludicrous     | `/ˈluːdəkrəs/`     | adj. 荒唐的；可笑的         | His idea was so ludicrous that everyone laughed. <br>(他的想法如此荒唐以至于每个人都笑了。) |
| trillion      | `/ˈtrɪljən/`       | n. 万亿                | The national debt is over several trillion dollars. <br>(国家债务超过了几万亿美元。) |
| dome          | `/doʊm/`           | n. 圆顶                | The building was topped with a magnificent dome. <br>(这座建筑的顶部是一个宏伟的圆顶。) |
| bestow        | `/bɪˈstoʊ/`        | v. 赠予；授予（财产、权力或荣誉） | The king bestowed titles on his most loyal subjects. <br>(国王赐予他最忠诚的臣民头衔。) |
| wreck         | `/rɛk/`            | v. 破坏；毁坏<br>n. 失事；残骸 | v. The storm wrecked many homes. <br>(风暴摧毁了许多房屋。)<br>n. The shipwreck was discovered after many years. <br>(许多年后发现了这艘船的残骸。) |
| earther       | `/ˈɜːrθər/`        | n. 地球人 (非正式，常用于科幻)   | As an earther, he found the alien planet fascinating. <br>(作为地球人，他发现这个外星球很迷人。) |
| irradiation   | `/ɪˌreɪdiˈeɪʃən/`  | n. 照射；辐射             | The food underwent irradiation to kill bacteria. <br>(食物经过辐射处理以杀死细菌。) |
| irradiate     | `/ɪˈreɪdieɪt/`     | v. 照射；辐射             | They use ultraviolet light to irradiate the surgical instruments. <br>(他们使用紫外线照射手术工具。) |
| unit          | `/ˈjuːnɪt/`        | n. 单位；单元；部件          | The meter is a unit of length. <br/>(米是长度单位。)<br />Each unit of the textbook covers a different topic. <br>(教科书的每个单元涵盖一个不同的主题。)<br />control unit. 控制器/控制部件。 |
...
| forth      | `/fɔːrθ/          | adv. 向前；向外              | He set forth on his journey at dawn. <br>(他在黎明时分开始了他的旅程。) |
...
| bang       | `/bæŋ/            | n. 巨响；猛击<br>v. 猛击；发出巨响 ✅ | n. We heard a loud bang outside. <br>(我们在外面听到了一声巨响。)<br>v. He banged the door shut. <br>(他砰地关上了门。) |
...
| 单词          | 美式发音                | 词性 + 汉语释义                      |
|---------------|-------------------------|-------------------------------------|
| blown away    | `/bloʊn əˈweɪ/`        | phr. 震惊；惊讶                      |
| dynasty       | `/ˈdaɪnəsti/`          | n. 王朝；朝代                        |
| fascinate     | `/ˈfæsəˌneɪt/`         | v. 迷住；吸引                        |
| degree        | `/dɪˈɡri/`             | n. 程度；学位                        |
| lean          | `/lin/`                | adj. 瘦的；贫乏的<br>v. 倾斜；依靠      |
| humble        | `/ˈhʌmbəl/`            | adj. 谦逊的；卑微的<br>v. 使谦逊      |
| depart        | `/dɪˈpɑrt/`            | v. 离开；出发                        |
| departure     | `/dɪˈpɑrtʃər/`         | n. 离开；出发                        |
| cope          | `/koʊp/`               | v. 应对；处理                        |
| communicate   | `/kəˈmjunɪˌkeɪt/`      | v. 交流；传达                        |
| kind          | `/kaɪnd/`              | adj. 善良的；友好的<br>n. 种类        |
| significant   | `/sɪɡˈnɪfɪkənt/`      | adj. 重要的；显著的                  |
| interminable  | `/ɪnˈtɜrmɪnəbəl/`     | adj. 无尽的；冗长的                  |
| recruit       | `/rɪˈkrut/`            | v. 招募；吸收<br>n. 新兵；新成员       |
| recruitment   | `/rɪˈkruːtmənt/`      | n. 招募；招聘                        |
| objection     | `/əbˈdʒɛkʃən/`        | n. 反对；异议                        |
| stalk         | `/stɔk/`               | n. 茎；秆<br>v. 跟踪；潜近            |
| proton        | `/ˈproʊtɑn/`           | n. 质子                             |
| pack          | `/pæk/`                | n. 包裹；一群<br>v. 打包；塞满         |
...
| 单词           | 美式发音           | 词类 + 汉语释义              | 示例                                                         |
|---------------|-------------------|------------------------| ------------------------------------------------------------ |
| gossip        | `/ˈɡɑːsɪp/`        | n. 八卦，闲聊；v. 闲聊    | n. She loves to share the latest gossip.<br>(她喜欢分享最新的八卦。)<br>v. They gossiped about their neighbors.<br>(他们闲聊关于他们邻居的事情。) |
...
| giggle        | `/ˈɡɪɡəl/`       | v. 咯咯笑                     |
| channel       | `/ˈtʃænəl/`      | n. 频道；渠道；海峡<br>v. 引导；传送    |
| channeling    | `/ˈtʃænəlɪŋ/`    | v. 引导，传送<br />（channel的ing形式） |
| laboratory    | `/ˈlæbrətɔːri/`  | n. 实验室                     |
| resonate      | `/ˈrezəneɪt/`    | v. 共鸣；共振；回响                |
| resonance     | `/ˈrezənəns/`    | n. 共鸣；共振；回响                |
| resonant      | `/ˈrezənənt/`    | adj. 洪亮的；共鸣的；共振的           |
| creek         | `/kriːk/`        | n. 小溪，小河                   |
| guardian      | `/ˈɡɑːrdiən/`    | n. 监护人；守护者                 |
| conclude      | `/kənˈkluːd/`    | v. 结束，总结                   |
| stall         | `/stɔːl/`        | n. 摊位；畜栏；<br />v. 使失速；拖延   |
| conduct     | `/kənˈdʌkt/` (v.)<br>`/ˈkɑndʌkt/` (n.) | v. 进行；指挥<br>n. 行为；管理         |
| beneficial  | `/ˌbɛnəˈfɪʃəl/`    | adj. 有益的                           |
| sue         | `/su/`             | v. 起诉                               |
| scheme      | `/skim/`           | n. 计划；阴谋<br>v. 策划；密谋        |
| gentleman   | `/ˈdʒɛntəlmən/`    | n. 绅士；有教养的人                     |
| limp        | `/lɪmp/`           | v. 跛行<br>n. 跛行<br>adj. 无力的     |
| digest      | `/daɪˈdʒɛst/` (v.)<br>`/ˈdaɪdʒɛst/` (n.) | v. 消化；理解<br>n. 摘要               |
| generally   | `/ˈdʒɛnərəli/`     | adv. 通常；总体上                            |
| major       | `/ˈmeɪdʒər/`       | adj. 主要的<br>n. 主修课程；少校<br>v. 主修  |
| tire        | `/taɪr/`           | v. 使疲倦；厌倦<br>n. 轮胎             |
...
注：下面 2 个表格（已合并成一个）的单词已写到 Goodnotes - 笔记日期：2024.04.07, 2024.04.08
...
| 单词           | 美式发音               | 词类 + 汉语释义                         | 示例 |
|-------------- |--------------------|-----------------------------------|---|
| blind         | `/blaɪnd/`         | adj. 失明的；盲目的 <br>v. 使失明 <br>n. 百叶窗 | adj. He has been blind since birth. <br>(他生来就是盲人。)<br>adj. Her blind devotion to him was concerning. <br>(她对他的盲目奉献令人担忧。)<br>v. The bright light temporarily blinded him. <br>(明亮的灯光暂时让他失明了。)<br>n. The sunlight filtered through the blinds. <br>(阳光透过百叶窗洒进来。) |
| draw          | `/drɔː/`           | v. 画；拉；吸引<br/>n. 抽签；平局            | v. She loves to draw portraits. <br>(她喜欢画肖像。)<br>v. He drew the curtains to block out the light. <br>(他拉上窗帘挡住了光线。)<br>v. The event drew a large crowd. <br>(这次活动吸引了大量人群。)<br>n. The teams ended the match in a draw. <br>(两队比赛以平局结束。)<br>n. They held a draw to decide the winner. <br>(他们进行了抽签决定胜者。) |
| urgent        | `/ˈɜrdʒənt/`       | adj. 紧急的                          | adj. The matter is urgent and needs immediate attention. <br>(这件事很紧急，需要立即处理。) |
| variety       | `/vəˈraɪəti/`      | n. 多样性；(动植物的)种类；综艺节目              | n. There is a great variety of books in the library. <br>(图书馆里有种类繁多的书籍。)<br>n. This variety of apple is particularly sweet. <br>(这种苹果特别甜。)<br>n. The show was a hit with its mix of comedy and variety acts. <br>(这场综艺节目因其混合了喜剧和各种表演而广受欢迎。) |
| comment       | `/ˈkɑːmɛnt/`       | n. 评论；意见；<br />v. 评论；发表意见         | n. His comment sparked a heated debate. <br>(他的评论引发了激烈的辩论。)<br>v. She declined to comment on the issue. <br>(她拒绝对这个问题发表评论。) |
| collision     | `/kəˈlɪʒən/`       | n. 碰撞；冲突                          | n. The collision between the two cars caused a massive traffic jam. <br>(两辆车的碰撞造成了严重的交通堵塞。) |
| existential   | `/ˌɛɡzɪˈstɛnʃəl/`   | adj. 存在主义的；存在的                    | adj. The philosopher discussed existential questions about life. <br>(哲学家讨论了有关生命的存在主义问题。) |
| route         | `/ruːt/`           | n. 路线；途径 <br>v. 按特定路线运送           | n. This is the most scenic route to the beach. <br>(这是去海滩最美的路线。)<br>v. The package was routed through New York. <br>(包裹通过纽约转运。) |
| euphony       | `/ˈjuːfəni/`        | n. 悦耳的声音                          | n. The euphony of the wind chimes was calming. <br>(风铃的悦耳声音让人感到平静。) |
| boa           | `/ˈboʊə/`           | n. 蟒蛇；女用长围巾                       | n. She wore a stylish boa around her neck. <br>(她脖子上围着一条时尚的长围巾。)<br>n. The boa constrictor is a large snake found in tropical regions. <br>(蟒蛇是一种生活在热带地区的大型蛇类。) |
| essential     | `/ɪˈsɛnʃəl/`        | adj. 必要的；本质的 <br>n. 必需品           | adj. Water is essential for life. <br>(水是生命必需的。)<br>adj. The essential point of the argument was missed. <br>(争论的关键点被忽略了。)<br>n. The backpack contains all the camping essentials. <br>(背包里装着所有的露营必需品。) |
| volcano       | `/vɑːlˈkeɪnoʊ/      | n. 火山                             | n. Mount St. Helens is an active volcano. <br>(圣海伦火山是一座活火山。) |
| charm         | `/tʃɑːrm/`         | n. 魅力；魔力 <br>v. 吸引                | n. She was captivated by his charm. <br>(她被他的魅力所吸引。)<br>v. The magician charmed the audience with his tricks. <br>(魔术师用他的魔术吸引了观众。) |
| charming      | `/ˈtʃɑːrmɪŋ/`      | adj. 迷人的；有魅力的                     | adj. The old town is charming with its cobblestone streets. <br>(古老的城镇以其鹅卵石街道而迷人。) |
| examine       | `/ɪɡˈzæmɪn/`       | v. 检查；考核                          | v. The doctor examined the patient thoroughly. <br>(医生彻底检查了病人。) |
| extraordinary | `/ɪkˈstrɔːrdəneri/` | adj. 非凡的；特别的                      | adj. She has an extraordinary talent for music. <br>(她在音乐方面有非凡的天赋。) |
| cut           | `/kʌt/`            | v. 切；削减<br>n. 切口；削减               | v. She cut the cake into small pieces. <br>(她把蛋糕切成了小块。)<br>v. The company cut costs by 20%. <br>(公司削减了20%的成本。)<br>n. He had a deep cut on his arm. <br>(他的手臂上有一个很深的切口。)<br>n. The budget cuts affected many departments. <br>(预算削减影响了许多部门。) |
| bright        | `/braɪt/`          | adj. 明亮的；聪明的                      | adj. The room was bright and airy. <br>(房间明亮通风。)<br>adj. She is one of the brightest students in the class. <br>(她是班上最聪明的学生之一。) |
| flight        | `/flaɪt/`          | n. 航班；飞行                          | n. Our flight was delayed due to bad weather. <br>(由于天气不好，我们的航班延误了。)<br>n. The bird's flight was graceful. <br>(这只鸟的飞行很优雅。) |
| dying         | `/ˈdaɪɪŋ/`         | adj. 垂死的；临终的<br>v. 死（die 的现在分词）   | adj. The old man gave his dying wish. <br>(老人说出了他的临终遗愿。)<br>v. The flowers are dying without water. <br>(没有水，花儿正在枯萎。) |
| sally         | `/ˈsæli/`          | n. 突围<br>v. 突围                    | n. The soldiers made a sally against the enemy lines. <br>(士兵们对敌方阵线发起了突围。)<br>v. They sallied forth to meet the challenge. <br>(他们勇敢地迎接挑战。) |
| dictation     | `/dɪkˈteɪʃən/`     | n. 听写；口述                          | n. The teacher gave the students a dictation test. <br>(老师给学生们进行了一次听写测试。) |
| ordinary      | `/ˈɔːrdəneri/`     | adj. 普通的；平凡的                      | adj. It was an ordinary day at work. <br>(那是工作中普通的一天。) |
| bid           | `/bɪd/`            | v. 出价；投标<br>n. 出价；投标              | v. He bid $100 for the painting. <br>(他为这幅画出价100美元。)<br>v. The company is bidding for a new contract. <br>(公司正在竞标一个新合同。)<br>n. His bid was the highest. <br>(他的出价是最高的。)<br>n. They submitted their bid for the project. <br>(他们提交了项目的投标书。) |
| construction  | `/kənˈstrʌkʃən/`   | n. 建造；建筑物                         | n. The construction of the new bridge will start next year. <br>(新桥的建造将于明年开始。)<br>n. The construction is expected to be completed in two years. <br>(建筑物预计将在两年内完工。) |
| investment    | `/ɪnˈvestmənt/`    | n. 投资（款项、对象）；〔大量时间﹑精力﹑情感等的〕投入     | n. His investment in the stock market paid off. <br>(他在股市的投资得到了回报。)<br>n. Her emotional investment in the project was significant. <br>(她在这个项目上的情感投入非常大。) |
| lifelong      | `/ˈlaɪfˌlɒːŋ/`     | adj. 终生的                          | adj. They were lifelong friends. <br>(他们是终生的朋友。) |
| furious       | `/ˈfjʊriəs/`       | adj. 愤怒的；激烈的                      | adj. She was furious when she found out about the lie. <br>(当她发现那个谎言时，她非常愤怒。)<br>adj. The debate was furious and lasted for hours. <br>(辩论非常激烈，持续了好几个小时。) |
| cheer         | `/tʃɪr/`           | n. 欢呼；喝彩 <br>v. 欢呼；鼓舞             | n. The crowd erupted in cheer as the team scored. <br>(球队得分时，观众欢呼雀跃。)<br>v. They cheered for their favorite player. <br>(他们为他们最喜欢的球员欢呼。)<br>v. Her words cheered him up. <br>(她的话鼓舞了他。) |
| cheers        | `/tʃɪrz/`          | interj. 干杯                        | interj. They raised their glasses and said, "Cheers!" <br>(他们举起杯子说：“干杯！”) |
| spoil         | `/spɔɪl/`          | v. 破坏；宠坏；变质<br>n. 战利品             | v. The rain spoiled our picnic. <br>(雨水破坏了我们的野餐。)<br>v. They always spoil their grandchildren. <br>(他们总是宠坏他们的孙子孙女。)<br>v. The food spoiled after being left out overnight. <br>(食物放了一夜后变质了。)<br>n. The soldiers divided the spoils of war. <br>(士兵们分了战利品。) |
| haggard       | `/ˈhæɡərd/`        | adj. (面容)憔悴的                      | adj. He looked haggard after working long hours. <br>(长时间工作后，他看起来很憔悴。) |
| sneer         | `/snɪr/`           | v. 嘲笑<br>n. 嘲笑                    | v. He sneered at their naive comments. <br>(他嘲笑他们天真的评论。)<br>n. She responded to the insult with a sneer. <br>(她对侮辱报以嘲笑。) |
...
Edit: 2024.08.02、03、5

~~注：下面表格单词已写到 Goodnotes；日期见：2024.00.00~~

| 单词          | 美式发音              | 词性 + 汉语释义         |
|-------------|-------------------|-------------------|
| desiccate   | `/ˈdesɪˌkeɪt/`    | v. 使干燥；使脱水        |
| desiccative | `/ˈdesɪˌkeɪtɪv/`  | adj. 干燥的；脱水的      |
| desiccator  | `/ˈdesɪˌkeɪtər/`  | n. 干燥器            |
| cult        | `/kʌlt/`          | n. 邪教；狂热崇拜      |
| decimate    | `/ˈdesəmeɪt/`     | v. 大量毁灭；使人口骤减     |
| pussy       | `/ˈpʊsi/`         | n. 猫咪（非正式用语）；阴部（粗俗用语） |
| delusion    | `/dɪˈluːʒən/`     | n. 错觉；妄想          |
| delusional  | `/dɪˈluːʒənəl/`   | adj. 错觉的；妄想的      |
| sort        | `/sɔːrt/`         | n. 种类；类别 <br>v. 分类；解决（问题或困难） |
| respite     | `/ˈrespɪt/`       | n. 喘息；暂缓          |
| catalogue   | `/ˈkætəlɔːɡ/`     | n. 目录；一系列（坏事、事件）<br>v. 将… 编入目录 |
| pasture     | `/ˈpæstʃər/`      | n. 牧场；草地<br>v. 放牧 |
| pastureland | `/ˈpɑːstʃərlænd/` | n. 牧场      |
| cow         | `/kaʊ/`           | n. 母牛<br>v. 恐吓    |
| convergence | `/kənˈvɜːrdʒəns/` | n. 汇聚；会合          |
| convergent  | `/kənˈvɜːrdʒənt/` | adj. [数] 收敛的；汇聚的  |
| world       | `/wɜːrld/`        | n. 世界；地球；人类社会    |
| dose        | `/doʊs/`          | n. 剂量<br>v. 给〔某人〕服药    |
| tributary   | `/ˈtrɪbjəteri/`   | n. 支流<br>adj. 纳贡的；附属的 |
| semester    | `/səˈmestər/`     | n. 〔尤指美国中学和大学的〕一学期﹐半学年  |
| Ergenbright | `/ˈɜːrdʒənbraɪt/` | n. 人名（埃根布赖特）      |
| counsel     | `/ˈkaʊnsəl/`      | n. 律师；建议<br>v. 劝告 |
| counsellor  | `/ˈkaʊnsələr/`    | n. 顾问；辅导员         |
| Satanic     | `/səˈtænɪk/`      | adj. 撒旦的；恶魔的      |
| worship     | `/ˈwɜːrʃɪp/`      | n. 崇拜<br>v. 崇拜    |
| rev         | `/rev/`           | n. 一转<br>v. 旋转    |
| postpone    | `/poʊsˈpoʊn/`     | v. 推迟；延期          |
| sadistic    | `/səˈdɪstɪk/`     | adj. 施虐的；虐待狂的     |
...
| chew           | `/tʃuː/`          | v. 咀嚼；深思              | He chews slowly to savor his food.<br />(他慢慢咀嚼以享受食物。) |
...
| 单词              | 美式发音                 | 词性 + 汉语释义              | 示例 |
|-------------------|----------------------|------------------------|---|
| tap               | `/tæp/`              | n. 龙头；轻敲<br>v. 轻敲；开发   | n. She turned the tap to get some water. <br>(她打开水龙头取水。)<br>n. He gave the door a gentle tap. <br>(他轻轻敲了敲门。)<br>v. He tapped the table with his fingers. <br>(他用手指轻敲桌子。)<br>v. The company tapped into new markets. <br>(公司开发了新市场。) |
| faucet            | `/ˈfɔsɪt/`           | n. 水龙头                 | n. The faucet in the kitchen is leaking. <br>(厨房的水龙头漏水了。) |
| tangent           | `/ˈtændʒənt/`        | n. 正切（数学）；切线；突然转移话题    | n. The tangent to the curve was calculated. <br>(曲线的切线被计算出来了。)<br>n. He went off on a tangent during the conversation. <br>(他在谈话中突然转移了话题。) |
| process           | `/ˈprɑːses/`         | n. 过程；工序<br>v. 加工；处理   | n. The process took several hours to complete. <br>(这个过程花了好几个小时才完成。)<br>n. The manufacturing process is very complex. <br>(制造工序非常复杂。)<br>v. The factory processes raw materials into finished goods. <br>(工厂将原材料加工成成品。)<br>v. The computer processes data quickly. <br>(计算机快速处理数据。) |
| embellish         | `/ɪmˈbelɪʃ/`         | v. 装饰；美化               | v. She likes to embellish her stories with details. <br>(她喜欢用细节来美化她的故事。) |
| instruction       | `/ɪnˈstrʌkʃən/`      | n. 指示；说明               | n. He gave clear instructions to the team. <br>(他给团队下达了明确的指示。) |
| fortress          | `/ˈfɔːrtrəs/`        | n. 堡垒；要塞               | n. The fortress was built to protect the city. <br>(这座堡垒是为了保护城市而建造的。) |
| troop             | `/truːp/`            | n. 部队；一群<br>v. 成群结队    | n. The troops were deployed to the border. <br>(部队被部署到边境。)<br>n. A troop of monkeys was spotted in the forest. <br>(在森林里看到了一群猴子。)<br>v. The children trooped into the classroom. <br>(孩子们成群结队地进入教室。) |
| bloke             | `/bloʊk/`            | n. 小伙子                 | n. He's a nice bloke once you get to know him. <br>(一旦你了解他，他是一个很好的人。) |
| factorial         | `/fækˈtɔːriəl/`      | n. 阶乘                  | n. The factorial of 5 is 120. <br>(5的阶乘是120。) |
| consideration     | `/kənˌsɪdəˈreɪʃən/`  | n. 考虑；体谅               | n. After careful consideration, he decided to accept the job offer. <br>(经过仔细考虑，他决定接受工作邀请。) |
| think about       | `/θɪŋk əˈbaʊt/`      | v. 考虑                  | v. She needs some time to think about the proposal. <br>(她需要一些时间来考虑这个提议。) |
| think over        | `/θɪŋk ˈoʊvər/`      | v. 仔细考虑                | v. He decided to think over the decision before committing. <br>(他决定在做决定前仔细考虑一下。) |
| torture           | `/ˈtɔːrtʃər/`        | n. 拷打；折磨<br>v. 拷打；折磨   | n. The prisoner endured hours of torture. <br>(囚犯忍受了数小时的拷打。)<br>v. They tortured him to extract information. <br>(他们拷打他以获取信息。) |
| grip              | `/ɡrɪp/`             | n. 紧握；控制<br>v. 紧握；控制   | n. He has a strong grip on the steering wheel. <br>(他紧紧握住方向盘。)<br>n. The country is in the grip of a severe drought. <br>(这个国家正处于严重干旱的控制之下。)<br>v. She gripped his hand tightly. <br>(她紧紧握住他的手。)<br>v. The movie gripped the audience from start to finish. <br>(这部电影从头到尾吸引了观众。) |
| gluten            | `/ˈɡluːtn/`          | n. 面筋                  | n. Many people are allergic to gluten. <br>(很多人对面筋过敏。) |
| regain            | `/rɪˈɡeɪn/`          | v. 重新获得；恢复             | v. He worked hard to regain his health after the accident. <br>(事故后他努力恢复健康。) |
| gene              | `/dʒiːn/`            | n. 基因                  | n. Scientists discovered a gene associated with the disease. <br>(科学家发现了与这种疾病相关的基因。) |
| participate       | `/pɑːrˈtɪsəpeɪt/`    | v. 参与；参加               | v. Everyone is encouraged to participate in the discussion. <br>(鼓励每个人参与讨论。) |
| screening         | `/ˈskriːnɪŋ/`        | n. 筛查；放映               | n. The screening for the disease is mandatory. <br>(这种疾病的筛查是强制性的。)<br>n. They attended a private screening of the film. <br>(他们参加了电影的私人放映会。) |
| cognitive         | `/ˈkɑːɡnətɪv/`       | adj. 认知的               | adj. Cognitive development is crucial in early childhood. <br>(认知发展在幼儿时期至关重要。) |
| enslave           | `/ɪnˈsleɪv/`         | v. 奴役                  | v. The regime enslaved thousands of people. <br>(这个政权奴役了成千上万的人。) |
| close-at-hand     | `/kloʊs æt hænd/`    | adj. 近在手边的             | adj. Keep your phone close-at-hand in case of emergencies. <br>(在紧急情况下，把手机放在手边。) |
| intimate          | `/ˈɪntəmət/`         | adj. 亲密的；隐私的 <br>n. 密友 | adj. They have an intimate relationship. <br>(他们关系亲密。)<br>adj. She shared intimate details of her life. <br>(她分享了生活中的隐私细节。)<br>n. He is one of her closest intimates. <br>(他是她最亲密的朋友之一。) |
...
| 单词             | 美式发音                 | 词性 + 汉语释义         |
|------------------|----------------------|-------------------|
| puke             | `/pjuːk/`            | v. 呕吐<br>n. 呕吐(物) |
| dude             | `/duːd/`             | n. <美，非正式>家伙，小子   |
| dud              | `/dʌd/`              | n. 哑弹；无用的东西       |
| impersonate      | `/ɪmˈpɜːrsəneɪt/`    | v. 冒充；模仿          |
| impersonation    | `/ɪmˌpɜːrsəˈneɪʃən/` | n. 模仿；假扮          |
| explode          | `/ɪkˈsploʊd/`        | v. 爆炸；激增          |
| decadence        | `/ˈdekədəns/`        | n. 堕落；颓废          |
| rig              | `/rɪɡ/`              | v. 装配；操纵<br>n. 设备 |
| hinge            | `/hɪndʒ/`            | n. 铰链；关键点<br>v. 安装铰链 |
| corn             | `/kɔrn/`             | n. 玉米；谷物          |
| synth            | `/sɪnθ/`             | n. 合成器            |
| bald             | `/bɒːld/`            | adj. 秃头的；光秃的      |
| facility         | `/fəˈsɪləti/`        | n. 设施；设备          |
| ventilation      | `/ˌvɛntəˈleɪʃən/`    | n. 通风；通风设备        |
| infectious       | `/ɪnˈfekʃəs/`        | adj. 传染的；有感染力的    |
...
注：下面表格单词已写到 Goodnotes -  笔记日期：24.04.01、02、06
...
| 单词                       | 美式发音           | 词类 + 汉语释义            | 示例                                                         |
|--------------------------| -------------- |----------------------| ------------------------------------------------------------ |
| preface                  | `/ˈprefəs/`    | n. 前言；序言             | The author wrote a touching preface for her novel.<br/>(作者为她的小说写了一段感人的前言。)<br />The author added a personal anecdote in the preface.<br>(作者在序言中加入了一个个人轶事。) |
...
| dine                     | `/daɪn/`       | v. 吃饭；进餐             | They dined under the stars on the beach.<br>(他们在海滩上的星空下用餐。) |
...
| state-of-the-art         | ` /'steitəvði:'a:t/` | adj. 最先进的            | The laboratory is equipped with state-of-the-art instruments.<br>(实验室配备了最先进的仪器。) |
...
| 单词          | 美式发音                | 词性 + 汉语释义                    | 示例 |
|-------------|-------------------------|------------------------------|---|
| proud       | `/praʊd/`        | adj. 自豪的；骄傲的           | adj. She felt proud of her accomplishments. <br>(她为自己的成就感到自豪。)<br>adj. He can be a bit too proud sometimes. <br>(他有时会有点骄傲。) |
| float       | `/floʊt/`        | v. 漂浮；浮动<br>n. 漂浮物；浮点数 | v. The boat began to float on the water. <br>(船开始在水面上漂浮。)<br>v. The currency can float freely in the market. <br>(货币可以在市场上自由浮动。)<br>n. There was a float in the parade. <br>(游行中有一个花车。)<br>n. The computer handles calculations with float values. <br>(计算机处理浮点数值的计算。) |
| attain      | `/əˈteɪn/`       | v. 达到；获得               | v. He worked hard to attain his goals. <br>(他努力工作以达到他的目标。)<br>v. She attained a high level of proficiency in English. <br>(她的英语水平达到了很高的程度。) |
| honorable   | `/ˈɑːnərəbəl/`   | adj. 光荣的；可敬的           | adj. He is considered an honorable man. <br>(他被认为是一个可敬的人。)<br>adj. She received an honorable mention for her work. <br>(她的工作获得了荣誉提名。) |
| sandal      | `/ˈsændl/`       | n. 凉鞋                  | n. She bought a new pair of sandals for the summer. <br>(她为夏天买了一双新凉鞋。) |
| commute     | `/kəˈmjuːt/`     | v. 通勤；减刑               | v. She commutes to work every day by train. <br>(她每天乘火车通勤。)<br>v. The governor commuted his sentence. <br>(州长减轻了他的刑罚。) |
| transparent | `/trænsˈpærənt/` | adj. 透明的；显而易见的         | adj. The glass is completely transparent. <br>(玻璃是完全透明的。)<br>adj. His intentions were transparent. <br>(他的意图是显而易见的。) |
| desire      | `/dɪˈzaɪər/`     | n. 渴望；欲望<br>v. 渴望      | n. His desire for knowledge is insatiable. <br>(他对知识的渴望是无法满足的。)<br>n. She felt a strong desire to help others. <br>(她感到强烈的帮助他人的欲望。)<br>v. He desires to become a great artist. <br>(他渴望成为一名伟大的艺术家。) |
| desirous    | `/dɪˈzaɪərəs/`   | adj. 渴望的               | adj. She is desirous of a better future. <br>(她渴望有一个更美好的未来。) |
| endless     | `/ˈendləs/`      | adj. 无止境的；无尽的          | adj. The possibilities are endless. <br>(可能性是无止境的。)<br>adj. They faced an endless stream of challenges. <br>(他们面临着无尽的挑战。) |
| invoke      | `/ɪnˈvoʊk/`      | v. 调用；祈求               | v. The program can invoke several functions. <br>(程序可以调用多个函数。)<br>v. He invoked the blessings of the gods. <br>(他祈求神的祝福。) |
| spray       | `/spreɪ/`        | v. 喷洒<br>n. 喷雾         | v. She sprayed perfume on her wrist. <br>(她在手腕上喷了香水。)<br>n. The spray from the ocean felt refreshing. <br>(海洋的喷雾让人感到清爽。) |
| steal       | `/stiːl/`        | v. 偷窃                  | v. Someone tried to steal my wallet. <br>(有人试图偷我的钱包。) |
| ink         | `/ɪŋk/`          | n. 墨水<br>v. 签署         | n. The pen ran out of ink. <br>(这支笔没墨水了。)<br>v. They inked the contract yesterday. <br>(他们昨天签署了合同。) |
| practice    | `/ˈpræktɪs/`     | n. 练习；实践<br>v. 练习；从事   | n. She has piano practice every day. <br>(她每天都练习弹钢琴。)<br>n. The theory needs to be tested in practice. <br>(理论需要在实践中检验。)<br>v. He practices playing the guitar daily. <br>(他每天练习弹吉他。)<br>v. She practices law in New York. <br>(她在纽约从事法律工作。) |
| humble      | `/ˈhʌmbəl/`      | adj. 谦逊的；卑微的           | adj. Despite his success, he remains humble. <br>(尽管取得了成功，他依然谦逊。)<br>adj. They lived in humble conditions. <br>(他们生活在卑微的条件下。) |
| minute      | `/ˈmɪnɪt/`(n.)<br>`/maɪˈnuːt/`(adj.) | n. 分钟<br>adj. 微小的      | n. The meeting lasted for 30 minutes. <br>(会议持续了30分钟。)<br>adj. There was a minute crack in the glass. <br>(玻璃上有一道微小的裂缝。) |
| brush       | `/brʌʃ/`         | n. 刷子；轻触<br>v. 刷；掠过    | n. She used a brush to paint the wall. <br>(她用刷子刷墙。)<br>n. He felt a brush of wind on his face. <br>(他感觉到脸上有一阵微风拂过。)<br>v. She brushes her teeth twice a day. <br>(她每天刷两次牙。)<br>v. The cat brushed against my leg. <br>(猫掠过我的腿。) |
...
注：下面表格单词已写到 Goodnotes - 笔记日期：2024.03.18-19

| 单词         | 美式发音            | 词类 + 汉语释义              | 示例                                                         |
|-------------|--------------------|------------------------| ------------------------------------------------------------ |
| phrase      | `/freɪz/`          | n. 短语；措辞；<br />v. 表达   | n. Music often relies on a catchy phrase. <br />(音乐经常依赖于一个朗朗上口的短语。)<br />n. A common phrase in English is "break the ice." <br />(英语中一个常见的短语是“打破沉默”。)<br />v. She phrased her criticism very tactfully. <br />(她非常巧妙地表达了她的批评。)<br />v. He phrased his request very politely. <br />(他非常礼貌地表达了他的请求。) |
...
| 单词             | 美式发音                | 词类 + 汉语释义            | 示例                             |
|----------------|---------------------|----------------------| ------------------------------------------------------------ |
| prey           | `/preɪ/`            | n. 猎物；v. 捕食   | n. The lion quietly stalked its prey. <br />(狮子悄悄地追踪着它的猎物。)<br>v. Owls prey on small mammals. <br />(猫头鹰捕食小型哺乳动物。)<br />n. The tiger stalked its prey in the shadows.<br/>(老虎在阴影中悄悄跟踪其猎物。)<br/>v. Owls prey on mice and other small animals.<br/>(猫头鹰捕食老鼠和其他小动物。) |
| stalk          | `/stɔːk/`           | v. 悄悄跟踪；n. 茎 | v. The cat stalked the bird before pouncing. <br />(猫在扑向鸟之前悄悄地跟踪它。)<br>n. She cut the stalks off the flowers. <br />(她剪掉了花的茎。) |
| groan          | `/ɡroʊn/`           | v. 呻吟；n. 呻吟声  | v. The patient groaned in pain. <br />(病人痛苦地呻吟。)<br>n. A groan of disappointment filled the room. <br />(房间里充满了失望的呻吟声。) |
| disappointment | `/ˌdɪsəˈpɔɪntmənt/` | n. 失望             | His failure to win the race was a big disappointment. <br />(他未能赢得比赛是一个巨大的失望。) |
| appoint        | `/əˈpɔɪnt/`         | v. 任命；指定      | She was appointed as the new manager. <br />(她被任命为新经理。)<br>We appointed a meeting for next week. <br />(我们安排了下周的会议。) |
| failure        | `/ˈfeɪljər/`        | n. 失败；故障      | His attempt to climb the mountain ended in failure. (他试图攀登这座山，但以失败告终。)<br>The failure of the engine caused the car to stop. (引擎故障导致汽车停止运行。) |
...
**注：下面表格单词已写到 Goodnotes；日期见：2024.06.24；但是笔记所在位置在 2024.02.26、27 的笔记的上上一页**

| 单词            | 美式发音                 | 词性 + 汉语释义           | 示例                                                                                                |
|----------------|----------------------|---------------------|---------------------------------------------------------------------------------------------------|
| chemical      | `/ˈkɛmɪkəl/`         | adj. 化学的；n. 化学制品    | adj. The chemical reaction was fascinating. <br>(化学反应很有趣。)<br>n. The factory produces industrial chemicals. <br>(工厂生产工业化学制品。) |
| underlie      | `/ˌʌndərˈlaɪ/`       | v. 构成…的基础；位于…之下     | The principles that underlie their work are sound. <br>(构成他们工作基础的原则是合理的。)<br>The river underlies the city. <br>(河流位于城市之下。) |
| keep in check | `/kip ɪn tʃɛk/`      | phr. 控制；抑制          | They tried to keep their emotions in check. <br>(他们试图控制自己的情绪。)                                    |
| serotonin     | `/ˌsɛrəˈtoʊnɪn/`     | n. 血清素              | Serotonin levels can affect mood. <br>(血清素水平可以影响情绪。)                                              |
| dopamine      | `/ˈdoʊpəmin/`        | n. 多巴胺              | Dopamine plays a role in reward and pleasure. <br>(多巴胺在奖励和愉悦中起作用。)                                |
...
| contribute    | `/kənˈtrɪbjuːt/`     | v. 贡献；捐献；促成         | He contributed a lot to the project. <br>(他对项目贡献很大。)<br>They contributed money to the charity. <br>(他们向慈善机构捐款。)<br>Good teamwork contributed to the success. <br>(良好的团队合作促成了成功。) |
| wear off      | `/wɛr ɔf/`           | phr. 逐渐消失           | The effects of the medicine will wear off after a few hours. <br>(药效会在几小时后逐渐消失。)                  |
| hang          | `/hæŋ/`              | v. 悬挂；绞死；垂下         | They hung the picture on the wall. <br>(他们把画挂在墙上。)<br>The criminal was hanged for his crimes. <br>(罪犯因其罪行被绞死。)<br>The branches hung low to the ground. <br>(树枝垂到地面。) |
| hangover      | `/ˈhæŋoʊvər/`        | n. 宿醉               | He had a terrible hangover after the party. <br>(派对后他宿醉得很厉害。)                                     |
| otter         | `/ˈɑːtər/`            | n. 水獭               | The otter swam gracefully in the river. <br>(水獭在河里优雅地游泳。)                                         |
| profound      | `/prəˈfaʊnd/`        | adj. 深刻的；深远的        | His speech had a profound impact on the audience. <br>(他的演讲对观众产生了深远的影响。)<br>The book explores profound philosophical questions. <br>(这本书探讨了深刻的哲学问题。) |
| crack         | `/kræk/`             | v. 破裂；破解；<br>n. 裂缝  | The glass cracked when it hit the floor. <br>(玻璃掉到地上时破裂了。)<br>He cracked the code in the computer program. <br>(他破解了计算机程序中的代码。)<br>There was a crack in the wall. <br>(墙上有一道裂缝。) |
...
| 单词            | 美式发音                 | 词性 + 汉语释义           | 示例                                   |
|----------------|----------------------|---------------------|-----------------------------------------------|
| benevolent   | `/bəˈnevələnt/`   | adj. 仁慈的；有意的     | adj. The benevolent leader was loved by all. <br>(仁慈的领袖受到所有人的爱戴。)<br>adj. He made a benevolent gesture by donating to the charity. <br>(他通过向慈善机构捐款做出了一个有意的举动。) |
| righteous    | `/ˈraɪtʃəs/`      | adj. 正义的；正直的     | adj. The righteous judge made a fair decision. <br>(正义的法官做出了公正的决定。)<br>adj. She is known for her righteous conduct in the community. <br>(她因在社区中的正直行为而闻名。) |
| uphold       | `/ʌpˈhoʊld/`      | v. 支持；维护          | v. They vowed to uphold their beliefs. <br>(他们发誓要支持他们的信仰。)<br>v. This decision will uphold the integrity of our legal system. <br>(这一决定将维护我们法律体系的完整性。) |
| autopsy      | `/ˈɒːtɑːpsi/`     | n. 尸体解剖；验尸       | n. The autopsy revealed the cause of death. <br>(尸检揭示了死亡原因。)<br>n. They performed an autopsy to determine the exact cause of death. <br>(他们进行了尸体解剖以确定确切的死因。) |
| logic        | `/ˈlɑːdʒɪk/`      | n. 逻辑；逻辑学          | The professor explained the logic behind the theorem. <br>(教授解释了该定理背后的逻辑。) |
| programmable | `/proʊˈɡræməbəl/` | adj. 可编程的           | The thermostat is programmable. <br>(恒温器是可编程的。) |
| converter    | `/kənˈvɜːrtər/`   | n. 转换器               | The power converter is broken. <br>(电源转换器坏了。) |
| suburban     | `/səˈbɜːrbən/`    | adj. 郊区的             | They moved to a suburban area for a quieter life. <br>(他们搬到郊区寻求更安静的生活。) |
| meant        | `/ment/`          | v. mean 的过去式和过去分词：意思是 | He meant no harm with his words. <br>(他说的话没有恶意。) |
| ought        | `/ɔːt/`           | v. 应该                 | You ought to apologize for your mistake. <br>(你应该为你的错误道歉。) |
| med          | `/med/`           | abbr. 医学的 (medical)  | medical staff 医务人员 <br>a medical student 医科学生|
| binge        | `/bɪndʒ/`         | n. 狂欢；大吃大喝<br>v. 狂饮；大吃大喝 | n. a drinking binge. 一番痛饮<br />n. They went on a shopping binge. <br>(他们进行了一次购物狂欢。)<br>v. He binged on junk food all weekend. <br>(他整个周末都在大吃垃圾食品。)<br />v. Whenever she's depressed, she bings on chocolates. <br />每当情绪低落时她就狂吃巧克力。 |
| binger       | `/ˈbɪndʒər/`      | n. 狂饮者；大吃大喝者     | As a binger, he often regretted his excesses. <br>(作为一个大吃大喝者，他经常后悔自己的过度行为。) |
| flea         | `/fliː/`          | n. 跳蚤                 | The dog was scratching because of a flea infestation. <br>(这只狗因为跳蚤感染而抓痒。) |
| tightrope    | `/ˈtaɪtˌroʊp/`    | n. 钢丝；绳索            | n. Walking a tightrope requires great balance. <br>(走钢丝需要很好的平衡能力。)<br>n. They used a tightrope to secure the tent. <br>(他们用一根绳索固定帐篷。) |
| necrotic     | `/neˈkrɑːtɪk/`    | adj. 坏死的             | The necrotic tissue had to be removed surgically. <br>(坏死的组织必须通过手术切除。) |
| vale         | `/veɪl/`          | n. 谷；溪谷             | They hiked through the picturesque vale. <br>(他们徒步穿越了风景如画的山谷。) |
| theoretic    | `/ˌθiːəˈretɪk/`   | adj. 理论的             | His ideas are purely theoretic. <br>(他的想法纯粹是理论性的。) |
| surround     | `/səˈraʊnd/`      | v. 包围<br>n. 环境      | v. The police surrounded the building. <br>(警察包围了这栋建筑。)<br>n. The surround was beautiful and peaceful. <br>(周围环境美丽而宁静。) |
| ax           | `/æks/`           | n. 斧头<br>v. 削减      | n. He chopped wood with an ax. <br>(他用斧头劈柴。)<br>v. The company had to ax jobs due to budget cuts. <br>(由于预算削减，公司不得不裁员。) |
| asteroid     | `/ˈæstərɔɪd/`     | n. 小行星               | An asteroid is heading towards Earth. <br>(一颗小行星正朝地球飞来。) |
| mastoid      | `/ˈmæstɔɪd/`      | n. 乳突<br>adj. 乳突的   | n. He has an infection in the mastoid. <br>(他在乳突部位有感染。)<br>adj. The mastoid process is located behind the ear. <br>(乳突位于耳朵后面。) |
| knucklehead  | `/ˈnʌkəlˌhɛd/`    | n. 傻瓜                 | Don't be such a knucklehead! <br>(别那么傻了！) |
| in motion    | `/ɪn ˈmoʊʃən/`    | phr. 在运动             | The car was already in motion. <br>(汽车已经在行驶中。) |
| motion       | `/ˈmoʊʃən/`       | n. 动作；提议<br>v. 示意  | n. The motion was passed unanimously. <br>(该提议一致通过。)<br>n. He made a motion to adjourn the meeting. <br>(他提议休会。)<br>v. She motioned for him to come closer. <br>(她示意他靠近。) |
...
| 单词               | 美式发音            | 词性 + 汉语释义                | 示例 |
|------------------|--------------------|--------------------------|---|
| overall          | `/ˌoʊvərˈɔːl/`     | adj. 总体的；全部的<br>adv. 总的来说 | adj. The overall performance was excellent. <br>(整体表现非常出色。)<br>adv. Overall, the project was a success. <br>(总的来说，这个项目是成功的。) |
| discoverability  | `/dɪsˌkʌvərəˈbɪləti/` | n. 可发现性                  | The discoverability of new talent is crucial for the industry. <br>(新人才的可发现性对行业至关重要。) |
| discoverable     | `/dɪsˈkʌvərəbl/`   | adj. 可发现的                | The error was easily discoverable. <br>(这个错误很容易被发现。) |
| endow            | `/ɪnˈdaʊ/`         | v. 捐赠；赋予                 | The philanthropist endowed the university with a large sum of money. <br>(慈善家向大学捐赠了一大笔钱。)<br>She is endowed with great intelligence. <br>(她天赋异禀，非常聪明。) |
| release          | `/rɪˈliːs/`        | v. 释放；发布<br>n. 释放；发布     | v. The prisoner was released after ten years. <br>(囚犯十年后被释放。)<br>n. The release of the new software is scheduled for next month. <br>(新软件的发布定于下个月。) |
| pick             | `/pɪk/`            | v. 挑选；采摘<br>n. 挑选        | v. She picked the best apples from the basket. <br>(她从篮子里挑选了最好的苹果。)<br>n. He made his pick from the available options. <br>(他从可选项中做了选择。) |
| lantern          | `/ˈlæntərn/`       | n. 灯笼                    | She carried a lantern to light her way. <br>(她提着一个灯笼照亮道路。) |
| approve          | `/əˈpruːv/`        | v. 批准；赞成                 | The committee approved the new policy. <br>(委员会批准了新政策。)<br>Her parents approve of her decision. <br>(她的父母赞成她的决定。) |
| basic            | `/ˈbeɪsɪk/`        | adj. 基本的；基础的             | She has a basic understanding of mathematics. <br>(她对数学有基本的理解。) |
| slam             | `/slæm/`           | v. 砰地关上；猛烈抨击<br>n. 砰的一声  | v. He slammed the door in anger. <br>(他愤怒地砰地关上了门。)<br>n. There was a loud slam as the door closed. <br>(门关上的时候发出了一声巨响。) |
| picnic           | `/ˈpɪknɪk/`        | n. 野餐<br>v. 去野餐          | n. We had a picnic by the lake. <br>(我们在湖边野餐。)<br>v. They often picnic in the park on weekends. <br>(他们经常在周末去公园野餐。) |
| prudent          | `/ˈpruːdənt/`      | adj. 谨慎的                 | It's prudent to save some money for emergencies. <br>(存一些钱以备不时之需是明智的。) |
| mnemonic         | `/nɪˈmɑːnɪk/`      | n. 记忆术；助记符               | He used a mnemonic to remember the list of words. <br>(他用了一个助记符来记住这串单词。) |
| paraphrase       | `/ˈpærəˌfreɪz/`    | v. 释义；改述<br>n. 释义        | v. He paraphrased the passage in his own words. <br>(他用自己的话改述了这段话。)<br>n. The paraphrase made the original text easier to understand. <br>(这个释义使原文更容易理解。) |
...
| 单词          | 美式发音            | 词类 + 汉语释义         | 示例 |
| ----------- |-----------------|-------------------|---|
| suppress    | `/səˈpres/`     | v. 镇压；抑制          | The government tried to suppress the protests. <br>(政府试图镇压抗议。)<br>She couldn't suppress her laughter. <br>(她无法抑制住笑声。) |
| adapt       | `/əˈdæpt/`      | v. 适应；改编          | He had to adapt to the new environment. <br>(他不得不适应新环境。)<br>The book was adapted into a movie. <br>(这本书被改编成电影。) |
| uncomment   | `/ʌnˈkɑːment/`  | v. 去掉注释           | Please uncomment the code to enable the feature. <br>(请去掉注释以启用该功能。) |
| squash      | `/skwɑːʃ/`      | v. 压扁；镇压<br>n. 壁球 | v. She squashed the bug with her shoe. <br>(她用鞋子压扁了那只虫子。)<br>v. The regime squashed the rebellion. <br>(政权镇压了叛乱。)<br>n. He plays squash every Saturday. <br>(他每周六打壁球。) |
| sleep       | `/sliːp/`       | v. 睡觉<br>n. 睡眠    | v. I usually sleep eight hours a night. <br>(我通常每晚睡八个小时。)<br>n. Lack of sleep can affect your health. <br>(缺乏睡眠会影响健康。) |
| marble      | `/ˈmɑːrbəl/`    | n. 大理石；弹珠         | The statue is made of marble. <br>(这座雕像是用大理石做的。)<br>Children played with marbles in the yard. <br>(孩子们在院子里玩弹珠。) |
| dug         | `/dʌɡ/`         | v. dig 的过去式和过去分词：挖 | He dug a hole in the backyard. <br>(他在后院挖了一个洞。) |
| deposit     | `/dɪˈpɑːzɪt/`   | n. 订金；押金；存款<br>v. 存放；沉积 | n. We paid a deposit on the house. <br>(我们付了房子的订金。)<br>n. They asked for a security deposit. <br>(他们要求支付保证金。)<br>n. I have a savings deposit in the bank. <br>(我在银行有一笔储蓄存款。)<br>v. She deposited the check into her account. <br>(她将支票存入了账户。)<br>v. Sediment was deposited at the river mouth. <br>(沉积物在河口沉积。) |
| technical   | `/ˈtɛknɪkəl/`   | adj. 技术的；工艺的      | He has excellent technical skills. <br>(他有出色的技术技能。)<br>The project requires technical expertise. <br>(这个项目需要技术专长。) |
| continue    | `/kənˈtɪnjuː/`  | v. 继续；连续          | The meeting will continue after lunch. <br>(会议将在午餐后继续。)<br>The rain continued all day. <br>(雨整天下个不停。) |
| able        | `/ˈeɪbəl/`      | adj. 能够的；有能力的     | She is able to solve complex problems. <br>(她能够解决复杂问题。)<br>He is an able and efficient worker. <br>(他是一个有能力且高效的工人。) |
| balance     | `/ˈbæləns/`     | n. 平衡；余额<br>v. 平衡 | n. She lost her balance and fell. <br>(她失去平衡摔倒了。)<br>n. The balance in your account is $500. <br>(你账户中的余额是500美元。)<br>v. She balanced the tray on her hand. <br>(她用手端平托盘。)<br>v. They need to balance their budget. <br>(他们需要平衡预算。) |
| beak        | `/biːk/`        | n. 鸟嘴             | The bird has a long, curved beak. <br>(这只鸟有一个长而弯的嘴。) |
| bird        | `/bɜːrd/`       | n. 鸟              | The bird flew away quickly. <br>(那只鸟很快飞走了。) |
| blame       | `/bleɪm/`       | v. 责备；归咎于<br>n. 责任；责备 | v. Don't blame me for your mistakes. <br>(不要把你的错误归咎于我。)<br>n. He took the blame for the accident. <br>(他为这次事故承担了责任。)<br>n. The blame was unfairly placed on her. <br>(责任不公平地落在她身上。) |
| blossoms    | `/ˈblɑːsəmz/`   | n. 花（复数）          | The trees are covered in blossoms. <br>(树上开满了花。) |
| cushion     | `/ˈkʊʃən/`      | n. 垫子；缓冲<br>v. 缓和冲击 | n. She sat on a soft cushion. <br>(她坐在一个软垫子上。)<br>v. The airbags cushioned the impact. <br>(安全气囊缓和了冲击。) |
| dangle      | `/ˈdæŋɡəl/`     | v. 悬挂；摆动          | The earrings dangled from her ears. <br>(耳环在她的耳朵上摆动。) |
| decorate    | `/ˈdekəreɪt/`   | v. 装饰；布置          | They decorated the room for the party. <br>(他们为聚会装饰了房间。)<br>She likes to decorate cakes. <br>(她喜欢装饰蛋糕。) |
| delighted   | `/dɪˈlaɪtɪd/`   | adj. 愉快的；高兴的      | She was delighted with the gift. <br>(她对这份礼物非常高兴。) |
| demonstrate | `/ˈdemənstreɪt/` | v. 演示；证明          | He demonstrated how to use the machine. <br>(他演示了如何使用这台机器。)<br>The results demonstrate the effectiveness of the new method. <br>(结果证明了新方法的有效性。) |
| den         | `/den/`         | n. 兽穴；书斋          | The lion returned to its den. <br>(狮子回到了它的巢穴。)<br>He reads in his den every evening. <br>(他每天晚上在书斋读书。) |
| destroy     | `/dɪˈstrɔɪ/`    | v. 破坏；毁灭          | The fire destroyed the building. <br>(大火烧毁了这座建筑。)<br>The evidence was destroyed. <br>(证据被销毁了。) |
...
| 单词          | 美式发音            | 词性 + 汉语释义            | 示例 |
|-------------|-----------------|----------------------|---|
| offer       | `/ˈɔːfər/`      | v. 提供；提出<br>n. 提议；报价 | v. He offered to help me with the work. <br>(他提出帮我工作。)<br>n. She made a generous offer. <br>(她提出了慷慨的提议。)<br>n. The car is on special offer. <br>(这辆车正在特价优惠。) |
| skin        | `/skɪn/`        | n. 皮肤；外皮<br>v. 剥皮    | n. She has very sensitive skin. <br>(她的皮肤非常敏感。)<br>n. The banana's skin was brown. <br>(香蕉皮是棕色的。)<br>v. He skinned the apple before eating it. <br>(他吃苹果前先剥了皮。) |
| caution     | `/ˈkɔːʃən/`     | n. 小心；警告<br>v. 警告    | n. You should proceed with caution. <br>(你应该小心行事。)<br>n. The sign was a caution against the danger. <br>(这个标志是对危险的警告。)<br>v. The teacher cautioned the students to be quiet. <br>(老师警告学生们要安静。) |
| explicit    | `/ɪkˈsplɪsɪt/`  | adj. 明确的；直率的         | The instructions were explicit. <br>(说明书非常明确。)<br>She was explicit about her intentions. <br>(她直率地表明了她的意图。) |
| bounce      | `/baʊns/`       | v. 弹跳；反弹<br>n. 弹跳    | v. The ball bounced high into the air. <br>(球弹得很高。)<br>n. He has a lot of bounce in his step. <br>(他走路很有弹性。) |
| broad       | `/brɔːd/`       | adj. 宽的；广泛的          | The river is very broad here. <br>(这里的河很宽。)<br>She has a broad knowledge of the subject. <br>(她对这个主题有广泛的了解。) |
| burst       | `/bɜːrst/`      | v. 爆裂；突发<br>n. 爆发    | v. The balloon burst suddenly. <br>(气球突然爆裂了。)<br>n. There was a burst of laughter. <br>(爆发了一阵笑声。) |
| capture     | `/ˈkæptʃər/`    | v. 捕获；夺得<br>n. 捕获   | v. The police captured the thief. <br>(警察抓住了小偷。)<br>v. The athlete captured the gold medal. <br>(这位运动员夺得了金牌。)<br>n. The capture of the city took several days. <br>(城市的捕获花了几天时间。) |
| chilly      | `/ˈtʃɪli/`      | adj. 寒冷的；冷淡的         | It's quite chilly today. <br>(今天很冷。)<br>She gave him a chilly reception. <br>(她对他冷淡接待。) |
| claw        | `/klɔː/`        | n. 爪；钳<br>v. 抓；撕     | n. The cat's claws are sharp. <br>(猫的爪子很锋利。)<br>n. The crab has strong claws. <br>(螃蟹有强壮的钳子。)<br>v. The cat clawed at the furniture. <br>(猫抓了家具。)<br>v. She clawed her way to the top. <br>(她拼命地爬到了顶端。) |
| claws       | `/klɔːz/`       | n. 爪（复数）；钳（复数）    | The bird's claws were sharp. <br>(鸟的爪子很锋利。)<br>The lobster has powerful claws. <br>(龙虾有强壮的钳子。) |
| collect     | `/kəˈlekt/`     | v. 收集；领取；收取          | He collects stamps as a hobby. <br>(他以收集邮票为爱好。)<br>You can collect your package at the post office. <br>(你可以在邮局领取你的包裹。)<br>The landlord collects rent every month. <br>(房东每个月收取租金。) |
| comfort     | `/ˈkʌmfərt/`    | n. 舒适；安慰<br>v. 安慰    | n. The chair offers great comfort. <br>(这把椅子非常舒适。)<br>n. She found comfort in her friend's words. <br>(她在朋友的话语中找到了安慰。)<br>v. He comforted her when she was sad. <br>(她难过时，他安慰了她。) |
| community   | `/kəˈmjuːnəti/` | n. 社区；群体             | The community came together to clean the park. <br>(社区成员齐心协力清理公园。)<br>She belongs to a close-knit community. <br>(她属于一个关系紧密的群体。) |
| cradle      | `/ˈkreɪdəl/`    | n. 摇篮；发源地<br>v. 抚育   | n. The baby slept peacefully in the cradle. <br>(婴儿在摇篮里安静地睡着。)<br>n. The city is known as the cradle of civilization. <br>(这座城市被称为文明的发源地。)<br>v. She cradled the newborn in her arms. <br>(她怀抱着新生儿。) |
| creep       | `/kriːp/`       | v. 爬行；悄悄移动           | The spider creeped along the wall. <br>(蜘蛛沿着墙壁爬行。)<br>She creeped quietly into the room. <br>(她悄悄地走进了房间。) |
| direction   | `/dɪˈrekʃən/`   | n. 方向；指导             | The compass shows the direction. <br>(指南针指示方向。)<br>She gave clear directions to the venue. <br>(她给出了明确的会场指示。) |
| drain       | `/dreɪn/`       | v. 排水；耗尽<br>n. 排水沟   | v. He drained the water from the sink. <br>(他把水从水槽里排掉了。)<br>v. The long work hours drained his energy. <br>(长时间的工作耗尽了他的精力。)<br>n. The drain was clogged with leaves. <br>(排水沟被树叶堵住了。) |
| dusty       | `/ˈdʌsti/`      | adj. 布满灰尘的           | The bookshelf was dusty. <br>(书架布满灰尘。) |
| edge        | `/ɛdʒ/`         | n. 边缘；优势<br>v. 缓慢移动  | n. He stood at the edge of the cliff. <br>(他站在悬崖边缘。)<br>n. The new technology gives them an edge over competitors. <br>(新技术使他们在竞争中占据优势。)<br>v. She edged closer to the door. <br>(她慢慢靠近门。) |
...
| 单词                | 美式发音                   | 词类 + 汉语释义           |                            |
|-------------------|------------------------|---------------------| ----------------------------------------- |
| faint             | `/feɪnt/`              | adj. 微弱的；模糊的<br />v. 晕倒 | adj. She heard a faint sound. <br/>(她听到了一声微弱的声音。)<br/>The text was faint and hard to read. <br/>(文字模糊难以辨认。)<br/>v. He fainted from exhaustion. <br/>(他因疲劳而晕倒了。) |
| compact           | `/kəmˈpækt/`           | adj. 紧凑的；小型的<br/>v. 压紧 | adj. The car is compact and easy to park. <br/>(这辆车紧凑且容易停车。)<br/>v. The soil was compacted to create a solid foundation. <br/>(土壤被压紧以创建一个坚固的基础。) |
| laminate          | `/ˈlæməneɪt/`          | v. 覆膜；n. 层压板        | v. They decided to laminate the important documents for preservation. <br />(他们决定给重要文件覆上薄膜以便保存。)<br>n. The countertop is made of laminate. <br />(这个台面是由层压板制成的。) |
...
| account           | `/əˈkaʊnt/`            | n. 账户；描述；解释<br/>v. 解释；说明 | n. She opened a bank account. <br/>(她开了一个银行账户。)<br/>He gave a detailed account of the events. <br/>(他详细描述了事件。)<br/>His account of the accident was clear. <br/>(他对事故的描述很清楚。)<br/>Her account provided a clear explanation. <br/>(她的描述提供了清晰的解释。)<br/>v. Can you account for your whereabouts last night? <br/>(你能解释一下你昨晚的行踪吗？)<br/>He couldn't account for the missing money. <br/>(他无法解释丢失的钱。) |
| take into account | `/teɪk ˈɪntu əˈkaʊnt/` | phrasal. 考虑；重视      |                    |
| skim              | `/skɪm/`               | v. 略读，撇去〔液体表面的浮油或漂浮物〕 | He skimmed the article quickly. <br />(他快速略读了这篇文章。)<br/>He skimmed the cream off the milk. <br/>(他撇去了牛奶上的奶油。) |
| crucial           | `/ˈkruːʃəl/`           | adj. 关键的；决定性的       | The support of her family was crucial to her success. <br />(她家人的支持对她的成功至关重要。) |
| central           | `/ˈsentrəl/`           | adj. 中央的；核心的        | the party’s central office. 该党的中央办公楼<br />The central idea of the article is clear. <br/>(文章的核心思想很清晰。)<br />The library plays a central role in the community. <br />(图书馆在社区中扮演着主要角色。)<br /> values which are central to our society.<br />我们社会的核心价值观 |
| chip              | `/tʃɪp/`               | n. 薄片；芯片；碎片<br/>v. 削下；打破 | n. The computer has a powerful chip. <br />(这台电脑有一个强大的芯片。)<br />He noticed a small chip in the glass. <br />(他注意到玻璃上有一个小碎片。)<br />There were chips of glass on the floor. <br/>(地板上有碎玻璃片。)<br />She loves eating potato chips. <br />(她喜欢吃薯片。)<br />v. He accidentally chipped the vase. <br />(他不小心打碎了花瓶。)<br />v. He chipped a piece of the vase. <br/>(他打碎了花瓶的一角。)<br/>v. The carpenter chipped the wood to shape it. <br/>(木匠削下木头以塑形。) |
| narration         | `/nəˈreɪʃən/`          | n. 叙述；旁白            | The documentary had excellent narration. <br />(这部纪录片的旁白非常出色。)<br />The movie's narration was both informative and entertaining. <br />(这部电影的旁白既提供信息又富有娱乐性。) |
| sleek             | `/sliːk/`              | adj. 光滑的；时髦的        | The design of the car is very sleek. <br />(这辆车的设计非常时髦光滑。) |
| informative       | `/ɪnˈfɔːrmətɪv/`       | adj. 提供信息的          | The documentary was both informative and interesting. <br />(这部纪录片既提供了信息又很有趣。) |
...
注：下面表格单词已写到 Goodnotes；日期见：2024.08.01
...
| pulp        | `/pʌlp/`         | n. 浆状物；果肉 <br/>v. 将... 制成浆 | n. The pulp of the fruit is very sweet. <br/>(这种水果的果肉很甜。)<br/>Mash the bananas to a pulp. 把香蕉捣成糊状。<br />The book was turned into pulp(低俗作品) fiction. <br/>(这本书被改编成了低俗小说。)<br/>v. The paper was pulped and recycled. <br/>(纸被制成浆并回收利用。)                                    |
...
| rule      | `/ruːl/`       | n. 规则；统治 <br>v. 统治；支配 | n. We must follow the rules of the game. <br>(我们必须遵守游戏规则。)<br>n. The king's rule was marked by peace and prosperity. <br>(国王的统治以和平和繁荣为特征。)<br>v. The queen ruled the country for many years. <br>(女王统治这个国家多年。)<br>v. He likes to rule over his subjects with a firm hand. <br>(他喜欢以铁腕手段统治他的臣民。) |
...
注：下面表格单词已写到 Goodnotes；日期见：2024.01.18
...
| satisfaction | `/ˌsætəsˈfækʃən/`  | n. 满意；满足         | Customer satisfaction is our top priority.<br /> (顾客满意是我们的首要任务。) <br>The job brought him great satisfaction. <br>(这份工作带给他极大的满足。) |
| relief       | `/rɪˈliːf/`        | n. 宽慰；(疼痛或不快的)减轻；救济 | He felt a sense of relief after the exam. <br>(考试后他感到如释重负。)<br>The medication provided relief from pain. <br>(药物缓解了疼痛。)<br>The relief efforts helped many people. <br>(救济工作帮助了很多人。) |
| interference | `/ˌɪntərˈfɪərəns/` | n. 干涉；干扰         | The interference from the crowd was distracting. <br>(人群的干扰令人分心。)                                                 |
| pattern      | `/ˈpætərn/`        | n. 模式；图案         | The dress has a beautiful pattern. <br>(这件连衣裙有一个美丽的图案。)                                                           |
...
| 单词            | 美式发音                  | 词类 + 汉语释义             | 示例                                                         |
| --------------- |-----------------------| -------------------------- | ------------------------------------------------------------ |
| consortium      | `/kənˈsɔrtiəm/`       | n. 联盟；财团              | The consortium of companies bid for the construction contract. <br />(这个公司联盟竞标建筑合同。) |
| footprint       | `/ˈfʊtprɪnt/`         | n. 脚印；足迹（个人或机构活动对环境的影响） | He left wet footprints on the floor. <br />(他在地板上留下了湿脚印。)<br>The company is trying to reduce its environmental footprint. <br />(公司正在努力减少其环境足迹。) |
| specific        | `/spəˈsɪfɪk/`         | adj. 特定的；明确的        | He gave specific instructions on how to proceed. <br />(他给出了如何进行的具体指示。) |
| combination     | `/ˌkɑːmbɪˈneɪʃən/`    | n. 结合；组合              | This dish is a delicious combination of flavors.<br /> (这道菜是各种口味的美妙结合。) |
| profile         | `/ˈproʊfaɪl/`         | n. 侧面；简介；配置文件      | n. The mountain has a distinctive profile.<br /> (这座山有一个独特的轮廓。) |
| reproducible    | `/ˌriːprəˈduːsəbl/`   | adj. 可复制的              | The experiment's results are reproducible. <br />(实验结果是可复制的。) |
| reproduce       | `/ˌriːprəˈduːs/`      | v. 复制；繁殖             | The artist failed to reproduce the colors of the original painting. <br />(艺术家未能复制原画的颜色。)<br />The scientist managed to reproduce the experiment's results. <br />(科学家设法复制了实验的结果。) |
| representation  | `/ˌreprɪzɛnˈteɪʃən/`  | n. 代表；表现              | She argued for better representation of women in politics. <br />(她主张在政治中更好地代表妇女。) |
| entail          | `/ɪnˈteɪl/`           | v. 牵涉；需要              | The project will entail a lot of hard work. <br />(这个项目将需要大量的努力。) |
| analog          | `/ˈænəlɔg/`           | adj. 模拟的               | The old analog system was replaced by a digital one. <br />(旧的模拟系统被数字系统替代。) |
| arbitrary       | `/ˈɑːrbətreri/`       | adj. 任意的；随机的        | The decision seemed to be quite arbitrary. <br />(这个决定看起来相当随机。) |
| correspond      | `/ˌkɔːrəˈspɑːnd/`     | v. 相符；相一致          | The two stories correspond in many details. <br />(这两个故事在许多细节上相符。) |
