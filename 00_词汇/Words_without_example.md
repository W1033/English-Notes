...
| fold     | `/foʊld/`               | v. 折叠<br>n. 褶皱(zhě zhòu)     |
...
| 单词         | 美式发音              | 词性 + 汉语释义         |
|------------|-------------------|-------------------|
| calculate  | `/ˈkælkjəleɪt/`   | v. 计算；估算          |
| measure    | `/ˈmɛʒər/`        | v. 测量；衡量<br/>n. 措施；标准 |
| decline    | `/dɪˈklaɪn/`      | n. 下降；减少<br/>v. 下降；拒绝 |
| modify     | `/ˈmɑːdɪfaɪ/`     | v. 修改；修饰          |
| maintain   | `/meɪnˈteɪn/`     | v. 维护；维持          |
| illustrate | `/ˈɪləstreɪt/`    | v. 说明；插图          |
| define     | `/dɪˈfaɪn/`       | v. 定义；规定          |
...
| 单词          | 美式发音            | 词性 + 汉语释义                |
|-------------|-----------------|--------------------------|
| gain        | `/ɡeɪn/`        | v. 获得<br>n. 收益           |
| gift        | `/ɡɪft/`        | n. 礼物；天赋                 |
| great       | `/ɡreɪt/`       | adj. 伟大的；大量的             |
| habit       | `/ˈhæbɪt/`      | n. 习惯                    |
| happen      | `/ˈhæpən/`      | v. 发生                    |
| happy       | `/ˈhæpi/`       | adj. 高兴的                 |
| hard        | `/hɑrd/`        | adj. 困难的；坚硬的<br>adv. 努力地 |
| help        | `/hɛlp/`        | v. 帮助<br>n. 帮助           |
| hide        | `/haɪd/`        | v. 隐藏<br>n. 兽皮           |
| high        | `/haɪ/`         | adj. 高的<br>adv. 高度地      |
| hit         | `/hɪt/`         | v. 击打；碰撞<br>n. 打击；风行一时的事物 (如电影、戏剧、歌曲等) |
| hold        | `/hoʊld/`       | v. 握住；保持；容纳<br>n. 握住；控制  |
| hope        | `/hoʊp/`        | v. 希望<br>n. 希望           |
| hurt        | `/hɜrt/`        | v. 伤害<br>adj. 受伤的        |
| idea        | `/aɪˈdiə/`      | n. 想法；主意                 |
| important   | `/ɪmˈpɔːrtənt/` | adj. 重要的；重大的             |
| interest    | `/ˈɪntrəst/`    | n. 兴趣；利息<br>v. 使感兴趣      |
| invent      | `/ɪnˈvent/`     | v. 发明；创造                 |
| joy         | `/dʒɔɪ/`        | n. 欢乐；喜悦                 |
| jump        | `/dʒʌmp/`       | v. 跳跃<br>n. 跳跃           |
...
| keep   | `/kiːp/`   | v. 保持；保留                |
| kill   | `/kɪl/`    | v. 杀死                   |
| kind   | `/kaɪnd/`  | n. 种类<br>adj. 友好的       |
| know   | `/noʊ/`    | v. 知道；了解                |
| last   | `/læst/`   | adj. 最后的；上一个的<br>v. 持续  |
| laugh  | `/læf/`    | v. 笑<br>n. 笑声           |
| learn  | `/lɜːrn/`  | v. 学习；得知                |
| leave  | `/liːv/`   | v. 离开；留下<br>n. 休假       |
| left   | `/left/`   | adj. 左边的<br>n. 左边       |
| let    | `/let/`    | v. 让；允许                 |
| like   | `/laɪk/`   | v. 喜欢<br>prep. 像        |
| little | `/ˈlɪtl/`  | adj. 小的；少量的<br>adv. 稍微  |
| live   | `/lɪv/` (v.);<br />`/laɪv/` (adj.) | v. 居住；生活；直播<br>adj. 活的；实况的 |
| long   | `/lɒːŋ/`   | adj. 长的；长时间的；<br>adv. 长久地 |
| look   | `/lʊk/`    | v. 看；寻找；显得<br>n. 看；外观   |
| lose   | `/luːz/`   | v. 失去；迷失                |
| love   | `/lʌv/`    | v. 爱<br>n. 爱情           |
| make   | `/meɪk/`   | v. 制作；使得                |
| man    | `/mæn/`    | n. 男人；人类                |
...
| 单词       | 美式发音       | 词性 + 汉语释义                  |
|----------|------------|--------------------------------|
| many     | `/ˈmɛni/`  | adj. 许多的<br>pron. 许多       |
| mark     | `/mɑrk/`   | v. 标记；评分；表明<br>n. 记号；分数 |
| may      | `/meɪ/`    | modal verb. 可能；可以          |
| meet     | `/miːt/`   | v. 遇见；满足                   |
| melt     | `/melt/`   | v. 融化；消失                   |
| mix      | `/mɪks/`   | v. 混合<br>n. 混合物            |
| move     | `/muːv/`   | v. 移动；搬家<br>n. 移动          |
| much     | `/mʌtʃ/`   | adv. 非常<br>pron. 许多         |
| must     | `/mʌst/`   | modal verb. 必须                |
| near     | `/nɪr/`    | prep. 靠近<br>adv. 几乎         |
| need     | `/niːd/`   | v. 需要<br>n. 需求              |
| never    | `/ˈnevər/` | adv. 从不                       |
| new      | `/njuː/`   | adj. 新的                       |
| next     | `/nekst/`  | adj. 下一个的<br>adv. 然后       |
| night    | `/naɪt/`   | n. 夜晚                        |
| part     | `/pɑrt/`   | n. 部分；零件；角色<br>v. 分开；分离 |
| pass     | `/pæs/`    | v. 通过；传递<br>n. 通行证         |
| people   | `/ˈpiːpəl/` | n. 人；人们；民族                 |
...
| 单词      | 美式发音         | 词性 + 汉语释义              |
|---------|--------------|------------------------|
| pick    | `/pɪk/`      | v. 挑选；摘<br>n. 选择       |
| picture | `/ˈpɪktʃər/` | n. 图片；照片<br>v. 描绘      |
| place   | `/pleɪs/`    | n. 地方；位置<br>v. 放置      |
| play    | `/pleɪ/`     | v. 玩；演奏<br>n. 游戏；剧本    |
| point   | `/pɔɪnt/`    | n. 点；观点；重点；地点；分数<br>v. 指向；指出；表明 |
| put     | `/pʊt/`      | v. 放置                  |
| read    | `/riːd/`     | v. 阅读<br>n. 阅读         |
| right   | `/raɪt/`     | adj. 正确的；右边的<br>adv. 直接地；恰好地<br>n. 权利；右边<br>v. 纠正 |
| run     | `/rʌn/`      | v. 跑；经营<br>n. 跑步       |
| say     | `/seɪ/`      | v. 说；表达 <br>n. 发言权     |
| said    | `/sɛd/`      | v. 说（say的过去式）          |
| same    | `/seɪm/`     | adj. 相同的<br>pron. 同样   |
| saw     | `/sɔ/`       | v. 看见（see的过去式）<br>n. 锯子 |
| school  | `/skuːl/`    | n. 学校                  |
| see     | `/siː/`      | v. 看见；理解               |
| seem    | `/siːm/`     | v. 似乎；看起来              |
| send    | `/send/`     | v. 发送；寄                |
| set     | `/set/`      | v. 设置；放置<br>n. 套       |
| should  | `/ʃʊd/`      | modal verb 应当；应该       |
...
| 单词        | 美式发音         | 词性 + 汉语释义                     |
|-----------|--------------|-------------------------------|
| show      | `/ʃoʊ/`      | v. 显示；表演<br>n. 展示；节目          |
| side      | `/saɪd/`     | n. 侧面；方面<br>adj. 侧面的<br>v. 支持 |
| sit       | `/sɪt/`      | v. 坐；就坐                       |
| small     | `/smɔl/`     | adj. 小的                       |
| so        | `/soʊ/`      | adv. 如此；所以                    |
| some      | `/sʌm/`      | adj. 一些<br>pron. 一些人          |
| something | `/ˈsʌmθɪŋ/`  | pron. 某物；某事                   |
| soon      | `/suːn/`     | adv. 很快；不久                    |
| start     | `/stɑrt/`    | v. 开始<br>n. 开端                |
| stop      | `/stɑːp/`    | v. 停止<br>n. 停止                |
| such      | `/sʌtʃ/`     | determiner. 这样的；如此的<br>pron. 这样的事物 |
| take      | `/teɪk/`     | v. 拿；接受；采取                    |
| tell      | `/tɛl/`      | v. 告诉；说                       |
| than      | `/ðæn/`      | conj. 比                       |
| then      | `/ðɛn/`      | adv. 然后；当时                    |
| thing     | `/θɪŋ/`      | n. 事物；东西；事情                   |
| think     | `/θɪŋk/`     | v. 想；认为；考虑                    |
| time      | `/taɪm/`     | n. 时间；次；时代                    |
| today     | `/təˈdeɪ/`   | adv. 在今天<br>n. 今天             |
| together  | `/təˈɡeðər/` | adv. 一起                       |
| too       | `/tuː/`      | adv. 也；太                      |
| top       | `/tɑːp/`     | n. 顶部；上方<br>adj. 最高的；顶级的<br>v. 超越 |
| under     | `/ˈʌndər/`   | prep. 在...下面；低于<br>adv. 在下面   |
| up        | `/ʌp/`       | adv. 向上；起来<br>prep. 向上        |
| very      | `/ˈveri/`    | adv. 非常；很<br>adj. 正是的；完全的     |
| want      | `/wɑːnt/`    | v. 想要；希望<br>n. 需求             |
| well      | `/wel/`      | adv. 好；很<br>adj. 健康的          |
| will      | `/wɪl/`      | aux. 将；会<br>n. 意志             |
| with      | `/wɪð/`      | prep. 和...一起；用；由于             |
| word      | `/wɜːrd/`    | n. 单词；话语                      |
| work      | `/wɜːrk/`    | v. 工作；运作<br>n. 工作；作品          |
| would     | `/wʊd/`      | aux. 将；会；愿意                   |
| write     | `/raɪt/`     | v. 写                          |
| year      | `/jɪr/`      | n. 年                          |
| young     | `/jʌŋ/`      | adj. 年轻的                      |
...
| vendor    | `/ˈvɛndər/`        | n. 小贩               |
| garage        | `/ɡəˈrɑːʒ/`       | n. 车库；(公共场所的)停车场；汽车修理厂 |
...
| parenting    | `/ˈpɛrəntɪŋ/`    | n. 养育（技巧）﹔抚养:                   |
...
| discourage   | `/dɪˈskɜrɪdʒ/      | v. 使气馁；阻止                 |
...
|--------------|------------------|---------------------|
| crawl        | `/krɔːl/`        | v. 爬行               |
| rather       | `/ˈræðər/`       | det. & adv. 宁愿；相当   |
| rather than  | `/ˈræðər ˈðæn/`  | conj. 宁愿；而不是        |
| diploma      | `/dɪˈploʊmə/`    | n. 文凭，毕业证书          |
| diplomat     | `/ˈdɪpləmæt/`    | n. 外交官              |
| diplomatic   | `/ˌdɪpləˈmætɪk/` | adj. 外交的；有策略的       |
| doll         | `/dɑːl/`         | n. (洋)娃娃，玩偶         |
| creepy       | `/ˈkriːpi/`      | adj. 令人毛骨悚然的        |
| thingamajig  | `/ˈθɪŋəməˌdʒɪɡ/` | n. [口]某物，玩意儿        |
| sabotage     | `/ˈsæbətɑːʒ/`    | v. 蓄意破坏             |
| daisy        | `/ˈdeɪzi/`       | n. 雏菊               |
| magnitude    | `/ˈmæɡnɪtuːd/`   | n. 大小，重要性；（地震的）级数   |
| incidence    | `/ˈɪnsɪdəns/`    | n. （尤指罪行﹑疾病等的）发生率   |
| heroin       | `/ˈheroʊɪn/`     | n. 海洛因              |
| question     | `/ˈkwestʃən/`    | n. 问题；疑问；<br />v. 询问；质疑； |
| hood         | `/hʊd/`          | n. 头巾，风帽；（汽车的）引擎盖   |
| anthem       | `/ˈænθəm/`       | n. 国歌；赞美歌           |
| critic       | `/ˈkrɪtɪk/`      | n. 评论家；批评家(/者)      |
| critical     | `/ˈkrɪtɪkəl/`    | adj. 批评的；关键的        |
| criticism    | `/ˈkrɪtɪsɪzəm/`  | n. 批评，评论            |
| stab         | `/stæb/`         | v. 刺，戳；<br />n. 刺伤  |
| soak         | `/soʊk/`         | v. 浸泡;<br />n. 浸泡   |
| kukri        | `/ˈkʊkri/`       | n. （印度廓尔喀人用的）反曲刀    |
| agonize      | `/ˈægənaɪz/`     | v. 折磨，使极度痛苦         |
| agonizing    | `/ˈægəˌnaɪzɪŋ/`  | adj. 令人极度痛苦的        |
| shrivel      | `/ˈʃrɪvəl/`      | v. （使）枯萎，（使）皱缩      |
...
| 单词            | 美式发音           | 词类 + 汉语释义            |
|----------------|-------------------|----------------------|
| obsolete       | `/ˌɑːbsəˈliːt/`   | adj. 过时的             |
| delegate       | `/ˈdeləɡət/`（n.）<br>`/ˌdelɪˈɡeɪt/`（v.） | n. 代表<br>v. 委派       |
| hill           | `/hɪl/`           | n. 小山                |
| mere           | `/mɪr/`           | adj. 仅仅的，只不过的        |
| merely         | `/ˈmɪrli/`        | adv. 仅仅地，只不过地        |
| pray           | `/preɪ/`          | v. 祈祷，祈求             |
| chew           | `/tʃuː/`          | v. 咀嚼；深思              |
| savor / savour | `/ˈseɪvər/`       | v. 品尝，享受；n. 滋味       |
| in the act of  |                   | phrase 在...的过程中      |
| magnificent    | `/mæɡˈnɪfəsənt/`  | adj. 壮丽的，宏伟的         |
| championship   | `/ˈtʃæmpiənˌʃɪp/` | n. 锦标赛               |
| session        | `/ˈsɛʃən/`        | n. （某项活动的）一段时间；会议    |
| parliament     | `/ˈpɑːrləmənt/`   | n. 议会，国会             |
| formality      | `/fɔːrˈmæləti/`   | n. 礼节；正式手续           |
| assembly       | `/əˈsɛmbli/`      | n. 集会，装配             |
| plague         | `/pleɪɡ/`         | n. 瘟疫，灾害<br>v. 折磨，困扰 |
| render         | `/ˈrɛndər/`       | v. 提供，使成为            |
...
| 单词       | 美式发音        | 词性 + 汉语释义                |
| ---------- | --------------- | ------------------------------ |
| literature | `/ˈlɪtərətʃʊr/` | n. 文学，文献                  |
| literary   | `/ˈlɪtəreri/`   | adj. 文学的                    |
| quote      | `/kwoʊt/`       | v. 引用；报价<br>n. 引文；报价 |
| bam        | `/bæm/`         | int. 砰（表示突然的声音）      |
| pariah     | `/pəˈraɪə/`     | n. 被社会遗弃者                |
| booby      | `/ˈbuːbi/`      | n. 傻瓜，笨蛋                  |
| shout-out  | `/ˈʃaʊtˌaʊt/`   | n. 致敬，公开感谢              |
| rapture    | `/ˈræptʃər/`    | n. 狂喜                        |
| effortless | `/ˈefərtləs/`   | adj. 不费力的                  |
| boast      | `/boʊst/`       | v. 自夸，吹嘘<br>n. 自夸       |
| concise    | `/kənˈsaɪs/`    | adj. 简明的，简洁的            |
| exclusive  | `/ɪkˈskluːsɪv/` | adj. 独有的<br>n. 独家新闻     |
| endanger   | `/ɪnˈdeɪndʒər/` | v. 危及；危害                  |
| wonder     | `/ˈwʌndər/`     | v. 想知道，感到惊讶<br>n. 奇迹 |
| wonderland | `/ˈwʌndərlænd/` | n. 仙境，奇境                  |
...
| Word         | American Pronunciation | Part of Speech + Chinese Definition |
|--------------|------------------|----------------------|
| tremendous   | `/trəˈmendəs/`   | adj. 巨大的，极好的         |
| toward^(1)^  | `/təˈwɔːrd/`     | prep. 朝，向；关于         |
| towards      | `/təˈwɔːdz/`     | prep. 朝，向；关于         |
| itinerary    | `/aɪˈtɪnəreri/`  | n. 行程，旅行计划           |
| indivisible  | `/ˌɪndɪˈvɪzəbəl/` | adj. 不可分割的           |
| onto         | `/ˈɑːntʊ/` <br /> `/ˈɒːntuː/`（strong） | prep. 到...上；向...之上   |
| impression   | `/ɪmˈpreʃən/`    | n. 印象，感想             |
| repent       | `/rɪˈpent/`      | v. 忏悔，悔过             |
| slack        | `/slæk/`         | adj. 松弛的，懈怠的<br>n. 松弛；懈怠 |
| fortunate    | `/ˈfɔːrtʃənət/`  | adj. 幸运的             |
| total        | `/ˈtoʊtəl/`      | adj. 总的，完全的<br>n. 总数 |
| labyrinth    | `/ˈlæbərɪnθ/`    | n. 迷宫，错综复杂           |
| labyrinthine | `/ˌlæbəˈrɪnθɪn/` | adj. 迷宫般的，复杂的        |
| corpse       | `/kɔːrps/`       | n. 尸体                |
| literal      | `/ˈlɪtərəl/`     | adj. 照字面意思的          |
| literally    | `/ˈlɪtərəli/`    | adv. 照字面意义地；确实地            |
...
| 单词       | 美式发音         | 词类 + 汉语释义                    |
| ---------- | ---------------- | ---------------------------------- |
| spare      | `/spɛər/`        | adj. 多余的，备用的；<br>v. 节约    |
| brute      | `/bruːt/`        | adj. 野蛮的，残忍的；<br>n. 野兽    |
| harbor     | `/ˈhɑːrbər/`     | n. 港口，避难所；<br>v. 怀有（情感等） |
| accelerate | `/əkˈseləˌreɪt/` | v. 加速，促进                     |
| grade      | `/ɡreɪd/`        | n. 等级，年级；<br>v. 评分，分级    |
| true       | `/truː/`         | adj. 真实的，正确的；<br />adv. 真实地 |
| quiz       | `/kwɪz/`         | n. 小测验，问答游戏；<br />v. 测验，提问 |
| thrift     | `/θrɪft/`        | n. 节俭，节约                     |
| dean       | `/diːn/`         | n. 院长，主任                     |
| catch      | `/kætʃ/`         | v. 捕捉，抓住；<br>n. 捕获物 |
...
| ----------- | ------------------ | ------------------ |
| drum        | `/drʌm/`           | n. 鼓；v. 敲击     |
| aware       | `/əˈwer/`          | adj. 意识到的      |
| awareness   | `/əˈwernəs/`       | n. 意识，认知       |
| mill        | `/mɪl/`            | n. 磨坊；工厂；<br />v. 研磨；加工 |
| normal      | `/ˈnɔːrməl/`       | adj. 正常的，常规的；<br />n. 常态，标准 |
| range       | `/reɪndʒ/`         | n. 范围，系列；<br />v. 排列，变动 |
| exhaust     | `/ɪgˈzʌːst/`       | v. 使筋疲力尽，耗尽<br />n. 排气，废气； |
| disillusion | `/ˌdɪsəˈluːʒən/`   | n. 幻灭；醒悟；<br />v. 使幻想破灭 |
| explanation | `/ˌɛkspləˈneɪʃən/` | n. 解释；说明       |
| biggie      | `/ˈbɪɡi/`          | n. 重要人或物       |
| reservation | `/ˌrɛzərˈveɪʃən/`  | n. 预订；保留(意见)   |
| summon      | `/ˈsʌmən/`         | v. 召唤；召集       |
| noon        | `/nuːn/`           | n. 正午；中午       |
| misfortune  | `/mɪsˈfɔrtʃən/`    | n. 灾难；不幸       |
| quiet       | `/ˈkwaɪət/`        | adj. 安静的；<br />n. 安静 |
| grazing     | `/ˈɡreɪzɪŋ/`       | n. 放牧；牧草地      |
| graze       | `/ɡreɪz/`          | v. 放牧；擦伤       |
...
| 单词                       | 美式发音           | 词类 + 汉语释义            |
|--------------------------| -------------- |----------------------|
| preface                  | `/ˈprefəs/`    | n. 前言；序言             |
| hyphen                   | `/ˈhaɪfən/`    | n. 连字符               |
| dine                     | `/daɪn/`       | v. 吃饭；进餐             |
| compromise               | `/ˈkɑːmprəmaɪz/`| n. 妥协；<br>v. 妥协      |
| not-so-nicely-lit（light）| N/A            | adj. 照明不佳的           |
| campus                   | `/ˈkæmpəs/`    | n. 校园                |
| off-campus               | `/ˌɔfˈkæmpəs/` | adj. 校（园）外的          |
| state-of-the-art         | ` /'steitəvði:'a:t/` | adj. 最先进的            |
| allergen                 | `/ˈælərdʒən/`  | n. 过敏原               |
| digest                   | `/daɪˈdʒɛst/` (v.), <br />`/ˈdaɪdʒɛst/` (n.) | v. 消化；理解<br>n. 摘要；文摘 |
...
| 单词        | 美式发音           | 词类 + 汉语释义           |
| ----------- | ------------------ | ------------------------ |
| preliminary | `/prɪˈlɪməneri/`   | adj. 初步的；预备的        |
| task        | `/tæsk/`           | n. 任务                  |
| available   | `/əˈveɪləbəl/`     | adj. 可用的；可获得的       |
| rudimentary | `/ˌruːdəˈmentəri/` | adj. 基础的；初步的        |
| convincing  | `/kənˈvɪnsɪŋ/`     | adj. 有说服力的          |
| convince    | `/kənˈvɪns/`       | v. 说服；使相信           |
| nasal       | `/ˈneɪzəl/`        | adj. 鼻的；鼻音的         |
| set out     | `/sɛt ˈaʊt/`       | phr. v. 开始；出发       |
| harness     | `/ˈhɑːrnɪs/`       | n. 马具；<br />v. 利用   |
| recognize   | `/ˈrɛkəɡnaɪz/`     | v. 识别；认出            |
| Cambridge   | `/ˈkeɪmbrɪdʒ/`     | n. 剑桥（英国城市名）        |
| utter       | `/ˈʌtər/`          | adj. 完全的；彻底的<br>v. 说；发出声音 |
| summation   | `/səˈmeɪʃən/`      | n. 总和；总结            |
| rather than | `/ˈræðər ðæn/`     | conj. 而不是             |
| beard       | `/bɪrd/`           | n. 胡须                  |
| bear        | `/ber/`            | v. 承担；忍受 <br />n. 熊 |
| adjustment  | `/əˈdʒʌstmənt/`    | n. 调整；调节            |
| turn        | `/tɜrn/`           | v. 转动；转变<br>n. 转弯；机会 |
| migration   | `/maɪˈɡreɪʃən/`    | n. 迁移；移民            |
| grow        | `/ɡroʊ/`           | v. 生长；增长            |
...
| shoot        | `/ʃut/`             | v. 射击；拍摄；发芽<br>n. 嫩芽；射击<br>int. （用于表达惊讶或失望）哎呀 |
| shot         | `/ʃɑːt/`            | n. 射击；拍摄；注射<br>v. shoot 的过去式和过去分词 |
| mythical     | `/ˈmɪθɪkəl/`        | adj. 神话的；虚构的        |
| reasonable   | `/ˈrizənəbəl/`      | adj. 合理的；公道的        |
...
| endless     | `/ˈendləs/`      | adj. 无止境的；无尽的          |
| invoke      | `/ɪnˈvoʊk/`      | v. 调用；祈求               |
| spray       | `/spreɪ/`        | v. 喷洒<br>n. 喷雾         |
| steal       | `/stiːl/`        | v. 偷窃                  |
| ink         | `/ɪŋk/`          | n. 墨水<br>v. 签署         |
| practice    | `/ˈpræktɪs/`     | n. 练习；实践<br>v. 练习；从事   |
| humble      | `/ˈhʌmbəl/`      | adj. 谦逊的；卑微的           |
| minute      | `/ˈmɪnɪt/`(n.)<br>`/maɪˈnuːt/`(adj.) | n. 分钟<br>adj. 微小的      |
| brush       | `/brʌʃ/`         | n. 刷子；轻触<br>v. 刷；掠过    |
...
| 单词         | 美式发音            | 词类 + 汉语释义              |
|-------------|--------------------|------------------------|
| phrase      | `/freɪz/`          | n. 短语；措辞；<br />v. 表达   |
| phrasal     | `/ˈfreɪzəl/`       | adj. 短语的               |
| intense     | `/ɪnˈtɛns/`        | adj. 强烈的；紧张的           |
| compile     | `/kəmˈpaɪl/`       | v. 编译；汇编               |
| parallel    | `/ˈpærəˌlɛl/`      | adj. 平行的；<br />n. 相似之处 |
| stylish     | `/ˈstaɪlɪʃ/`       | adj. 时髦的               |
| durable     | `/ˈdʊrəbəl/`       | adj. 耐久的；持久的           |
| lightweight | `/ˈlaɪtweɪt/`      | adj. 轻便的               |
| tear        | `/tɪr/` or `/tɛr/` | n. 眼泪；撕裂<br>v. 撕裂      |
| scuff       | `/skʌf/`           | n. 擦痕；v. 擦伤            |
| abrasion    | `/əˈbreɪʒən/`      | n. 磨损                  |
| ballistic   | `/bəˈlɪstɪk/`      | adj. 弹道的               |
| versatile   | `/ˈvɜːrsətəl/`     | adj. 多才多艺的；多用途的        |
| reliable    | `/rɪˈlaɪəbəl/`     | adj. 可靠的               |
| heritage    | `/ˈhɛrɪtɪdʒ/`      | n. 遗产                  |
| advance     | `/ədˈvæns/`        | n. 提前；进步 <br>v. 推进；促进 |
| fabric      | `/ˈfæbrɪk/`        | n. 织物                  |
...
| 单词          | 美式发音             | 词类 + 汉语释义                   |
| ------------- | -------------------- | --------------------------------- |
| heave         | `/hiːv/`             | v. 举起；呕吐；起伏               |
| nauseous      | `/ˈnɔːʃəs/`          | adj. 恶心的                       |
| greasy        | `/ˈɡriːsi/`          | adj. 油腻的                       |
| count         | `/kaʊnt/`            | v. 计数<br />n. 数量              |
| stimulate     | `/ˈstɪmjəleɪt/`      | v. 刺激；激励                     |
| executive     | `/ɪɡˈzɛkjətɪv/`      | adj. 执行的；<br />n. 主管        |
| interest      | `/ˈɪntrəst/`         | n. 兴趣；利息；<br />v. 使感兴趣  |
| impatient     | `/ɪmˈpeɪʃənt/`       | adj. 不耐烦的                     |
| patient       | `/ˈpeɪʃənt/`         | adj. 耐心的；n. 病人              |
| complimentary | `/ˌkɑːmplɪˈmentəri/` | adj. 免费的；赞美的               |
| elementary    | `/ˌelɪˈmentri/`      | adj. 基础的；初级的               |
| podcast       | `/ˈpɑːdkæst/`        | n. 播客                           |
| fight         | `/faɪt/`             | n. 战斗；争吵<br />v. 战斗；争吵  |
| iconic        | `/aɪˈkɑnɪk/`         | adj. 图标的；象征性的             |
| icon          | `/ˈaɪkɒn/`           | n. 图标；偶像                     |
| anal          | `/ˈeɪnəl/`           | adj. 肛门的；吹毛求疵的〔含贬义〕 |
...
| 单词          | 美式发音           | 词类 + 汉语释义         |
|--------------|-------------------|-------------------|
| hawk         | `/hɔːk/`          | n. 鹰；鹰派人物 <br />v. 叫卖 |
| avenue       | `/ˈævənuː/`       | n. 大道；途径          |
| imprint      | `/'ɪmprɪnt/` (n.) <br />`/ɪm'prɪnt/` (v.) | n. 印记 <br />v. 印刻；铭记<br />(<i style="color:red">备注</i>) |
| psyche       | `/ˈsaɪki/`        | n. 心智；灵魂          |
| psycho       | `/ˈsaɪkoʊ/`       | adj. 精神病的；<br />n. 精神病患者 |
| evident      | `/ˈɛvɪdənt/`      | adj. 明显的；显而易见的    |
...
| proficiency  | `/prəˈfɪʃənsi/`   | n. 精通；熟练          |
| Japan        | `/dʒəˈpæn/`       | n. 日本             |
| Japanese     | `/ˌdʒæpəˈniːz/`   | n. 日语；日本人 <br />adj. 日本的；日本人的 |
| renovation   | `/ˌrɛnəˈveɪʃən/`  | n. 翻新；修复          |
| renovate     | `/ˈrɛnəveɪt/`     | v. 翻新；修复          |
| redecorate   | `/ˌriːˈdɛkəreɪt/` | v. 重新装饰           |
| decorate     | `/ˈdɛkəreɪt/`     | v. 装饰；装修          |
...
| 单词         | 美式发音                                  | 词类 + 汉语释义                                      |
| ------------ | ----------------------------------------- | ---------------------------------------------------- |
| regression   | `/rɪˈɡrɛʃən/`                             | n. 回归；退化                                        |
| hunger       | `/ˈhʌŋɡər/`                               | n. 饥饿；渴望 <br />v. 渴望                          |
| campaign     | `/kæmˈpeɪn/`                              | n. 活动；运动；战役                                  |
| hostile      | `/ˈhɑːstəl/`                              | adj. 敌对的；不友好的                                |
| empower      | `/ɪmˈpaʊər/`                              | v. 授权；使能够                                      |
| power        | `/ˈpaʊər/`                                | n. 力量；权力；电力 <br />v. 供电；驱动              |
| schedule     | `/ˈskedʒʊl/`                              | n. 时间表；日程安排 <br />v. 安排；预定              |
| antagonistic | `/ænˌtæɡəˈnɪstɪk/`                        | adj. 敌对的；对抗性的                                |
| court        | `/kɔːrt/`                                 | n. 法院；球场；宫廷 <br />v. 追求；招致              |
| veto         | `/ˈviːtoʊ/`                               | n. 否决权 <br />v. 否决                              |
| uplift       | `/ʌpˈlɪft/`（v. ）<br /> `/ˈʌplɪft/`(n. ) | v. 提升（物理上或抽象层面）；振奋<br />n. 提升；振奋 |
| thorough     | `/ˈθɜːroʊ/`                               | adj. 彻底的；详尽的                                  |
| biography    | `/baɪˈɑːɡrəfi/`                           | n. 传记；传记文学                                    |
| mingle       | `/ˈmɪŋɡəl/`                               | v. （使）混合；（使）交往                            |
| lie          | `/laɪ/`                                   | v. 躺；位于；说谎 <br />n. 谎言                      |
...
|------------|------------------|------------------------------------------------|
| announce   | `/əˈnaʊns/`      | v. 宣布；通告                                       |
| further    | `/ˈfɜːrðər/`      | adv. 更远地；进一步地<br />adj. 更远的；进一步的 <br />v. 促进；推动 |
| order      | `/ˈɔːrdər/`      | n. 顺序；命令；订单 <br />v. 订购；命令                 |
| conduit    | `/ˈkɑːnduɪt/`    | n. 导道；渠道                                       |
| hypothesis | `/haɪˈpɑːθəsɪs/` | n. 假设；假说                                       |
| complete   | `/kəmˈpliːt/`    | adj. 完整的；完全的 <br />v. 完成                    |
| band       | `/bænd/`         | n. 乐队；带(子)；波段；级别 <br />v. 联合；绑(bǎng)扎   |
| stamp      | `/stæmp/`        | n. 邮票；印章 <br />v. 盖章；跺脚                     |
| voluntary  | `/ˈvɑːləntɛri/`  | adj. 自愿的；志愿的                                  |
| hereby     | `/hɪrˈbaɪ/`      | adv. 特此；以此                                     |
| secret     | `/ˈsiːkrɪt/`     | adj. 秘密的；保密的 <br/>n. 秘密                      |
...
| 单词           | 美式发音             | 词类 + 汉语释义             |
|--------------|------------------|-----------------------|
| decoration   | `/ˌdɛkəˈreɪʃən/` | n. 装饰；装潢              |
| adornment    | `/əˈdɔːrnmənt/`  | n. 装饰；装饰品             |
| slippery     | `/ˈslɪpəri/`     | adj. 滑的；狡猾的           |
| encounter    | `/ɪnˈkaʊntər/`   | n. 遭遇；邂逅 <br />v. 遇到  |
| ambiguous    | `/æmˈbɪɡjuəs/`   | adj. 模棱两可的；不明确的       |
| festive      | `/ˈfɛstɪv/`      | adj. 节日的；欢乐的          |
| conviction   | `/kənˈvɪkʃən/`   | n. 定罪；信念              |
| firm         | `/fɜːrm/`        | adj. 坚固的；坚定的 <br />n. 公司 |
| instant      | `/ˈɪnstənt/`     | adj. 即时的，立即的；<br />n. 瞬间；片刻 |
| duplicate    | `/ˈduːplɪkeɪt/`  | adj. 完全相同的；复制的 <br />n. 复制品 <br />v. 复制 |
...
| 单词            | 美式发音             | 词类 + 汉语释义      |
|---------------|------------------| -------------------- |
| litter        | `/ˈlɪtər/`       | n. 垃圾；废弃物 <br />v. 乱丢垃圾     |
| sanction      | `/ˈsæŋkʃən/`     | n. 制裁；批准 <br />v. 批准；制裁 |
| congressional | `/kənˈɡrɛʃənəl/` | adj. 国会的 |
| congress      | `/ˈkɑːŋɡrɛs/`    | n. 国会；大会 |
| oversight     | `/ˈoʊvərsaɪt/`   | n. 监督；疏忽 |
| antagonym     | `/ænˈtæɡənɪm/`   | n. 自反词（具有相反两种含义的词） |
| indefinite    | `/ɪnˈdefənət/`   | adj. 无限期的；不确定的 |
...
| 单词           | 美式发音                | 词类 + 汉语释义               |
|--------------|---------------------|-------------------------|
| specialty    | `/ˈspɛʃəlti/`       | n. 专业；特长；特产              |
| endure       | `/ɪnˈdʊr/`          | v. 忍受；持续                    |
| scrap        | `/skræp/`           | n. 碎片；废料<br>v. 废弃；取消   |
| sleepy       | `/sliːpi/`          | adj. 困倦的                      |
| quo          | `/kwoʊ/`            | n. 现状（常用于短语 status quo） |
| bias         | `/ˈbaɪəs/`          | n. 偏见；偏爱<br>v. 使有偏见     |
| encyclopedia | `/ɪnˌsaɪkləˈpidɪə/` | n. 百科全书                      |
| maintain     | `/meɪnˈteɪn/`       | v. 维持；维护；主张              |
| status       | `/ˈsteɪtəs/`        | n. 地位；状态                    |
| special      | `/ˈspɛʃəl/`         | adj. 特别的；特殊的            |
| alarm        | `/əˈlɑrm/`          | n. 警报；<br />v. 使惊恐      |
| barrier      | `/ˈbæriər/`         | n. 障碍物；屏障               |
| reenter      | `/riˈɛntər/`        | v. 再进入                  |
| moss         | `/mɔs/`             | n. 苔藓（xiǎn）             |
| cabin        | `/ˈkæbɪn/`          | n. 小(木)屋；船舱             |
| log          | `/lɒːɡ/`            | n. 圆木；日志；v. 记录          |
| stack        | `/stæk/`            | n. 堆；v. 堆积              |
...
|----------------|---------------------|----------------------|
| prey           | `/preɪ/`            | n. 猎物；v. 捕食   |
| stalk          | `/stɔːk/`           | v. 悄悄跟踪；n. 茎 |
| groan          | `/ɡroʊn/`           | v. 呻吟；n. 呻吟声  |
| disappointment | `/ˌdɪsəˈpɔɪntmənt/` | n. 失望             |
| appoint        | `/əˈpɔɪnt/`         | v. 任命；指定      |
| failure        | `/ˈfeɪljər/`        | n. 失败；故障      |
| magnify        | `/ˈmæɡnɪfaɪ/`       | vt. 放大；夸大            |
| tendency       | `/ˈtɛndənsi/`       | n. 趋势；倾向             |
| virtue         | `/ˈvɜːrtʃuː/`       | n. 美德；优点             |
| retreat        | `/rɪˈtriːt/`        | n. & v. 撤退；隐退        |
| force          | `/fɔːrs/`           | n. 力量；影响力 <br />v. 强迫 |
| writ           | `/rɪt/`             | n. 正式文书；命令状         |
| deception      | `/dɪˈsɛpʃən/`       | n. 欺骗；诡计            |
| infinite       | `/ˈɪnfənət/`        | adj. 无限的；无穷的        |
| converter      | `/kənˈvɜrtər/`      | n. 转换器；变流器          |
| drive          | `/draɪv/`           | v. 驾驶；推动<br>n. 驱动；驱动器 |
...
| 单词     | 美式发音        | 词类 + 汉语释义               |
| -------- | --------------- | ----------------------------- |
| theater  | `/ˈθiətər/`     | n. 剧院；电影院               |
| theatre  | `/ˈθiətər/`     | n. 剧院；电影院               |
| rave     | `/reɪv/`        | v. 狂热赞扬; <br />n. 狂欢派对 |
| rant     | `/rænt/`        | v. 咆哮；长篇大论             |
| brave    | `/breɪv/`       | adj. 勇敢的；<br />v. 勇敢面对 |
| survival | `/sərˈvaɪvəl/`  | n. 生存；幸存                 |
| fit      | `/fɪt/`         | v. 适合；安装；<br />adj. 合适的；健康的 |
| fittest  | `/ˈfɪtɪst/`     | adj. 最适合的（fit的最高级）     |
| incident | `/ˈɪnsɪdənt/`   | n. 事件；事故                 |
| optical  | `/ˈɑptɪkəl/`    | adj. 光学的；视觉的           |
| converge | `/kənˈvɜːrdʒ/`  | v. 汇聚；集中                 |
| focal    | `/ˈfoʊkəl/`     | adj. 焦点的；核心的           |
| among    | `/əˈmʌŋ/`       | prep. 在...之中               |
| element  | `/ˈeləmənt/`    | n. 元素；成分                 |
| hydrogen | `/ˈhaɪdrədʒən/` | n. 氢                         |
| oxygen   | `/ˈɑːksɪdʒən/`  | n. 氧                         |
| abundant | `/əˈbʌndənt/`   | adj. 丰富的；大量的           |
...
| truth       | `/truθ/`       | n. 真相；真理          |
| attribute   | `/ˈætrəbjuːt/` (n.), <br />`/əˈtrɪbjuːt/` (v.) | n. 属性；v. 归因于     |
...
| 单词               | 美式发音               | 词类 + 汉语释义        |
|------------------|--------------------|------------------|
| impact           | `/ˈɪmpækt/`        | n. 影响；冲击<br>v. 影响；撞击 |
| depressant       | `/dɪˈprɛsənt/`     | n. 抑制剂；镇静剂       |
| neuro-           | `/ˈnʊroʊ-/`        | prefix. 神经的      |
| neurology        | `/nʊˈrɑːlədʒi/`    | n. 神经学           |
| neurotransmitter | `/'nʊrotrænzmɪtɚ/` | n. 神经递质          |
| depression       | `/dɪˈprɛʃən/`      | n. 抑郁（症）；萧条      |
| anxiety          | `/æŋˈzaɪəti/`      | n. 焦虑            |
| underlying       | `/ˌʌndərˈlaɪɪŋ/`   | adj. 潜在的；基础的     |
| emotional        | `/ɪˈmoʊʃənəl/`     | adj. 情感的；情绪的     |
| additional       | `/əˈdɪʃənəl/`      | adj. 附加的；额外的     |
| additionally     | `/əˈdɪʃənəli/`     | adv. 另外；此外       |
| impair           | `/ɪmˈpɛr/`         | v. 损害；削弱         |
| pair             | `/per/`            | n. 一对；一双；<br>v. 配对 |
| stock            | `/stɑk/`           | n. 库存；股票；<br>v. 储备 |
| stocking         | `/ˈstɑkɪŋ/`        | n. 长袜            |
| sock             | `/sɑːk/`           | n. 短袜<br>v. 猛击   |
| hose             | `/hoʊz/`           | n. 长筒袜；软管        |
| inhibition       | `/ˌɪnhəˈbɪʃən/`    | n. 抑制；拘束         |
| dwell            | `/dwɛl/`           | v. 居住；细想         |
| otherwise        | `/ˈʌðərˌwaɪz/`     | adv. 否则；不然；另外    |
...
| keep in check | `/kip ɪn tʃɛk/`      | phr. 控制；抑制          |
| serotonin     | `/ˌsɛrəˈtoʊnɪn/`     | n. 血清素              |
| dopamine      | `/ˈdoʊpəmin/`        | n. 多巴胺              |
| regulating    | `/ˈrɛɡjəleɪtɪŋ/`     | v. 调节；控制（regulate 的现在分词） |
| regulate      | `/ˈrɛɡjəleɪt/`       | v. 调节；控制            |
| intensify     | `/ɪnˈtɛnsəfaɪ/`      | v. 加强；加剧            |
| physiological | `/ˌfɪziəˈlɑːdʒɪkəl/` | adj. 生理的            |
| physiology    | `/ˌfɪziˈɑːlədʒi/`    | n. 生理学              |
| biochemistry  | `/ˌbaɪoʊˈkɛmɪstri/`  | n. 生物化学             |
| nausea        | `/ˈnɔːziə/`          | n. 恶心；反胃            |
| fatigue       | `/fəˈtiːɡ/`          | n. 疲劳                |
| contribute    | `/kənˈtrɪbjuːt/`     | v. 贡献；捐献；促成         |
| wear off      | `/wɛr ɔf/`           | phr. 逐渐消失           |
| hang          | `/hæŋ/`              | v. 悬挂；绞死；垂下         |
| hangover      | `/ˈhæŋoʊvər/`        | n. 宿醉               |
| otter         | `/ˈɑːtər/`            | n. 水獭               |
| profound      | `/prəˈfaʊnd/`        | adj. 深刻的；深远的        |
| crack         | `/kræk/`             | v. 破裂；破解；<br>n. 裂缝  |
...
| binge        | `/bɪndʒ/`         | n. 狂欢；大吃大喝<br>v. 狂饮；大吃大喝 |
...
| discoverability  | `/dɪsˌkʌvərəˈbɪləti/` | n. 可发现性                  |
| discoverable     | `/dɪsˈkʌvərəbl/`   | adj. 可发现的                |
| endow            | `/ɪnˈdaʊ/`         | v. 捐赠；赋予                 |
| release          | `/rɪˈliːs/`        | v. 释放；发布<br>n. 释放；发布     |
| pick             | `/pɪk/`            | v. 挑选；采摘<br>n. 挑选        |
...
| 单词          | 美式发音            | 词类 + 汉语释义         |
| ----------- |-----------------|-------------------|
| suppress    | `/səˈpres/`     | v. 镇压；抑制          |
| adapt       | `/əˈdæpt/`      | v. 适应；改编          |
| uncomment   | `/ʌnˈkɑːment/`  | v. 去掉注释           |
| squash      | `/skwɑːʃ/`      | v. 压扁；镇压<br>n. 壁球 |
| sleep       | `/sliːp/`       | v. 睡觉<br>n. 睡眠    |
| marble      | `/ˈmɑːrbəl/`    | n. 大理石；弹珠         |
| dug         | `/dʌɡ/`         | v. dig 的过去式和过去分词：挖 |
...
| balance     | `/ˈbæləns/`     | n. 平衡；余额<br>v. 平衡 |
| beak        | `/biːk/`        | n. 鸟嘴             |
| bird        | `/bɜːrd/`       | n. 鸟              |
...
| delighted   | `/dɪˈlaɪtɪd/`   | adj. 愉快的；高兴的      |
| demonstrate | `/ˈdemənstreɪt/` | v. 演示；证明          |
| den         | `/den/`         | n. 兽穴；书斋          |
...
| 单词            | 美式发音            | 词性 + 汉语释义            |
|---------------|-----------------|----------------------|
| as            | `/æz/`          | conj. 当...时；因为；尽管<br>adv. 像...一样 |
| when          | `/wen/`         | conj. 当...时；何时；如果<br>adv. 何时 |
| before        | `/bɪˈfɔːr/`     | conj. 在...之前<br>prep. 在...之前<br>adv. 以前 |
| after         | `/ˈæftər/`      | conj. 在...之后<br>prep. 在...之后 |
| while         | `/waɪl/`        | conj. 当...时候；虽然<br>n. 一段时间 |
| since         | `/sɪns/`        | conj. 自从；因为<br>adv. 从那时到现在 |
| until         | `/ənˈtɪl/`      | conj. & prep.  直到 |
| once          | `/wʌns/`        | conj. 一旦<br>adv. 一次  |
| where         | `/wer/`         | conj. 在...的地方<br>adv. 哪里 |
| wherever      | `/werˈevər/`    | conj. 无论哪里<br>adv. 无论什么地方 |
| though        | `/ðoʊ/`         | conj. 虽然<br>adv. 然而  |
...
| provided that | `/prəˈvaɪdɪd ðæt/` | conj. 只要             |
| as if         | `/æz ɪf/`       | conj. 仿佛             |
| as though     | `/æz ðoʊ/`      | conj. 仿佛             |
| although      | `/ɔlˈðoʊ/`      | conj. 虽然             |
| even though   | `/ˈivən ðoʊ/`   | conj. 即使             |
| whereas       | `/werˈæz/`      | conj. 然而             |
| while         | `/waɪl/`        | conj. 当...时候；虽然      |
| dramatic      | `/drəˈmætɪk/`   | adj. 戏剧性的；引人注目的      |
| ==demographic | `/ˌdeməˈɡræfɪk/` | adj. 人口统计的<br>n. 人口统计数据 |
...
| 单词                | 美式发音                   | 词类 + 汉语释义           |
|-------------------|------------------------|---------------------|
| faint             | `/feɪnt/`              | adj. 微弱的；模糊的<br />v. 晕倒 |
| compact           | `/kəmˈpækt/`           | adj. 紧凑的；小型的<br/>v. 压紧 |
| laminate          | `/ˈlæməneɪt/`          | v. 覆膜；n. 层压板        |
| callout           | `/ˈkɔːlaʊt/`           | n. 呼叫；标注            |
| spec              | `/spɛk/`               | n. 规格；说明（specification的缩写） |
| account           | `/əˈkaʊnt/`            | n. 账户；描述；解释<br/>v. 解释；说明 |
| take into account | `/teɪk ˈɪntu əˈkaʊnt/` | phrasal. 考虑；重视      |
| skim              | `/skɪm/`               | v. 略读，撇去〔液体表面的浮油或漂浮物〕 |
| crucial           | `/ˈkruːʃəl/`           | adj. 关键的；决定性的       |
| central           | `/ˈsentrəl/`           | adj. 中央的；核心的        |
| chip              | `/tʃɪp/`               | n. 薄片；芯片；碎片<br/>v. 削下；打破 |
| narration         | `/nəˈreɪʃən/`          | n. 叙述；旁白            |
| sleek             | `/sliːk/`              | adj. 光滑的；时髦的        |
| informative       | `/ɪnˈfɔːrmətɪv/`       | adj. 提供信息的          |
| entertaining      | `/ˌɛntərˈteɪnɪŋ/`      | adj. 有趣的；娱乐性的       |
...
| 单词          | 美式发音             | 词性 + 汉语释义              |
|-------------|------------------|------------------------|
| arbor       | `/ˈɑrːbər/`      | n. 树荫处；凉亭              |
| minutia     | `/mɪˈnuːʃɪə/`    | n. 细节；琐事（单数形式）         |
| minutiae    | `/mɪ’nuːʃɪi/`    | n. 细节；琐事（复数）           |
| chief       | `/tʃiːf/`        | adj. 主要的<br>n. 首领      |
| deputy      | `/ˈdɛpjəti/`     | n. 副手；代理人              |
| destruct	  | `/dɪˈstrʌkt/`    | v. 毁坏；破坏	              |
| destructive | `/dɪˈstrʌktɪv/`  | adj. 破坏性的              |
| erase       | `/ɪˈreɪs/`       | v. 擦除；删除               |
| any	      | `/ˈeni/`	     | adj. 任何的；一些的<br/>pron. 一些；任何事物 |
| bonus       | `/ˈboʊnəs/`      | n. 奖金；额外奖励             |
| lexical     | `/ˈleksɪkəl/`    | adj. 词汇的；词典的           |
| coherence   | `/koʊˈhɪrəns/`   | n. 连贯性；一致性             |
| academy     | `/əˈkædəmi/`     | n. 学院；学会               |
| bark        | `/bɑːrk/`        | n. 树皮；狗吠声<br>v. (狗)吠叫  |
| dye         | `/daɪ/`          | n. 染料<br>v. 染色         |
| die         | `/daɪ/`          | v. 死亡；消亡               |
| verse       | `/vɜːrs/`        | n. 诗歌；韵文               |
| module      | `/ˈmɑːdʒuːl/`    | n. 模块；单元               |
| merge       | `/mɜːrdʒ/`       | v. 合并；融合               |
| pulp        | `/pʌlp/`         | n. 浆状物；果肉 <br/>v. 将... 制成浆 |
| miss        | `/mɪs/`          | v. 想念；错过<br/>n. 小姐     |
| stamina     | `/ˈstæmənə/`     | n. 耐力；持久力              |
...
|-----------|----------------|-----------------------|
| pronounce | `/prəˈnaʊns/`  | v. 发音；宣布              |
| juggle    | `/ˈdʒʌɡəl/`    | v. 玩杂耍；同时应付           |
| aspirate  | `/ˈæspəˌreɪt/` | v. 吸入；发送气音<br>n. 送气音  |
| dash      | `/dæʃ/`        | v. 猛冲；撞击<br>n. 破折号    |
| ascend    | `/əˈsend/`     | v. 上升；攀登              |
| descend   | `/dɪˈsend/`    | v. 下降；下来              |
| vest      | `/vest/`       | n. 背心；马甲<br/>v. 授予    |
| invest    | `/ɪnˈvest/`    | v. 投资；投入              |
| rule      | `/ruːl/`       | n. 规则；统治 <br>v. 统治；支配 |
| inception | `/ɪnˈsepʃən/`  | n. 开始；开端              |
| basket    | `/ˈbæskɪt/`    | n. 篮子；篓               |
| case      | `/keɪs/`       | n. 情况；箱子；案件           |
| crux      | `/krʌks/`      | n. 关键；症结              |
| form      | `/fɔːrm/`      | n. 形式；表格<br>v. 形成     |
| orbit     | `/ˈɔːrbɪt/`    | n. 轨道<br>v. 绕轨道运行     |
| lump      | `/lʌmp/`       | n. 块；肿块<br>v. 结块      |
| revival   | `/rɪˈvaɪvəl/`  | n. 复兴；恢复              |
| cottage   | `/ˈkɑːtɪdʒ/`   | n. 小屋；别墅              |
| crash     | `/kræʃ/`       | v. 碰撞；崩溃<br>n. 碰撞；崩溃  |
| smash     | `/smæʃ/`       | v. 打碎；猛撞<br>n. 撞击；扣杀  |
| collide   | `/kəˈlaɪd/`    | v. 碰撞；相撞              |
| wreck     | `/rek/`        | v. 破坏；使失事<br/>n. 残骸；失事 |
...
| 单词           | 美式发音               | 词性 + 汉语释义        |
|--------------|--------------------|------------------|
| conclusive   | `/kənˈkluːsɪv/`    | adj. 确定的；决定性的    |
| rapid        | `/ˈræpɪd/`         | adj. 快速的<br>n. 急流 |
| contest      | `/ˈkɑnˌtɛst/` (n.)<br>`/kənˈtɛst/` (v.)  | n. 比赛；竞赛<br>v. 争夺；质疑 |
| iteration    | `/ˌɪtəˈreɪʃən/`    | n. 迭代；重复         |
| iterate      | `/ˈɪtəreɪt/`       | v. 迭代；重复         |
| item         | `/ˈaɪtəm/`         | n. 项目；物品         |
| satisfaction | `/ˌsætəsˈfækʃən/`  | n. 满意；满足         |
| relief       | `/rɪˈliːf/`        | n. 宽慰；(疼痛或不快的)减轻；救济 |
| interference | `/ˌɪntərˈfɪərəns/` | n. 干涉；干扰         |
| pattern      | `/ˈpætərn/`        | n. 模式；图案         |
| medical      | `/ˈmɛdɪkəl/`       | adj. 医学的；医疗的     |
| locality     | `/loʊˈkæləti/`     | n. 地区；位置         |
| calculation  | `/ˌkælkjəˈleɪʃən/` | n. 计算；估算         |
| physical     | `/ˈfɪzɪkəl/`       | adj. 身体的；物理的     |
| experiment   | `/ɪkˈsperəmənt/`   | n. 实验<br>v. 实验   |
| material     | `/məˈtɪriəl/`      | n. 材料；素材<br>adj. 物质的；重要的 |
...
| stray        | `/streɪ/`          | adj. 迷路的；<br />v. 走失；偏离 |
...
| 单词            | 美式发音                  | 词类 + 汉语释义             |
| --------------- |-----------------------| -------------------------- |
| consortium      | `/kənˈsɔrtiəm/`       | n. 联盟；财团              |
| footprint       | `/ˈfʊtprɪnt/`         | n. 脚印；足迹（个人或机构活动对环境的影响） |
| specific        | `/spəˈsɪfɪk/`         | adj. 特定的；明确的        |
| combination     | `/ˌkɑːmbɪˈneɪʃən/`    | n. 结合；组合              |
| profile         | `/ˈproʊfaɪl/`         | n. 侧面；简介；配置文件      |
| reproducible    | `/ˌriːprəˈduːsəbl/`   | adj. 可复制的              |
| reproduce       | `/ˌriːprəˈduːs/`      | v. 复制；繁殖             |
| representation  | `/ˌreprɪzɛnˈteɪʃən/`  | n. 代表；表现              |
| entail          | `/ɪnˈteɪl/`           | v. 牵涉；需要              |
| analog          | `/ˈænəlɔg/`           | adj. 模拟的               |
| arbitrary       | `/ˈɑːrbətreri/`       | adj. 任意的；随机的        |
| correspond      | `/ˌkɔːrəˈspɑːnd/`     | v. 相符；相一致          |
| assign          | `/əˈsaɪn/`            | v. 分配；指派              |
| discrete        | `/dɪˈskriːt/`         | adj. 离散的；不连续的      |
| stress          | `/stres/`             | n. 压力；重读；<br />v. 强调；重读 |