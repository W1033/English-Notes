...
| 单词               | 美式发音                              | 词性 + 汉语释义              |
|------------------| ---------------------------------- | -------------------------- |
| salivary         | `/ˈsælɪˌvɛri/`                    | adj. 唾液的；分泌唾液的         |
| bowel            | `/ˈbaʊəl/`                        | n. 肠；内部                |
| demonstrate      | `/ˈdɛmənˌstreɪt/`                 | v. 展示；证明               |
| clarity          | `/ˈklærəti/`                      | n. 清晰；明确               |
| bow              | `/baʊ/`(n. & v.)<br>`/boʊ/`(n.)   | n. 鞠躬；弓<br>v. 鞠躬       |
| homesick         | `/ˈhoʊmˌsɪk/`                     | adj. 想家的                |
| homesickness     | `/ˈhoʊmˌsɪknəs/`                  | n. 思乡；想家               |
| lord             | `/lɔːrd/`                         | n. 主；贵族                |
| fortitude        | `/ˈfɔːrtɪˌtjuːd/`                 | n. 坚韧；刚毅               |
| piety            | `/ˈpaɪɪti/`                       | n. 虔诚；孝顺               |
| famous           | `/ˈfeɪməs/`                       | adj. 著名的；有名的           |
| oral             | `/ˈɔːrəl/`                        | adj. 口头的；口腔的           |
| aurora           | `/əˈrɔːrə/`                       | n. 极光；黎明               |
| uppity           | `/ˈʌpɪti/`                        | adj. 自负的；傲慢的           |
| pretentious      | `/prɪˈtɛnʃəs/`                    | adj. 自命不凡的；炫耀的         |
| pretentiousness  | `/prɪˈtɛnʃəsnɪs/`                 | n. 自命不凡；炫耀             |
...
| millennia   | `/mɪˈlɛniə/`         | n. 千年（millennium 的复数形式）       |
| imbue       | `/ɪmˈbjuː/`          | v. 充满；灌输                      |
| visionary   | `/ˈvɪʒəˌnɛri/`       | adj. 有远见的；幻想的<br>n. 空想家       |
| prefecture  | `/ˈpriːfɛktʃər/`     | n. (日本等国家的)省；管区               |
| cheetah     | `/ˈtʃiːtə/`          | n. 猎豹                            |
| asset       | `/ˈæsɛt/`            | n. 资产；优点                      |
| assert      | `/əˈsɜːrt/`          | v. 断言；主张                      |
| negate      | `/nɪˈɡeɪt/`          | v. 否定；取消                      |
| negation    | `/nɪˈɡeɪʃən/`        | n. 否定；反对                      |
| recall      | `/rɪˈkɔːl/`          | v. 回忆；召回<br>n. 记忆；召回          |
| still       | `/stɪl/`             | adj. 静止的；平静的<br>adv. 仍然；依旧    |
| often       | `/ˈɔːfən/`           | adv. 经常                          |
| core        | `/kɔːr/`             | n. 核心；果核<br>v. 去核             |
| common      | `/ˈkɑːmən/`          | adj. 普通的；常见的                  |
| lot         | `/lɑːt/`             | n. 一堆；许多                      |
| intervene   | `/ˌɪntərˈviːn/`      | v. 干预；介入                      |
| amidst      | `/əˈmɪdst/`          | prep. 在...之中                   |
| distract    | `/dɪˈstrækt/`        | v. 分心；转移注意力                   |
...
|----------------| ----------------------- | ----------------------------------- |
| grok           | `/ɡrɑːk/`              | v. 理解；领悟                       |
| strip          | `/strɪp/`              | v. 剥去；脱光<br>n. 条；带             |
| scholarship    | `/ˈskɑːlərˌʃɪp/`       | n. 奖学金；学术研究                    |
| wed            | `/wɛd/`                | v. 结婚；结合                       |
| wedding        | `/ˈwɛdɪŋ/`             | n. 婚礼                            |
| tick           | `/tɪk/`                | n. 勾号；滴答声<br>v. 打勾；发出滴答声       |
| demand         | `/dɪˈmænd/`            | v. 需求；要求<br>n. 需求；要求           |
| cashback       | `/ˈkæʃˌbæk/`           | n. 返现                            |
| sip            | `/sɪp/`                | v. 小口喝<br>n. 一小口               |
| conclusion     | `/kənˈkluːʒən/`        | n. 结论；结束                       |
| attentive      | `/əˈtɛntɪv/`           | adj. 注意的；专心的                   |
| restore        | `/rɪˈstɔːr/`           | v. 恢复；修复                       |
| crush          | `/krʌʃ/`               | v. 压碎；迷恋<br>n. 压碎；迷恋           |
| hippo          | `/ˈhɪpoʊ/`             | n. 河马                            |
| cybernetic     | `/ˌsaɪbərˈnɛtɪk/`      | adj. 控制论的；信息论的                 |
| moiety         | `/ˈmɔɪəti/`            | n. 一部分；一半                      |
| expenditure    | `/ɪkˈspɛndɪtʃər/`      | n. 支出；花费                       |
| bog            | `/bɑːɡ/`               | n. 沼泽<br>v. 陷入泥沼               |
| reinforcement  | `/ˌriːɪnˈfɔːrsmənt/`   | n. 加强；增强                       |
| averse         | `/əˈvɜːrs/`            | adj. 反对的；厌恶的                   |
...
| 单词            | 美式发音                    | 词性 + 汉语释义                  |
| --------------- | ------------------------ | ------------------------------- |
| accidental      | `/ˌæksɪˈdɛntl/`         | adj. 偶然的；意外的               |
| cancellation    | `/ˌkænsəˈleɪʃən/`       | n. 取消；作废                   |
| transparency    | `/trænsˈpɛrənsi/`       | n. 透明；透明度                  |
| stem            | `/stɛm/`                | n. 茎；词干<br>v. 阻止；源自        |
| steam           | `/stiːm/`               | n. 蒸汽<br>v. 蒸发；冒热气         |
| recovery        | `/rɪˈkʌvəri/`           | n. 恢复；复苏                   |
| paramount       | `/ˈpærəˌmaʊnt/`         | adj. 至高无上的；最重要的            |
| capitalization  | `/ˌkæpɪtəlaɪˈzeɪʃən/`   | n. 大写；资本化                  |
| vertical        | `/ˈvɜːrtɪkəl/`          | adj. 垂直的                     |
| playback        | `/ˈpleɪbæk/`            | n. 回放                         |
| gut             | `/ɡʌt/`                 | n. 肠子；内脏<br>v. 取出内脏        |
| Barbara O'Neil  | `/ˈbɑːrbərə oʊˈniːl/`   | 专有名词，需根据上下文判断              |
| care            | `/kɛr/`                 | v. 关心；在意<br>n. 照顾；关怀       |
| paragraph       | `/ˈpærəˌɡræf/`          | n. 段落                         |
| consolidate     | `/kənˈsɒlɪˌdeɪt/`       | v. 巩固；合并                   |
| ensure          | `/ɪnˈʃʊr/`              | v. 确保；担保                   |
| caption         | `/ˈkæpʃən/`             | n. 标题；字幕                   |
| file            | `/faɪl/`                | n. 文件；档案<br>v. 归档；提出       |
| pheasant        | `/ˈfɛzənt/`             | n. 雉鸡；野鸡                   |
| day off         | `/deɪ ɔːf/`             | n. 休假；放假                   |
...
| 单词           | 美式发音                   | 词性 + 汉语释义                   |
| -------------- | ---------------------- | -------------------------------- |
| proper         | `/ˈprɑːpər/`           | adj. 合适的；适当的              |
| over           | `/ˈoʊvər/`             | prep. 在...之上<br>adv. 结束；再  |
| slate          | `/sleɪt/`              | n. 石板<br>v. 列入名单           |
| ripple         | `/ˈrɪpəl/`             | n. 涟漪；波纹<br>v. 起涟漪        |
| aesthetic      | `/ɛsˈθɛtɪk/`           | adj. 审美的；美学的              |
| large          | `/lɑːrdʒ/`             | adj. 大的；广泛的                |
| popper         | `/ˈpɑːpər/`            | n. 爆米花机；发射器               |
| spicy          | `/ˈspaɪsi/`            | adj. 辛辣的；有刺激性的            |
| breakfast      | `/ˈbrɛkfəst/`          | n. 早餐                          |
| sausage        | `/ˈsɔːsɪdʒ/`           | n. 香肠                         |
| turbulent      | `/ˈtɜːrbjələnt/`       | adj. 动荡的；汹涌的              |
| archive        | `/ˈɑːrkaɪv/`           | n. 档案；档案馆<br>v. 存档        |
| extravagant    | `/ɪkˈstrævəɡənt/`      | adj. 奢侈的；过度的              |
| scale          | `/skeɪl/`              | n. 规模；比例<br>v. 攀登         |
| authenticator  | `/ɔːˈθɛntɪˌkeɪtər/`    | n. 验证者；认证器                |
| torment        | `/ˈtɔːrmɛnt/`          | v. 折磨；使痛苦<br>n. 折磨；痛苦     |
| tug            | `/tʌɡ/`                | v. 用力拉<br>n. 猛拉            |
| eligibility    | `/ˌɛlɪdʒəˈbɪlɪti/`     | n. 资格；合格                    |
| redemption     | `/rɪˈdɛmʃən/`          | n. 赎回；救赎                    |
| jurisdiction   | `/ˌdʒʊrɪsˈdɪkʃən/`     | n. 管辖权；司法权                |
...
| 单词           | 美式发音                       | 词性 + 汉语释义                 |
| -------------- | -------------------------- | ---------------------------- |
| thereafter     | `/ðɛrˈæftər/`              | adv. 此后；以后                |
| pear           | `/pɛr/`                    | n. 梨                       |
| foreground     | `/ˈfɔːrɡraʊnd/`            | n. 前景；最显著的位置              |
| island         | `/ˈaɪlənd/`                | n. 岛屿                     |
| package        | `/ˈpækɪdʒ/`                | n. 包裹；一揽子计划<br>v. 包装      |
| outrage        | `/ˈaʊtˌreɪdʒ/`             | n. 愤怒；暴行<br>v. 激怒         |
| netizen        | `/ˈnɛtɪzən/`               | n. 网民                     |
| monopoly       | `/məˈnɑːpəli/`             | n. 垄断；专卖                  |
| monopolize     | `/məˈnɑːpəˌlaɪz/`          | v. 垄断；独占                  |
| monopolistic   | `/məˌnɑːpəˈlɪstɪk/`        | adj. 垄断的                  |
| oligarch       | `/ˈɑːləˌɡɑːrk/`            | n. 寡头                     |
| oligarchy      | `/ˈɑːləˌɡɑːrki/`           | n. 寡头政治                   |
| oligarchic     | `/ˌɑːləˈɡɑːrkɪk/`          | adj. 寡头的                  |
| oligarchical   | `/ˌɑːləˈɡɑːrkɪkəl/`        | adj. 寡头政治的                |
| realistic      | `/ˌriːəˈlɪstɪk/`           | adj. 现实的；实际的              |
| finalist       | `/ˈfaɪnəlɪst/`             | n. 决赛选手                   |
| finality       | `/faɪˈnælɪti/`             | n. 定局；终结                  |
| abyss          | `/əˈbɪs/`                  | n. 深渊；无底洞                 |
| tapir          | `/ˈteɪpər/`                | n. 貘（动物）                  |
| giveaway       | `/ˈɡɪvəˌweɪ/`              | n. 赠品；免费样品                |
...
| foe            | `/foʊ/`                  | n. 敌人；对手                 |
| exponent       | `/ɪkˈspoʊnənt/`          | n. 倡导者；指数                |
| exponential    | `/ˌɛkspəˈnɛnʃəl/`        | adj. 指数的；迅速增长的           |
| manage         | `/ˈmænɪdʒ/`              | v. 管理；控制                 |
| absolute       | `/ˈæbsəluːt/`            | adj. 绝对的；完全的             |
| absolutely     | `/ˈæbsəluːtli/`          | adv. 绝对地；完全地             |
| topic          | `/ˈtɑːpɪk/`              | n. 话题；主题                 |
| flaw           | `/flɔː/`                 | n. 缺陷；瑕疵                 |
| flawed         | `/flɔːd/`                | adj. 有缺陷的；错误的            |
| cognition      | `/kɒɡˈnɪʃən/`            | n. 认知；认识                 |
| passive        | `/ˈpæsɪv/`               | adj. 被动的；消极的             |
| control        | `/kənˈtroʊl/`            | v. 控制；管理<br>n. 控制；管理     |
| abbreviation   | `/əˌbriːviˈeɪʃən/`       | n. 缩写；简写                 |
| Centigrade     | `/ˈsɛntɪˌɡreɪd/`         | adj. 摄氏的                  |
| octave         | `/ˈɑːktɪv/`              | n. 八度音阶；八度               |
| camouflage     | `/ˈkæməˌflɑːʒ/`          | n. 伪装；掩饰<br>v. 伪装；掩饰     |
...
| 单词              | 美式发音                      | 词性 + 汉语释义                  |
|-----------------| -------------------------- | ------------------------------- |
| confiscate      | `/ˈkɑːnfɪˌskeɪt/`         | v. 没收；充公                   |
| kablooey        | `/kəˈbluːi/`              | int. 砰的一声（象声词，用于爆炸声）  |
| faulty          | `/ˈfɔːlti/`               | adj. 有缺陷的；错误的           |
| electromagnetic | `/ɪˌlɛktrəʊmæɡˈnɛtɪk/`    | adj. 电磁的                    |
| deflect         | `/dɪˈflɛkt/`              | v. 偏转；转移                   |
| capsule         | `/ˈkæpsəl/`               | n. 胶囊；小容器；太空舱         |
| bossy           | `/ˈbɔːsi/`                | adj. 专横的；好发号施令的       |
| sorta           | `/ˈsɔːrtə/`               | adv. 有点儿（口语化）           |
| deadliest       | `/ˈdɛdliəst/`             | adj. 最致命的                  |
| warden          | `/ˈwɔːrdən/`              | n. 管理员；监狱长              |
| pearson         | `/ˈpɪərsən/`              | 专有名词，需根据上下文判断         |
| coaster         | `/ˈkoʊstər/`              | n. 杯垫；过山车                 |
| tapestry        | `/ˈtæpəstri/`             | n. 挂毯；织锦                  |
| rhyme           | `/raɪm/`                  | n. 押韵；韵脚<br>v. 押韵       |
| sublime         | `/səˈblaɪm/`              | adj. 崇高的；壮丽的             |
| blend           | `/blɛnd/`                 | v. 混合；融合<br>n. 混合物      |
| assume          | `/əˈsuːm/`                | v. 假设；承担                   |
| strive          | `/straɪv/`                | v. 努力；奋斗                   |
| enact           | `/ɪˈnækt/`                | v. 制定（法律）；扮演           |
| archaic         | `/ɑːrˈkeɪɪk/`             | adj. 古老的；过时的             |
...
| 单词           | 美式发音                 | 词性 + 汉语释义              |
| -------------- | -------------------- | -------------------------- |
| confluence     | `/ˈkɑːnfluəns/`      | n. 汇合；交汇点              |
| salubrious     | `/səˈluːbriəs/`      | adj. 有益健康的；宜人的         |
| stratagem      | `/ˈstrætədʒəm/`      | n. 策略；计谋               |
| protractor     | `/prəˈtræktər/`      | n. 量角器                 |
| clarity        | `/ˈklærəti/`         | n. 清晰；明晰               |
| carry          | `/ˈkæri/`            | v. 携带；运送<br>n. 携带      |
| bunch          | `/bʌntʃ/`            | n. 束；捆<br>v. 捆成一束      |
| cocoon         | `/kəˈkuːn/`          | n. 茧；保护层               |
| peaky          | `/ˈpiːki/`           | adj. 苍白的；虚弱的           |
| bakery         | `/ˈbeɪkəri/`         | n. 面包店                 |
| Seattle        | `/siˈætl/`           | n. 西雅图（美国城市）           |
| fun            | `/fʌn/`              | n. 乐趣；玩笑<br>adj. 有趣的   |
| sibilant       | `/ˈsɪbɪlənt/`        | adj. 发出嘶嘶声的            |
| slush          | `/slʌʃ/`             | n. 融雪；稀泥               |
| slushie        | `/ˈslʌʃi/`           | n. 冰沙                   |
| tsunami        | `/tsuːˈnɑːmi/`       | n. 海啸                   |
| almond         | `/ˈɑːmənd/`          | n. 杏仁                   |
| wrack          | `/ræk/`              | n. 毁坏；失事               |
| wrench         | `/rɛntʃ/`            | n. 扳手；痛苦<br>v. 扭伤；使痛苦  |
| agnostic       | `/æɡˈnɒstɪk/`        | n. 不可知论者<br>adj. 不可知论的 |
...
| 单词               | 美式发音                    | 词性 + 汉语释义              |
|------------------| ----------------------- | --------------------------- |
| charge           | `/tʃɑːrdʒ/`             | v. 收费；指控<br>n. 费用；指控   |
| bribery          | `/ˈbraɪbəri/`           | n. 贿赂；行贿               |
| bribe            | `/braɪb/`               | v. 贿赂<br>n. 贿赂          |
| permissive       | `/pərˈmɪsɪv/`           | adj. 宽容的；放任的           |
| firmware         | `/ˈfɜːrmwɛr/`           | n. 固件                    |
| newbie           | `/ˈnuːbi/`              | n. 新手                    |
| verity           | `/ˈvɛrɪti/`             | n. 真实性；真理              |
| tweak            | `/twiːk/`               | v. 调整；微调<br>n. 小调整     |
| disclaimer       | `/dɪsˈkleɪmər/`         | n. 免责声明                |
| extensible       | `/ɪkˈstɛnsɪbəl/`        | adj. 可扩展的              |
| extension        | `/ɪkˈstɛnʃən/`          | n. 延长；扩展               |
| extenuate        | `/ɪkˈstɛn.juˌeɪt/`      | v. 减轻；为...找借口          |
| syntactical      | `/sɪnˈtæktɪkəl/`        | adj. 句法的                |
| distinguishable  | `/dɪˈstɪŋɡwɪʃəbəl/`     | adj. 可区分的；易识别的         |
| terminology      | `/ˌtɜːrmɪˈnɑːlədʒi/`    | n. 术语                    |
| evolve           | `/ɪˈvɑːlv/`             | v. 进化；发展               |
| manuscript       | `/ˈmænjəskrɪpt/`        | n. 手稿；原稿               |
| correction       | `/kəˈrɛkʃən/`           | n. 改正；校正               |
| typographic      | `/ˌtaɪpəˈɡræfɪk/`       | adj. 排版的                |
| boldface         | `/ˈboʊldˌfeɪs/`         | n. 粗体字                  |


#### Eleventh Table - ~~已校对~~ - ~~已写入 GoodNotes~~
...
| 单词           | 美式发音                | 词性 + 汉语释义              |
| -------------- | ------------------- | --------------------------- |
| trippy         | `/ˈtrɪpi/`          | adj. 迷幻的；怪异的          |
| stain          | `/steɪn/`           | n. 污点；污渍<br>v. 玷污；染色 |
| guinea         | `/ˈɡɪni/`           | n. 几内亚；几内亚币          |
| immobilize     | `/ɪˈmoʊbəˌlaɪz/`    | v. 使固定；使不能动          |
| straitjacket   | `/ˈstreɪtˌdʒækɪt/`  | n. 紧身衣；束缚             |
| oppressive     | `/əˈprɛsɪv/`        | adj. 压迫的；沉重的          |
| sins           | `/sɪnz/`            | n. 罪孽；过错               |
| superior       | `/sʊˈpɪriər/`       | adj. 优越的；上级的<br>n. 上级 |
| stumble        | `/ˈstʌmbəl/`        | v. 绊倒；结结巴巴地说         |
| doorstep       | `/ˈdɔːrˌstɛp/`      | n. 门前台阶                 |
| doorway        | `/ˈdɔːrweɪ/`        | n. 门口；入口               |
| chisel         | `/ˈtʃɪzəl/`         | n. 凿子<br>v. 凿            |
| velarize       | `/ˈviːlərˌaɪz/`     | v. 使软腭化                 |
| pecs           | `/pɛks/`            | n. 胸肌（口语）             |
| converse       | `/ˈkɑːnvɜːrs/`      | v. 交谈<br>n. 相反的事物     |
| abandon        | `/əˈbændən/`        | v. 放弃；抛弃               |
| labour         | `/ˈleɪbər/`         | n. 劳动；劳工               |
| verbose        | `/vɜːrˈboʊs/`       | adj. 冗长的；啰嗦的          |
| applicant      | `/ˈæplɪkənt/`       | n. 申请者                  |
| corruption     | `/kəˈrʌpʃən/`       | n. 腐败；贪污               |



#### Twelfth Table - ~~已校对~~ - ~~已写入 GoodNotes~~
...
| 单词               | 美式发音                      | 词性 + 汉语释义                       |
|------------------| ------------------------- | ----------------------------------- |
| pumped           | `/pʌmpt/`                 | adj. 兴奋的；激动的                    |
| initiative       | `/ɪˈnɪʃətɪv/`             | n. 主动性；倡议                       |
| ass              | `/æs/`                    | n. 驴子；屁股（俚语）；笨蛋（俚语）           |
| Sabbath          | `/ˈsæbəθ/`                | n. 安息日                          |
| onstage          | `/ˈɑːnˌsteɪdʒ/`           | adv. 在舞台上<br>adj. 舞台上的          |
| doctrine         | `/ˈdɑːktrɪn/`             | n. 教义；信条                        |
| posse            | `/ˈpɑːsi/`                | n. 一群人；武装队伍                     |
| saddle           | `/ˈsædl/`                 | n. 马鞍<br>v. 给...装鞍              |
| prosaic          | `/proʊˈzeɪɪk/`            | adj. 平凡的；乏味的                    |
| cast             | `/kæst/`                  | v. 投掷；铸造<br>n. 演员阵容；铸件          |
| incomprehensible | `/ɪnˌkɑːmprɪˈhɛnsəbəl/`   | adj. 费解的；不可理解的                  |
| rewind           | `/ˌriːˈwaɪnd/`            | v. 倒带；回放                        |
| maid             | `/meɪd/`                  | n. 女仆；少女                        |
| disguise         | `/dɪsˈɡaɪz/`              | v. 伪装；掩饰<br>n. 伪装               |
| continent        | `/ˈkɑːntɪnənt/`           | n. 大陆；洲                         |
| infirmary        | `/ɪnˈfɜːrməri/`           | n. 医务室；医院                       |
| ego              | `/ˈiːɡoʊ/`                | n. 自我；自负                        |
| trailer          | `/ˈtreɪlər/`              | n. 拖车；预告片                       |
| brat             | `/bræt/`                  | n. 顽童；小淘气                       |
| inlay            | `/ˈɪnleɪ/`                | v. 镶嵌<br>n. 镶嵌物                 |


#### Thirteenth Table - ~~已校对~~ - ~~已写入 GoodNotes~~
...
| scorch         | `/skɔːrtʃ/`                | v. 烧焦；烤焦<br>n. 烧焦；焦痕                |
| scorching      | `/ˈskɔːrtʃɪŋ/`             | adj. 灼热的；酷热的                           |
| swelter        | `/ˈswɛltər/`               | v. 热得难受                                  |
| sweltering     | `/ˈswɛltərɪŋ/`             | adj. 闷热的；酷热的                           |
| freeze         | `/friːz/`                  | v. 冻结；结冰<br>n. 冰冻                       |
| freezing       | `/ˈfriːzɪŋ/`               | adj. 极冷的；冰冻的                           |
| starve         | `/stɑːrv/`                 | v. 挨饿；使饿死                              |
| starving       | `/ˈstɑːrvɪŋ/`              | adj. 饥饿的；极度匮乏的                       |
| hideous        | `/ˈhɪdiəs/`                | adj. 丑陋的；可怕的                           |
| grotesque      | `/ɡroʊˈtɛsk/`              | adj. 怪诞的；荒诞的                           |
| elated         | `/ɪˈleɪtɪd/`               | adj. 兴高采烈的；得意洋洋的                   |
| ecstatic       | `/ɪkˈstætɪk/`              | adj. 狂喜的；入迷的                           |
| overjoy        | `/ˌoʊvərˈdʒɔɪ/`            | v. 使极度高兴                                |
| overjoyed      | `/ˌoʊvərˈdʒɔɪd/`           | adj. 狂喜的；欣喜若狂的                       |
| devastate      | `/ˈdɛvəˌsteɪt/`            | v. 毁灭；使荒废                              |
| devastated     | `/ˈdɛvəˌsteɪtɪd/`          | adj. 极度震惊的；毁坏的                       |
| enrage         | `/ɪnˈreɪdʒ/`               | v. 激怒；使愤怒                              |
| enraged        | `/ɪnˈreɪdʒd/`              | adj. 被激怒的；愤怒的                         |
| pump           | `/pʌmp/`                   | n. 泵；打气机<br>v. 用泵输送；打气             |
...
| 单词           | 美式发音             | 词性 + 汉语释义                    |
|----------------|----------------------|--------------------------------|
| retaliate      | `/rɪˈtælieɪt/`       | v. 报复                        |
| retaliation    | `/rɪˌtæliˈeɪʃən/`    | n. 报复                        |
| song           | `/sɔːŋ/`             | n. 歌曲                        |
| prolog         | `/ˈproʊlɔːɡ/`        | n. 序言                        |
| tacit          | `/ˈtæsɪt/`           | adj. 心照不宣的；默示的               |
| way            | `/weɪ/`              | n. 方式；道路                     |
| emesis         | `/ˈɛmɪsɪs/`          | n. 呕吐                        |
| basin          | `/ˈbeɪsən/`          | n. 盆；盆地                      |
| dizzy          | `/ˈdɪzi/`            | adj. 头晕的                     |
| expectorant    | `/ɪkˈspɛktərənt/`    | n. 化痰药                       |
| squabble       | `/ˈskwɑːbəl/`        | v. 争吵<br>n. 争吵               |
| cavil          | `/ˈkævəl/`           | v. 吹毛求疵<br>n. 吹毛求疵           |
| carp           | `/kɑːrp/`            | v. 挑剔                        |
| gum            | `/ɡʌm/`              | n. 口香糖；牙龈                    |
| comedy         | `/ˈkɑːmədi/`         | n. 喜剧                        |
| mistress       | `/ˈmɪstrɪs/`         | n. 女主人；情妇                    |
| jukebox        | `/ˈdʒuːkbɑːks/`      | n. 自动点唱机                     |
| quarter        | `/ˈkwɔːrtər/`        | n. 四分之一；季度                   |
| improve        | `/ɪmˈpruːv/`         | v. 改善；提高                     |
| improvement    | `/ɪmˈpruːvmənt/`     | n. 改善；改进                     |
| decrease       | `/dɪˈkriːs/` (v.)<br>`ˈdiːkriːs/` (n.) | v. 减少<br>n. 减少  |
...
| 单词           | 美式发音                 | 词性 + 汉语释义                                    |
|----------------|------------------------|----------------------------------------------------|
| congeal        | `/kənˈdʒiːl/`          | v. 凝结；凝固                                      |
| govern         | `/ˈɡʌvərn/`            | v. 统治；管理                                      |
| procrastinate  | `/proʊˈkræstɪˌneɪt/`   | v. 拖延                                            |
| procrastination| `/proʊˌkræstɪˈneɪʃən/` | n. 拖延                                            |
| inspirational  | `/ˌɪnspəˈreɪʃənl/`     | adj. 鼓舞人心的                                    |
| unconscious    | `/ʌnˈkɑːnʃəs/`         | adj. 无意识的；失去知觉的                           |
| marvellous     | `/ˈmɑːrvələs/`         | adj. 奇妙的；了不起的                              |
| mighty         | `/ˈmaɪti/`             | adj. 强大的<br>adv. 非常                           |
| endurance      | `/ɪnˈdʊrəns/`          | n. 耐力；持久力                                    |
| mission        | `/ˈmɪʃən/`             | n. 使命；任务                                      |
| priority       | `/praɪˈɔːrɪti/`        | n. 优先权；优先事项                                |
| meadow         | `/ˈmɛdoʊ/`             | n. 草地；牧场                                      |
| gratis         | `/ˈɡrætɪs/`            | adv. 免费地                                        |
| abnormal       | `/æbˈnɔːrməl/`         | adj. 反常的；异常的                                |
| slumber        | `/ˈslʌmbər/`           | v. 睡眠<br>n. 睡眠                                  |
| musicianship   | `/mjuˈzɪʃnʃɪp/`        | n. 音乐才能                                        |
| vocal          | `/ˈvoʊkl/`             | adj. 声音的；发声的<br>n. 声乐部分                  |
| kick           | `/kɪk/`                | v. 踢<br>n. 踢                                     |
| durak          | `/ˈduːrɑːk/`           | n. 二十一点牌戏（俄罗斯纸牌游戏）                   |
| fake           | `/feɪk/`               | adj. 假的<br>v. 伪造<br>n. 假货                     |
...
| 单词           | 美式发音                 | 词性 + 汉语释义                     |
|----------------|------------------------|----------------------------------|
| underestimate  | `/ˌʌndərˈɛstɪˌmeɪt/`   | v. 低估                         |
| overestimate   | `/ˌoʊvərˈɛstɪˌmeɪt/`   | v. 高估                         |
| brood          | `/bruːd/`              | v. 沉思；孵蛋<br>n. 一窝幼鸟           |
| whiff          | `/wɪf/`                | n. 一股气味；一阵风                   |
| parrot         | `/ˈpærət/`             | n. 鹦鹉<br>v. 鹦鹉学舌地重复           |
| crop           | `/krɑːp/`              | n. 庄稼；作物<br>v. 修剪             |
| buttock        | `/ˈbʌtək/`             | n. 臀部                         |
| muck           | `/mʌk/`                | n. 污泥；粪便                      |
| dip            | `/dɪp/`                | v. 浸<br>n. 调味酱                |
| virgin         | `/ˈvɜːrdʒɪn/`          | n. 处女；未开发的东西                  |
| unspoiled      | `/ʌnˈspɔɪld/`          | adj. 未受破坏的；未开发的               |
| tune-up        | `/ˈtuːn ʌp/`           | n. 调整；调试                      |
| Soviet         | `/ˈsoʊviət/`           | adj. 苏联的<br>n. 苏联             |
| union          | `/ˈjuːnjən/`           | n. 联盟；工会                      |
| duffle         | `/ˈdʌfəl/`             | n. 粗呢；行李                      |
| surplus        | `/ˈsɜːrpləs/`          | n. 过剩<br>adj. 多余的             |
| grenade        | `/ɡrəˈneɪd/`           | n. 手榴弹                        |
| swoop          | `/swuːp/`              | v. 俯冲<br>n. 俯冲                |
| consume        | `/kənˈsuːm/`           | v. 消费；消耗                      |
| hustle         | `/ˈhʌsəl/`             | v. 推搡；猛推<br>n. 奋力争取           |
...
| 单词           | 美式发音           | 词性 + 汉语释义                                      |
|----------------|--------------------|------------------------------------------------------|
| ideal          | `/aɪˈdiːəl/`       | adj. 理想的；完美的<br>n. 理想                       |
| invitation     | `/ˌɪnvɪˈteɪʃən/`   | n. 邀请；请柬                                        |
| register       | `/ˈredʒɪstər/`     | v. 登记；注册<br>n. 登记簿；注册                     |
| fame           | `/feɪm/`           | n. 名声；声望                                        |
| downward       | `/ˈdaʊnwərd/`      | adj. 向下的；下降的<br>adv. 向下地                   |
| drawback       | `/ˈdrɔːbæk/`       | n. 缺点；不利条件                                    |
| renewal        | `/rɪˈnuːəl/`       | n. 更新；续期                                        |
| warfare        | `/ˈwɔːrfer/`       | n. 战争；斗争                                        |
| outlandish     | `/aʊtˈlændɪʃ/`     | adj. 古怪的；异国风格的                              |
| stoked         | `/stoʊkt/`         | adj. 兴奋的；激动的                                  |
| terrify        | `/ˈterəfaɪ/`       | v. 使恐惧；使害怕                                    |
| terrified      | `/ˈterəfaɪd/`      | adj. 非常害怕的                                      |
| terrific       | `/təˈrɪfɪk/`       | adj. 极好的；可怕的                                  |
| petrify        | `/ˈpetrəfaɪ/`      | v. 使石化；使惊呆                                    |
| petrified      | `/ˈpetrəfaɪd/`     | adj. 吓呆的；石化的                                  |
| ubiquitous     | `/juːˈbɪkwɪtəs/`   | adj. 无处不在的                                      |
| browse         | `/braʊz/`          | v. 浏览；吃草<br>n. 浏览                             |
| browsing       | `/ˈbraʊzɪŋ/`       | n. 浏览；吃草(browse 的现在分词)                    |
| population     | `/ˌpɑːpjəˈleɪʃən/` | n. 人口；全体居民                                    |
| tighten        | `/ˈtaɪtən/`        | v. 收紧；变紧                                        |
| pause          | `/pɔːz/`           | v. 暂停；犹豫<br>n. 暂停；中止                       |
| ominous        | `/ˈɑːmɪnəs/`       | adj. 不祥的；预兆的                                  |
| whine          | `/waɪn/`           | v. 哀鸣；发牢骚<br>n. 哀鸣声                         |
...
| 单词          | 美式发音            | 词性 + 汉语释义                          |
|---------------|---------------------|------------------------------------------|
| level         | `/ˈlɛvəl/`          | n. 水平；等级<br>adj. 平的；水平的<br>v. 使平坦；使对等 |
| foam          | `/foʊm/`            | n. 泡沫<br>v. 起泡沫                     |
| cage          | `/keɪdʒ/`           | n. 笼子<br>v. 关进笼子                   |
| vibe          | `/vaɪb/`            | n. 气氛；氛围                             |
| marketing     | `/ˈmɑrkɪtɪŋ/`       | n. 市场营销                               |
| tickle        | `/ˈtɪkəl/`          | v. 使发痒；逗乐<br>n. 痒感               |
| inflation     | `/ɪnˈfleɪʃən/`      | n. 通货膨胀                               |
| somersault    | `/ˈsʌmərˌsɔlt/`     | n. 翻筋斗<br>v. 翻筋斗                    |
| ankle         | `/ˈæŋkəl/`          | n. 脚踝                                   |
| which         | `/wɪtʃ/`            | pron. 哪一个；哪个                        |
| niece         | `/nis/`             | n. 侄女；外甥女                           |
| anger         | `/ˈæŋɡər/`          | n. 愤怒<br>v. 使愤怒                     |
| angry         | `/ˈæŋɡri/`          | adj. 愤怒的                               |
| forbearance   | `/fɔrˈbɛrəns/`      | n. 忍耐；宽容                             |
| relative      | `/ˈrɛlətɪv/`        | n. 亲戚<br>adj. 相对的                     |
| cross         | `/krɔs/`            | v. 穿过；交叉<br>n. 十字架；交叉          |
| dictionary    | `/ˈdɪkʃənɛri/`      | n. 字典                                   |
| directory     | `/dəˈrɛktəri/`      | n. 名录；目录                             |
| cucumber      | `/ˈkjuˌkʌmbər/`     | n. 黄瓜                                   |
...
| 单词            | 美式发音            | 词性 + 汉语释义                          |
|-----------------|---------------------|------------------------------------------|
| line            | `/laɪn/`            | n. 线；排<br>v. 排队；画线                |
| lining          | `/ˈlaɪnɪŋ/`         | n. 衬里；内层                             |
| irritable       | `/ˈɪrɪtəbəl/`       | adj. 易怒的；急躁的                        |
| irritability    | `/ˌɪrɪtəˈbɪlɪti/`   | n. 易怒；过敏性                           |
| allergy         | `/ˈælɚdʒi/`         | n. 过敏症；反感                           |
| penalty         | `/ˈpɛnəlti/`        | n. 罚款；处罚                             |
| hazard          | `/ˈhæzərd/`         | n. 危险；冒险<br>v. 冒险                  |
| kerchief        | `/ˈkɜrtʃɪf/`        | n. 头巾；围巾                             |
| exclusively     | `/ɪkˈskluːsɪvli/`   | adv. 仅仅；专门地                         |
| typical         | `/ˈtɪpɪkəl/`        | adj. 典型的；特有的                       |
| typically       | `/ˈtɪpɪkli/`        | adv. 通常；典型地                         |
| augmentation    | `/ˌɔɡmɛnˈteɪʃən/`   | n. 增加；扩大                             |
| unwavering      | `/ʌnˈweɪvərɪŋ/`     | adj. 坚定的；不动摇的                      |
| contempt        | `/kənˈtɛmpt/`       | n. 轻视；蔑视                             |
| swing           | `/swɪŋ/`            | v. 摇摆；转动<br>n. 摇摆；秋千            |
| carpentry       | `/ˈkɑrpəntri/`      | n. 木工活；木匠手艺                        |
| wrestle         | `/ˈrɛsəl/`          | v. 摔跤；斗争<br>n. 摔跤；斗争            |
| alter           | `/ˈɔltər/`          | v. 改变；修改                             |
| push            | `/pʊʃ/`             | v. 推动；催促<br>n. 推动；决心            |
...
|-----------------|---------------------|------------------------------------------|
| tulip           | `/ˈtuːlɪp/`         | n. 郁金香                                 |
| recitation      | `/ˌrɛsɪˈteɪʃən/`    | n. 背诵；朗诵                              |
| bible           | `/ˈbaɪbəl/`         | n. 圣经；权威著作                          |
| ankle           | `/ˈæŋkəl/`          | n. 脚踝                                   |
| contort         | `/kənˈtɔrt/`        | v. 扭曲；歪曲                             |
| distort         | `/dɪˈstɔrt/`        | v. 扭曲；曲解                             |
| cruel           | `/ˈkruəl/`          | adj. 残酷的；无情的                        |
| unexpected      | `/ˌʌnɪkˈspɛktɪd/`  | adj. 意外的；突然的                        |
| cudgel          | `/ˈkʌdʒəl/`         | n. 棍棒；粗棒                              |
| eerie           | `/ˈɪri/`            | adj. 怪异的；可怕的                        |
| stair           | `/stɛr/`            | n. 楼梯；阶梯                              |
| summit          | `/ˈsʌmɪt/`          | n. 顶峰；峰会                              |
| morality        | `/məˈrælɪti/`       | n. 道德；伦理                              |
| avid            | `/ˈævɪd/`           | adj. 渴望的；热衷的                        |
| norm            | `/nɔrm/`            | n. 标准；规范                              |
| artillery       | `/ɑrˈtɪləri/`       | n. 火炮；炮兵                              |
| insurance       | `/ɪnˈʃʊrəns/`       | n. 保险；保障                              |
| monetary        | `/ˈmɑnɪˌtɛri/`      | adj. 货币的；金融的                        |
| its             | `/ɪts/`             | pron. 它的                                 |
| burn            | `/bɜrn/`            | v. 燃烧；灼伤<br>n. 烧伤；灼伤            |
| burning         | `/ˈbɜrnɪŋ/`         | adj. 燃烧的；强烈的<br>n. 燃烧            |
| completely      | `/kəmˈplitli/`      | adv. 完全地；彻底地                        |
...
| 单词            | 美式发音            | 词性 + 汉语释义                          |
|-----------------|---------------------|------------------------------------------|
| sunbeam         | `/ˈsʌnˌbiːm/`       | n. 阳光；光束                             |
| tranquility     | `/træŋˈkwɪlɪti/`    | n. 宁静；平静                             |
| ambassador      | `/æmˈbæsədər/`      | n. 大使；代表                             |
| scribble        | `/ˈskrɪbəl/`        | v. 潦草地写<br>n. 潦草的字迹               |
| polar           | `/ˈpoʊlər/`         | adj. 极地的；正好相反的                    |
| gametophyte     | `/ɡəˈmitəˌfaɪt/`    | n. 配子体                                 |
| precedent       | `/ˈprɛsɪdənt/`      | n. 先例；前例                             |
| unprecedented   | `/ʌnˈprɛsɪˌdɛntɪd/` | adj. 前所未有的；史无前例的                |
| collarless      | `/ˈkɔlərˌlɪs/`      | adj. 无领的                               |
| cause           | `/kɔz/`             | n. 原因；事业<br>v. 引起；导致            |
...
| sundae          | `/ˈsʌnˌdeɪ/`        | n. 圣代冰淇淋                              |
| swimsuit        | `/ˈswɪmˌsut/`       | n. 泳衣                                   |
...
|-----------------|---------------------|------------------------------------------|
| sale            | `/seɪl/`            | n. 销售；减价                             |
| vandal          | `/ˈvændl/`          | n. 破坏公物者                            |
| putative        | `/ˈpjutətɪv/`       | adj. 推定的；假定的                        |
| legacy          | `/ˈlɛɡəsi/`         | n. 遗产；遗留问题                          |
| strait          | `/streɪt/`          | n. 海峡；困境                         |
| plaque          | `/plæk/`            | n. 匾；牙斑                               |
| senile          | `/ˈsinaɪl/`         | adj. 年老的；衰老的                        |
| pharmacy        | `/ˈfɑrməsi/`        | n. 药房；药剂学                            |
| confine         | `/kənˈfaɪn/`        | v. 限制；禁闭                             |
| choke           | `/tʃoʊk/`           | v. 窒息；堵塞<br>n. 窒息；阻塞             |
| inexperience    | `/ˌɪnɪkˈspɪriəns/`  | n. 缺乏经验                               |
| inexperienced   | `/ˌɪnɪkˈspɪriənst/` | adj. 无经验的                              |
| delay           | `/dɪˈleɪ/`          | v. 延迟；耽搁<br>n. 延误；耽搁             |
| rotten          | `/ˈrɑtn/`           | adj. 腐烂的；糟糕的                        |
| column          | `/ˈkɑləm/`          | n. 柱子；专栏                              |
| straw           | `/strɔ/`            | n. 稻草；吸管                              |
| demeanor        | `/dɪˈminər/`        | n. 行为；举止                              |
| undergo         | `/ˌʌndərˈɡoʊ/`      | v. 经历；遭受                              |
| climb           | `/klaɪm/`           | v. 攀登；上升<br>n. 攀登；上升             |
| climber         | `/ˈklaɪmər/`        | n. 攀登者；登山者                          |
| sooner          | `/ˈsunər/`          | adv. 更早；宁愿                              |
| tyre            | `/taɪr/`            | n. 轮胎                                  |
...
| 单词            | 美式发音            | 词性 + 汉语释义                          |
|-----------------|---------------------|------------------------------------------|
| overripe        | `/ˌoʊvərˈraɪp/`     | adj. 熟过头的；过熟的                      |
| expired         | `/ɪkˈspaɪərd/`      | adj. 过期的                               |
| withered        | `/ˈwɪðərd/`         | adj. 枯萎的；憔悴的                        |
| soggy           | `/ˈsɔɡi/`           | adj. 湿透的；沉闷的                        |
| mealy           | `/ˈmili/`           | adj. 面粉状的；松软的                      |
| bitter          | `/ˈbɪtər/`          | adj. 苦的；痛苦的                          |
| silky           | `/ˈsɪlki/`          | adj. 丝绸般的；柔滑的                      |
| sour            | `/saʊər/`           | adj. 酸的；酸腐的                          |
| creamy          | `/ˈkrimi/`          | adj. 奶油般的；光滑的                      |
| bulb            | `/bʌlb/`            | n. 灯泡；球茎                              |
| fan             | `/fæn/`             | n. 扇子；风扇；粉丝<br>v. 扇风；煽动      |
| embarrass       | `/ɪmˈbærəs/`        | v. 使尴尬；使困窘                          |
| replicate       | `/ˈrɛplɪˌkeɪt/`     | v. 复制；重复<br>n. 复制品                 |
| clash           | `/klæʃ/`            | v. 冲突；碰撞<br>n. 冲突；不协调           |
| incognito       | `/ˌɪnkɑgˈnitoʊ/`    | adv. & adj. 隐姓埋名地；化名的             |
| suspicious      | `/səˈspɪʃəs/`       | adj. 可疑的；怀疑的                        |
| coherent        | `/koʊˈhɪrənt/`      | adj. 连贯的；一致的                        |
| computing       | `/kəmˈpjutɪŋ/`      | n. 计算；计算机科学                         |
| civilization    | `/ˌsɪvələˈzeɪʃən/`  | n. 文明；文化                              |
| singularity     | `/ˌsɪŋɡjəˈlærɪti/`  | n. 奇点；独特性                             |
...
| 单词            | 美式发音            | 词性 + 汉语释义                          |
|-----------------|---------------------|------------------------------------------|
| resolve         | `/rɪˈzɑːlv/`        | v. 解决；决心<br>n. 决心                  |
| procure         | `/prəˈkjʊr/`        | v. 获得；取得                              |
| procurement     | `/prəˈkjʊrmənt/`    | n. 采购；获得                              |
| purchase        | `/ˈpɜrtʃəs/`        | v. 购买<br>n. 购买；采购                   |
| fillip          | `/ˈfɪlɪp/`          | n. 激励；弹指                              |
| meringue        | `/məˈræŋ/`          | n. 蛋白甜饼；蛋白酥皮                       |
| chick           | `/tʃɪk/`            | n. 小鸡；小鸟                              |
| fault           | `/fɔlt/`            | n. 故障；过失<br>v. 指责                   |
| ruin            | `/ˈruːɪn/`          | v. 毁灭；破坏<br>n. 废墟；毁灭             |
| mess            | `/mɛs/`             | n. 混乱；脏乱<br>v. 弄乱                   |
| motivate        | `/ˈmoʊtəˌveɪt/`     | v. 激励；促使                              |
| revenge         | `/rɪˈvɛndʒ/`        | n. 复仇；报复<br>v. 报复                  |
| mister          | `/ˈmɪstər/`         | n. 先生                                    |
| field           | `/fild/`            | n. 领域；田地<br>v. 处理；应对              |
| wake            | `/weɪk/`            | v. 醒来；唤醒<br>n. 尾迹；守夜             |
| futurist        | `/ˈfjuːtʃərɪst/`    | n. 未来学家                                |
| futurism        | `/ˈfjuːtʃəˌrɪzəm/`  | n. 未来主义                                |
| shatter         | `/ˈʃætər/`          | v. 粉碎；破坏<br>n. 破碎；粉碎             |
...
|----------------|--------------------|--------------------------------|
| mare           | `/mɛr/`            | n. 母马；母驴                      |
| stare          | `/stɛr/`           | v. 凝视；盯着看<br>n. 凝视            |
| romance        | `/roʊˈmæns/`       | n. 浪漫；爱情故事                    |
| fussy          | `/ˈfʌsi/`          | adj. 挑剔的；过分装饰的                |
| feminine       | `/ˈfɛmənɪn/`       | adj. 女性的；娇柔的                  |
| plaintiff      | `/ˈpleɪntɪf/`      | n. 原告                         |
| exchange       | `/ɪksˈʧeɪndʒ/`     | n. 交换；交易所<br>v. 交换；兑换         |
| political      | `/pəˈlɪtɪkəl/`     | adj. 政治的                      |
| instability    | `/ˌɪnstəˈbɪlɪti/`  | n. 不稳定；动荡                     |
| wold           | `/woʊld/`          | n. 丘陵地带                       |
| compelling     | `/kəmˈpɛlɪŋ/`      | adj. 引人注目的；强迫性的               |
| wight          | `/waɪt/`           | n. 生物（旧或文学用语）                 |
...
| 单词           | 美式发音              | 词性 + 汉语释义                  | 示例 |
|--------------|-------------------|----------------------------|---|
| loom         | `/luːm/`           | v. 隐约出现<br>n. 织布机         | v. A storm was looming on the horizon. <br>(地平线上隐现出一场暴风雨。)<br>v. The deadline looms closer with each passing day. <br>(随着每一天的过去，截止日期越来越近。)<br>n. She worked on the loom for hours. <br>(她在织布机上工作了好几个小时。) |
...
| row            | `/roʊ/` (n. & v.)<br>`/raʊ/` (n. & v.) | n. 一行；一排<br>v. 划(船)<br>n. (尤指熟人之间的)争吵<br>v. 争吵 ✅ |
...
| 单词          | 美式发音            | 词性 + 汉语释义              |
|-------------|-----------------|------------------------|
| infiltrate  | `/ˈɪnfɪlˌtreɪt/`  | v. 渗透；潜入               |
| fuel        | `/ˈfjuəl/`        | n. 燃料<br>v. 加燃料；激起     |
| haze        | `/heɪz/`          | n. 薄雾；迷糊<br>v. 使迷糊     |
| shebang     | `/ʃəˈbæŋ/`        | n. 整个事情；设备             |
...
| ahold       | `/əˈhoʊld/`       | n. 抓住                  |
| conquer     | `/ˈkɑŋkər/`       | v. 征服；克服               |
| conquest    | `/ˈkɑŋkwɛst/`     | n. 征服；战利品              |
| reefer      | `/ˈrifər/`        | n. 大麻烟卷                |
| creepy      | `/ˈkripi/`        | adj. 令人毛骨悚然的           |
| homicide    | `/ˈhɑməˌsaɪd/`    | n. 谋杀                  |
| poly        | `/ˈpɑli/`         | adj. 多元的；多配偶的          |
| scenario    | `/sɪˈnɛrioʊ/`     | n. 情景；剧本               |
| thumb       | `/θʌm/`           | n. 拇指<br>v. 翻阅         |
...
| 单词          | 美式发音                 | 词性 + 汉语释义           |
|-------------|----------------------|---------------------|
| marvel      | `/ˈmɑrvəl/`          | v. 惊叹<br>n. 奇迹      |
| thrum       | `/θrʌm/`             | v. 轻敲；发出嗡嗡声         |
| wondrous    | `/ˈwʌndrəs/`         | adj. 奇妙的；令人惊叹的      |
| legible     | `/ˈlɛdʒəbəl/`        | adj. 清晰的；易读的        |
| warmth      | `/wɔrmθ/`            | n. 温暖；热情            |
| baton       | `/bəˈtɑn/`           | n. 指挥棒；接力棒          |
| rapid       | `/ˈræpɪd/`           | adj. 快速的            |
| moldy       | `/ˈmoʊldi/`          | adj. 发霉的            |
| butt        | `/bʌt/`              | n. 屁股；烟蒂            |
| geolocation | `/ˌdʒioʊloʊˈkeɪʃən/` | n. 地理位置             |
| sarcastic   | `/sɑrˈkæstɪk/`       | adj. 讽刺的            |
| reject      | `/rɪˈdʒɛkt/`         | v. 拒绝<br>n. 废品      |
| rejig       | `/rɪˈdʒɪɡ/`          | v. 调整               |
| debris      | `/dəˈbri/`           | n. 碎片；残骸            |
| pandemic    | `/pænˈdɛmɪk/`        | n. 大流行病             |
| vaccination | `/ˌvæksɪˈneɪʃən/`    | n. 接种疫苗             |
| squeeze     | `/skwiz/`            | v. 挤压<br>n. 挤压      |
| pacific     | `/pəˈsɪfɪk/`         | adj. 和平的；平静的        |
| juvenile    | `/ˈdʒuvəˌnaɪl/`      | adj. 青少年的；幼稚的<br>n. 青少年 |
| commit      | `/kəˈmɪt/`           | v. 承诺；犯（罪）；提交 ✅          |
...
|--------------|-------------------|------------------|
| tray         | `/treɪ/`          | n. 托盘            |
| approx       | `/əˈprɑks/`       | adj. 大约的         |
| quantity     | `/ˈkwɑntəti/`     | n. 数量            |
| rump         | `/rʌmp/`          | n. 臀部；尾部         |
| steak        | `/steɪk/`         | n. 牛排            |
| grass        | `/ɡræs/`          | n. 草             |
| flavoursome  | `/ˈfleɪvərsəm/`   | adj. 美味的         |
| gravy        | `/ˈɡreɪvi/`       | n. 肉汁            |
| hearty       | `/ˈhɑrti/`        | adj. 丰盛的；热情的     |
| stew         | `/stu/`           | n. 炖菜<br>v. 炖    |
| casserole    | `/ˈkæsəˌroʊl/`    | n. 砂锅菜；炖菜        |
| braise       | `/breɪz/`         | v. 炖；焖           |
| curry        | `/ˈkɜri/`         | n. 咖喱            |
...
| proverb    | `/ˈprɑvərb/`     | n. 谚语；格言                 |
| park       | `/pɑrk/`         | n. 公园；停车场<br>v. 停车       |
| intuitive  | `/ɪnˈtuɪtɪv/`    | adj. 直觉的；凭直觉的            |
| vivid      | `/ˈvɪvɪd/`       | adj. 生动的；鲜艳的             |
...
| detection  | `/dɪˈtɛkʃən/`    | n. 侦查；发现                 |
| carpenter  | `/ˈkɑrpəntər/`   | n. 木匠                    |
| cream      | `/krim/`         | n. 奶油；精华<br>v. 把...搅成奶油状 |
| nonchalant | `/ˌnɑnʃəˈlɑnt/`  | adj. 冷淡的；漠不关心的           |
| superb     | `/suˈpɜrb/`      | adj. 极好的                 |
| criticism  | `/ˈkrɪtɪˌsɪzəm/` | n. 批评；评论                 |
| chair      | `/tʃɛr/`         | n. 椅子；主席<br>v. 担任主席；主持   |
...
| 单词           | 美式发音            | 词性 + 汉语释义              |
|--------------|-----------------|------------------------|
| potential    | `/pəˈtenʃəl/`   | adj. 潜在的<br>n. 潜力      |
| load         | `/loʊd/`        | n. 负载；装载量<br>v. 装载     |
| ferocious    | `/fəˈroʊʃəs/`   | adj. 凶猛的；猛烈的           |
| trail        | `/treɪl/`       | n. 小径；踪迹<br>v. 拖；跟踪    |
| sail         | `/seɪl/`        | n. 帆；航行<br>v. 航行       |
| vessel       | `/ˈvɛsəl/`      | n. 船只；容器；血管            |
| aquarium     | `/əˈkwɛriəm/`   | n. 水族馆；鱼缸              |
| mechanism    | `/ˈmɛkəˌnɪzəm/` | n. 机制；机械装置             |
| subconscious | `/ˌsʌbˈkɑnʃəs/` | adj. 潜意识的<br>n. 潜意识    |
| wimp         | `/wɪmp/`        | n. 懦夫；软弱的人             |
| trial        | `/ˈtraɪəl/`     | n. 试验；审判               |
| six-pack     | `/sɪks pæk/`    | n. 六罐装；六块腹肌            |
| wheel        | `/wil/`         | n. 轮子；方向盘<br>v. 推动     |
| kidney       | `/ˈkɪdni/`      | n. 肾脏                  |
| grease       | `/ɡris/`        | n. 油脂<br>v. 涂油         |
| captive      | `/ˈkæptɪv/`     | adj. 被俘的；受控制的<br>n. 俘虏 |
| flame        | `/fleɪm/`       | n. 火焰；热情<br>v. 燃烧      |
| frank        | `/fræŋk/`       | adj. 坦率的               |
| snuff        | `/snʌf/`        | v. 掐灭；熄灭               |
| flinch       | `/flɪntʃ/`      | v. 退缩                  |
| wince        | `/wɪns/`        | v. 畏缩；皱眉               |
...
| garlic       | `/ˈɡɑrlɪk/`          | n. 大蒜             |
| block        | `/blɑːk/`            | n. 街区；块<br>v. 阻塞；阻挡 |
| blocker      | `/ˈblɑːkər/`         | n. 障碍物；阻挡者        |
| barn         | `/bɑrn/`             | n. 谷仓；牲口棚         |
| carton       | `/ˈkɑrtən/`          | n. 纸箱；纸盒          |
| trolley      | `/ˈtrɑli/`           | n. 手推车；电车         |
| dietary      | `/ˈdaɪəˌtɛri/`       | adj. 饮食的；膳食的      |
| deli         | `/ˈdɛli/`            | n. 熟食店            |
| frozen       | `/ˈfroʊzən/`         | adj. 冷冻的；冻结的      |
| pantry       | `/ˈpæntri/`          | n. 食品储藏室          |
| protein      | `/ˈproʊtin/`         | n. 蛋白质            |
| saturate     | `/ˈsætʃəˌreɪt/`      | v. 浸透；使饱和         |
| fibre        | `/ˈfaɪbər/`          | n. 纤维             |
| carbohydrate | `/ˌkɑrboʊˈhaɪdreɪt/` | n. 碳水化合物          |
| sodium       | `/ˈsoʊdiəm/`         | n. 钠              |
| nutritional  | `/nuˈtrɪʃənəl/`      | adj. 营养的          |
| edible       | `/ˈɛdəbəl/`          | adj. 可食用的         |
| portion      | `/ˈpɔrʃən/`          | n. 部分；一份          |
| claim        | `/kleɪm/`            | v. 声称；要求<br>n. 声明；索赔 |
...
| 单词           | 美式发音               | 词性 + 汉语释义         |
|--------------|--------------------|-------------------|
| authenticate | `/ɔˈθɛntɪˌkeɪt/`   | v. 验证；证明          |
...
| protein      | `/ˈproʊtin/`       | n. 蛋白质            |
| page         | `/peɪdʒ/`          | n. 页；呼叫           |
| bulge        | `/bʌldʒ/`          | v. 膨胀；凸出<br>n. 凸起 |
| badge        | `/bædʒ/`           | n. 徽章             |
| bridge       | `/brɪdʒ/`          | n. 桥              |
| dodge        | `/dɑdʒ/`           | v. 躲避             |
| judge        | `/dʒʌdʒ/`          | n. 法官；裁判<br>v. 判断；评判 |
| tube         | `/tub/`            | n. 管子             |
| morph        | `/mɔrf/`           | v. 变化             |
| stand        | `/stænd/`          | v. 站立；忍受<br>n. 台；立场   |
...
| eager           | `/ˈiɡər/`          | adj. 渴望的；热切的           |
| tongue          | `/tʌŋ/`            | n. 舌头；语言               |
| credit          | `/ˈkrɛdɪt/`        | n. 信用；学分<br>v. 归功于；相信  |
| retrieval       | `/rɪˈtriːvəl/`     | n. 检索，取回              |
| restaurant      | `/ˈrɛst(ə)ˌrɑnt/`  | n. 餐馆，饭店              |
| lively          | `/ˈlaɪvli/`        | adj. 活泼的，生动的          |
| bloom           | `/blum/`           | v. 开花，繁荣<br>n. 花，开花期  |
| classy          | `/ˈklæsi/`         | adj. 优雅的，有品位的         |
| camtono         | `/kæmˈtoʊnoʊ/`     | n. （科幻中的一个词，指一种容器）    |
| drive           | `/draɪv/`          | v. 驾驶，驱动<br>n. 驾车，驱动力 |
| electric        | `/ɪˈlɛktrɪk/`      | adj. 电的，电动的           |
| planet          | `/ˈplænɪt/`        | n. 行星                 |
| aeronautics     | `/ˌɛroʊˈnɔtɪks/`   | n. 航空学，航空             |
| strand          | `/strænd/`         | v. 使搁浅，使滞留<br>n. 一股，绞 |
| survive         | `/sərˈvaɪv/`       | v. 生存，幸存              |
| amuse           | `/əˈmjuz/`         | v. 娱乐，使发笑             |
| amusement       | `/əˈmjuzmənt/      | n. 娱乐；乐趣           |
...
| very      | `/ˈveri/`    | adv. 非常；十分<br>adj. 恰好的；正是的 | adv. She is very happy. (她非常高兴。)<br>It's very hot today. (今天非常热。)<br>adj. This is the very book I wanted. (这正是我想要的那本书。) |
...
| 单词         | 美式发音         | 词性 + 汉语释义                 |
|--------------|------------------|--------------------------------|
| place        | `/pleɪs/`        | n. 地方；位置<br>v. 放置       |
| disaster     | `/dɪˈzæstər/`    | n. 灾难                       |
| gather       | `/ˈɡæðər/`       | v. 收集；聚集                 |
| mushroom     | `/ˈmʌʃˌrum/`     | n. 蘑菇<br>v. 迅速增长         |
| eccentric    | `/ɪkˈsɛntrɪk/`   | adj. 古怪的<br>n. 古怪的人     |
| rot          | `/rɑt/`          | v. 腐烂<br>n. 腐烂            |
| steal        | `/stil/`         | v. 偷窃                       |
| shrunk       | `/ʃrʌŋk/`        | v. (shrink 的过去式和过去分词) 缩小 |
| buck         | `/bʌk/`          | n. 雄鹿；美元<br>v. 抵制；反抗    |
| musk         | `/mʌsk/`         | n. 麝香                       |
| heartfelt    | `/ˈhɑrtˌfɛlt/`   | adj. 衷心的                   |
| gratitude    | `/ˈɡrætɪˌtud/`   | n. 感激                       |
| bounty       | `/ˈbaʊnti/`      | n. 奖金；丰富                 |
| yard         | `/jɑrd/`         | n. 院子；码                   |
| cabinet      | `/ˈkæbənɪt/`     | n. 橱柜；内阁                 |
| energy       | `/ˈɛnərdʒi/`     | n. 能量；精力                 |
| thermometer  | `/θərˈmɑmɪtər/`  | n. 温度计                     |
| streak       | `/strik/`        | n. 条纹；一段时间<br>v. 留下条纹   |
| stub         | `/stʌb/`         | n. 存根；残根<br>v. 碰到；碰伤    |
| toe          | `/toʊ/`          | n. 脚趾<br>v. 用脚尖触        |
...
| upset         | `/ʌpˈsɛt/`       | v. 使心烦意乱<br>n. 心烦意乱<br>adj. 心烦的 |
| indistinct    | `/ˌɪndɪˈstɪŋkt/` | adj. 模糊的；不清楚的            |
| indispensable | `/ˌɪndɪˈspɛnsəbəl/`| adj. 必不可少的                 |
| indiscreet    | `/ˌɪndɪˈskrit/`  | adj. 轻率的；不慎重的            |
| discreet      | `/dɪˈskrit/`     | adj. 谨慎的；慎重的              |
| indiscretion  | `/ˌɪndɪˈskrɛʃən/`| n. 轻率；不慎重的行为             |
| judicial      | `/dʒuˈdɪʃəl/`    | adj. 司法的；法庭的              |
| contraction   | `/kənˈtrækʃən/`  | n. 收缩；缩写形式                |
| residual      | `/rɪˈzɪdʒuəl/`   | adj. 剩余的；残留的<br>n. 剩余；残渣 |
| reservation   | `/ˌrɛzərˈveɪʃən/`| n. 预订；保留                    |
| avail         | `/əˈveɪl/`       | v. 利用<br>n. 效用               |
...
| 单词          | 美式发音                 | 词性 + 汉语释义               |
|---------------|----------------------|-------------------------|
| educate       | `/ˈɛdʒəˌkeɪt/`       | v. 教育                   |
| education     | `/ˌɛdʒəˈkeɪʃən/`     | n. 教育                   |
| mentor        | `/ˈmɛntɔr/`          | n. 导师；顾问<br>v. 指导       |
| refuge        | `/ˈrɛfjudʒ/`         | n. 避难所；庇护               |
| sew           | `/soʊ/`              | v. 缝纫                   |
| sewing        | `/ˈsoʊɪŋ/`           | n. 缝纫                   |
...
| aerial        | `/ˈɛriəl/`           | adj. 空中的<br>n. 天线       |
| aeriality     | `/ˌɛriˈælɪti/`       | n. 空中状态                 |
| inanity       | `/ɪˈnænɪti/`         | n. 空洞；无意义               |
| manual        | `/ˈmænjuəl/`         | adj. 手工的<br>n. 手册       |
| minuend       | `/ˈmɪnjuˌɛnd/`       | n. 被减数                  |
| entrepreneur  | `/ˌɑntrəprəˈnɜr/`    | n. 企业家                  |
| rapist        | `/ˈreɪpɪst/`         | n. 强奸犯                  |
| communicate   | `/kəˈmjuːnɪkeɪt/`    | v. 交流；传达          ✅     |
| communication | `/kəˌmjuːnɪˈkeɪʃən/` | n. 交流；通讯      ✅         |
...
| numb           | `/nʌm/`              | adj. 麻木的<br>v. 使麻木     |
| blown          | `/bloʊn/`            | adj. 吹制的；爆炸的           |
| spasm          | `/ˈspæzəm/`          | n. 痉挛<br>v. 痉挛         |
| skull          | `/skʌl/`             | n. 头骨                  |
| cocky          | `/ˈkɑki/`            | adj. 自大的；骄傲的           |
| butthead       | `/ˈbʌtˌhɛd/`         | n. 笨蛋；傻瓜               |
| goner          | `/ˈɡɔnər/`           | n. 完蛋的人；无可救药的人         |
| conceal        | `/kənˈsil/`          | v. 隐藏；隐瞒               |
| rampage        | `/ˈræmˌpeɪdʒ/`       | n. 狂暴行为<br>v. 横冲直撞     |
| implement      | `/ˈɪmpləmənt/`       | v. 实施；执行<br>n. 工具      |
| implementation | `/ˌɪmplɪmənˈteɪʃən/` | n. 实施；执行               |
...
| evaluation | `/ɪˌvæljuˈeɪʃən/` | n. 评估              |
| specialise | `/ˈspɛʃəlaɪz/`    | v. 专门研究；专攻         |
| vacation   | `/veɪˈkeɪʃən/`    | n. 假期              |
| mandarin   | `/ˈmændərɪn/`     | n. 橘子；普通话          |
| tangerine  | `/ˌtændʒəˈrin/`   | n. 橘子              |
| mung       | `/mʌŋ/`           | n. 绿豆              |
| bean       | `/biːn/` ，       | n. 豆；豆类植物          |
| soak       | `/soʊk/`          | v. 浸泡；湿透<br>n. 浸泡  |
| pomelo     | `/ˈpɑməloʊ/`      | n. 柚子              |
| grapefruit | `/ˈɡreɪpfruːt/`   | n. 葡萄柚             |
| grape      | `/ɡreɪp/`         | n. 葡萄              |
| cilantro   | `/səˈlɑːntroʊ/`   | n. 芫荽叶             |
| coriander  | `/ˌkɔriˈændər/`   | n. 香菜              |
| snack      | `/snæk/`          | n. 小吃；零食<br>v. 吃零食 |
| snake      | `/sneɪk/`         | n. 蛇<br>v. 蜿蜒行进；蛇行 |
...
|---------------|----------------------|----------------------|
| kidnap        | `/ˈkɪdnæp/`          | v. 绑架                |
| kidnapping    | `/ˈkɪdnæpɪŋ/`        | n. 绑架                |
| minor         | `/ˈmaɪnər/`          | adj. 次要的；轻微的<br>n. 未成年人 |
| prosecute     | `/ˈprɑːsɪkjut/`      | v. 起诉；检举             |
| walkie        | `/ˈwɔki/`            | n. 对讲机               |
| itchy         | `/ˈɪtʃi/`            | adj. 发痒的             |
| bra           | `/brɑ/`              | n. 胸罩                |
| pinch         | `/pɪntʃ/`            | v. 捏；掐<br>n. 少量      |
| boob          | `/buːb/`             | n. （口语）傻瓜，蠢货；乳房      |
| inevitable    | `/ɪˈnevətəbəl/`      | adj. 不可避免的           |
| strangulation | `/ˌstræŋɡjəˈleɪʃən/` | n. 扼杀；勒死             |
| colossal      | `/kəˈlɑːsəl/`        | adj. 巨大的             |
| counselor     | `/ˈkaʊnsələr/`       | n. 顾问；辅导员            |
| massacre      | `/ˈmæsəkər/`         | n. 大屠杀<br>v. 屠杀      |
| sob           | `/sɑːb/`             | v. 哭泣；啜泣<br>n. 哭泣    |
| spot          | `/spɑːt/`            | n. 地点；斑点 <br>v. 发现 <br>adj. 现货的  |
| ignite        | `/ɪɡˈnaɪt/`          | v. 点燃；激起             |
| belt          | `/bɛlt/`             | n. 皮带；地带<br>v. 用带系   |
| karate        | `/kəˈrɑːti/`         | n. 空手道〔一种日本武术〕       |
| cockpit       | `/ˈkɑːkˌpɪt/`        | n.〔飞机、赛车的〕驾驶舱        |
...
| institute     | `/ˈɪnstɪtuːt/`     | n. 机构；研究所<br>v. 制定（制度﹑规则等）   |
| odd           | `/ɑːd/`            | adj. 奇怪的；奇数的                 |
| odds          | `/ɑːdz/`           | n. 可能性；几率                    |
| devious       | `/ˈdiːviəs/`       | adj. 狡猾的；迂回的                 |
| crate         | `/kreɪt/`          | n. 板条箱                       |
| scale         | `/skeɪl/`          | n. 规模；比例；音节；鳞片<br>v. 攀登      |
| pop           | `/pɑːp/`           | n. 流行音乐；汽水<br>v. 突然出现；发出砰的响声 |
| pope          | `/poʊp/`           | n. 教皇                        |
| scope         | `/skoʊp/`          | n. 范围；视野                     |
| inappropriate | `/ˌɪnəˈproʊpriət/` | adj. 不适当的                    |
| Indonesia     | `/ˌɪndoʊˈniːʒə/`   | n. 印度尼西亚                     |
| ban           | `/bæn/`            | n. 禁止<br>v. 禁止               |
| kindred       | `/ˈkɪn.drəd/`      | n. 亲属<br>adj. 同类的            |
| roulette      | `/ruːˈlɛt/`        | n. 轮盘赌                       |
| senior        | `/ˈsiːniər/`       | adj. 高级的；年长的<br>n. 老人；高年级学生  |
| junior        | `/ˈdʒuːniər/`      | adj. 级别低的；年少的<br>n. 晚辈；低年级学生 |
| pregnant      | `/ˈprɛɡnənt/`      | adj. 怀孕的                     |
| stool         | `/stuːl/`          | n. 凳子；粪便                     |
| mechanic      | `/məˈkænɪk/`       | n. 机械师；技工                    |
| invade        | `/ɪnˈveɪd/`        | v. 入侵；侵略                     |
| imperial      | `/ɪmˈpɪriəl/`      | adj. 帝国的                     |
| inaction      | `/ɪnˈækʃən/`       | n. 不作为                       |
...
| 单词            | 美式发音               | 词性 + 汉语释义               |
|---------------|--------------------|-------------------------|
| trance        | `/træns/`          | n. 出神；恍惚                |
| nightmare     | `/ˈnaɪtmɛr/`       | n. 噩梦                   |
| dungeon       | `/ˈdʌndʒən/`       | n. 地牢                   |
| cheat         | `/tʃiːt/`          | v. 欺骗<br>n. 骗子          |
| cheater       | `/ˈtʃiːtər/`       | n. 骗子                   |
| texture       | `/ˈtɛkstʃər/`      | n. 质地；纹理                |
| trim          | `/trɪm/`           | v. 修剪；削减<br>adj. 整齐的<br>n. 修剪 |
| course        | `/kɔrs/`           | n. 课程；过程；航线；一道菜<br>v. 流动 |
| hold          | `/hoʊld/`          | v. 持有；握住<br>n. 抓住；控制    |
| dignity       | `/ˈdɪɡnəti/`       | n. 尊严                   |
| fantastic     | `/fænˈtæstɪk/`     | adj. 极好的；奇异的            |
| asylum        | `/əˈsaɪləm/`       | n. 庇护；精神病院              |
| thesis        | `/ˈθiːsɪs/`        | n. 论文；论点                |
| paranoid      | `/ˈpɛrənɔɪd/`      | adj. 偏执的；多疑的            |
| schizophrenic | `/ˌskɪtsəˈfrɛnɪk/` | adj. 精神分裂症的<br>n. 精神分裂症患者 |
| outta         | `/ˈaʊtə/`          | 缩略语. 出自（out of 的非正式用法）  |
| fellow        | `/ˈfɛloʊ/`         | n. 同事；家伙                |
| jam           | `/dʒæm/`           | n. 果酱；拥堵<br>v. 塞满；卡住    |
| jar           | `/dʒɑːr/`          | n. 罐；广口瓶<br>v. 震动       |
| jug           | `/dʒʌɡ/`           | n. 壶；罐                  |
...
| 单词       | 美式发音       | 词性 + 汉语释义                 |
| ---------- | -------------- | ------------------------------ |
| bottle     | `/ˈbɑːtl/`     | n. 瓶子<br>v. 把...装入瓶中      |
| lid        | `/lɪd/`        | n. 盖子                        |
| mason      | `/ˈmeɪsən/`    | n. 泥瓦匠；石匠                 |
| vase       | `/veɪs/`       | n. 花瓶                        |
| vial       | `/vaɪəl/`      | n. (装香水、药水等的）小瓶           |
| spoonful   | `/ˈspuːnfʊl/`  | n. 一匙的量                    |
| chore      | `/tʃɔːr/`      | n. 家务；杂事                  |
| vast       | `/væst/`       | adj. 广阔的；巨大的              |
| rebellion  | `/rɪˈbɛljən/`  | n. 叛乱                        |
| rebellious | `/rɪˈbɛljəs/`  | adj. 叛逆的                    |
| startle    | `/ˈstɑːrtəl/`  | v. 惊吓                        |
| canister   | `/ˈkænɪstər/`  | n.  (装茶叶、咖啡、香烟等有盖的金属) 小罐 |
| flask      | `/flæsk/`      | n. 烧瓶；长颈瓶                 |
| survive    | `/sərˈvaɪv/`   | v. 生存；幸存                  |
| survivor   | `/sərˈvaɪvər/` | n. 幸存者                      |
| rainy      | `/ˈreɪni/`     | adj. 多雨的                    |
| rash       | `/ræʃ/`        | n. 皮疹<br>adj. 鲁莽的         |
| stick      | `/stɪk/`       | n. 棍；棒<br>v. 粘贴；坚持        |
| neighbour  | `/ˈneɪbər/`    | n. 邻居                        |
...
| 单词           | 美式发音             | 词性 + 汉语释义                |
|--------------|------------------|--------------------------|
| politician   | `/ˌpɑːləˈtɪʃən/` | n. 政治家，政客                |
| balloon      | `/bəˈluːn/`      | n. 气球<br>v. 膨胀           |
| expand       | `/ɪkˈspænd/`     | v. 扩展；扩大                 |
| expansion    | `/ɪkˈspænʃən/`   | n. 扩展；膨胀                 |
| extend       | `/ɪkˈstɛnd/`     | v. 延伸；扩展                 |
| extent       | `/ɪkˈstɛnt/`     | n. 程度；范围                 |
| vendor       | `/ˈvɛndər/`      | n. 小贩                    |
| lift         | `/lɪft/`         | v. 举起；提升<br>n. 电梯        |
| folio        | `/ˈfoʊlioʊ/`     | n. 对折本                   |
| household    | `/ˈhaʊshoʊld/`   | n. 家庭<br>adj. 家庭的        |
| action       | `/ˈækʃən/`       | n. 行动；行为；战斗              |
| appropriate  | `/əˈproʊpriət/`  | adj. 合适的；恰当的<br>v. 拨款；挪用 |
| hypnotic     | `/hɪpˈnɑːtɪk/`   | adj. 催眠的<br>n. 安眠药（可数）   |
| opponent     | `/əˈpoʊnənt/`   | n. 对手；反对者              |
| pledge       | `/pledʒ/`       | n. 保证；誓言；<br>v. 发誓；保证  |
| propaganda   | `/ˌprɑːpəˈɡændə/` | n. 宣传                  |
| propagate    | `/ˈprɑːpəɡeɪt/` | v. 传播；繁殖               |
| messiah      | `/məˈsaɪə/`     | n. 弥赛亚（犹太人所期待的救世主）；救世主 |
| sway         | `/sweɪ/`        | v. 摇摆；影响<br>n. 摇摆      |
| mock         | `/mɑːk/`         | v. 嘲笑；模仿<br>adj. 假的    |
| reverend     | `/ˈrevərənd/`    | n. 牧师                  |
| lethal       | `/ˈliːθəl/`      | adj. 致命的               |
| erg          | `/ɜːrɡ/`         | n. 尔格（能量单位）            |
| possess      | `/pəˈzes/`       | v. 拥有；具有               |
| plant        | `/plænt/`       | n. 植物；工厂<br>v. 种植      |
| nucleus      | `/ˈnuːkliəs/`     | n. 核；核心                |
| submarine    | `/ˌsʌbməˈriːn/`  | n. 潜水艇<br>adj. 海底的     |
...
| 单词          | 美式发音              | 词性 + 汉语释义            |
|-------------|-------------------|----------------------|
| top         | `/tɑp/`           | n. 顶部；上端<br>v. 超越<br>adj. 最高的 |
| goddamn     | `/ˈɡɑːdˌdæm/`     | adj. 该死的（粗俗用语）   |
| wonky       | `/ˈwɑŋki/`        | adj. 摇晃的；不稳定的     |
| capital     | `/ˈkæpɪtl/`       | n. 首都；资本；大写字母<br>adj. 大写的；重要的 |
| dig         | `/dɪɡ/`           | v. 挖掘<br>n. 挖掘       |
| digital     | `/ˈdɪdʒɪtl/`      | adj. 数字的；数码的       |
| digit       | `/ˈdɪdʒɪt/`       | n. 数字；数位；手指       |
| chop        | `/tʃɑːp/`         | v. 切；砍<br>n. 排骨     |
| plural      | `/ˈplʊrəl/`       | n. 复数<br>adj. 复数的   |
| somehow     | `/ˈsʌmhaʊ/`       | adv. 以某种方式；不知怎么地 |
| slay        | `/sleɪ/`          | v. 杀死；杀害             |
| hardwire    | `/ˈhɑrdˌwaɪər/`   | v. 硬接线；固有           |
| navy        | `/ˈneɪvi/`        | n. 海军；深蓝色            |
| envy        | `/ˈɛnvi/`         | n. 嫉妒<br />v. 嫉妒     |
| ludicrous   | `/ˈluːdəkrəs/`    | adj. 荒唐的；可笑的         |
| trillion    | `/ˈtrɪljən/`      | n. 万亿                |
| dome        | `/doʊm/`          | n. 圆顶                |
| bestow      | `/bɪˈstoʊ/`       | v. 赠予；授予（财产、权力或荣誉） |
| wreck       | `/rɛk/`           | v. 破坏；毁坏<br>n. 失事；残骸 |
| earther     | `/ˈɜːrθər/`       | n. 地球人 (非正式，常用于科幻)   |
| irradiation | `/ɪˌreɪdiˈeɪʃən/` | n. 照射；辐射             |
| irradiate   | `/ɪˈreɪdieɪt/`    | v. 照射；辐射             |
| unit        | `/ˈjuːnɪt/`       | n. 单位；单元；部件          |
| immune      | `/ɪˈmjuːn/`       | adj. 免疫的；不受影响的       |
| cretin      | `/ˈkriːtn/`       | n. 笨蛋；傻瓜             |
| consider    | `/kənˈsɪdər/`     | v. 考虑；认为             |
| gay         | `/ɡeɪ/`           | adj. 同性恋的；快乐的<br>n. 同性恋(者) |
...
| flash         | `/flæʃ/`           | v. 闪光；闪现<br> n. 闪光；闪光灯 |
...
| nest      | `/nest/`       | n. 窝；巢<br>v. 筑巢          |
| slot      | `/slɑːt/`      | n. 狭(xiá)槽；时间段           |
| boost     | `/buːst/`      | v. 提高；增强<br>n. 提高；增强     |
| warehouse | `/ˈwerhaʊs/`   | n. 仓库                    |
| roast     | `/roʊst/`      | v. 烤；炙<br>n. 烤肉          |
| anarchy   | `/ˈænərki/`    | n. 混乱；无秩序                |
| permanent | `/ˈpɜːrmənənt/` | adj. 永久的；永恒的             |
| rope      | `/roʊp/`       | n. 绳索<br>v. 捆，绑           |
| douche    | `/duːʃ/`       | n. 冲洗器；灌洗器               |
| miserable | `/ˈmɪzərəbəl/` | adj. 悲惨的；痛苦的             |
| settle    | `/ˈsetəl/`     | v. 解决；定居；沉淀              |
| settled   | `/ˈsɛtəld/`    | adj. 定居的，稳定的             |
| beneath   | `/bɪˈniːθ/`    | prep. 在...下方<br>adv. 在下方 |
...
| reverse        | `/rɪˈvɜːrs/`      | v. 逆转；倒车<br>n. 逆转；反面<br>adj. 相反的      |
| reversal       | `/rɪˈvɜːrsəl/`    | n. 逆转；倒退                              |
| revest         | `/rɪˈvɛst/`       | v. 重新授予                               |
| cub            | `/kʌb/`           | n. 幼兽                                 |
| cube           | `/kjuːb/`         | n. 立方体；立方(数学)；<br />v. 求...的立方，切成方块   |
| cubic          | `/ˈkjuːbɪk/`      | adj. 立方的                              |
| cubicle        | `/ˈkjuːbɪkəl/`    | n. 小隔间                                |
| pragmatist     | `/ˈpræɡmətɪst/`   | n. 实用主义者                              |
| pragmatism     | `/ˈpræɡmətɪzəm/`  | n. 实用主义                               |
| impressionable | `/ɪmˈpreʃənəbəl/` | adj. (尤因年轻而)易受影响的                     |
| accept         | `/ækˈsɛpt/`       | v. 接受；承认                              |
| accepted       | `/əkˈsɛptɪd/`     | v. 接受；承认（accept 的过去式和过去分词）<br>adj. 公认的；被认可的 |
| contentious    | `/kənˈtenʃəs/`    | adj. 有争议的；好争吵的                        |
| dyslexia       | `/dɪsˈleksiə/`    | n. 阅读障碍                               |
...
| beneficial   | `/ˌbenɪˈfɪʃəl/`              | adj. 有益的                     |
| sue          | `/suː/`                      | v. （尤指为要求赔偿金而）起诉；（尤因别无选择而）求和 |
| scheme       | `/skiːm/`                    | n. （造福他人的）计划；阴谋<br>v. 策划；密谋  |
| gentleman    | `/ˈdʒentəlmən/`              | n. 绅士；有教养的人                  |
| limp         | `/lɪmp/`                     | v. 跛行<br>n. 跛行<br>adj. 无力的   |
| generally    | `/ˈdʒɛnərəli/`               | adv. 通常；总体上                  |
| major        | `/ˈmeɪdʒər/`                 | adj. 主要的<br>n. 专业；少校<br>v. 主修 |
| tire         | `/taɪr/`                     | v. 使疲倦；厌倦<br>n. 轮胎（同 tyre）      |
| conduct      | `/kənˈdʌkt/` (v.)<br>`/ˈkɑndʌkt/` (n.) | v. 进行；指挥<br>n. 行为；管理     |
| digest       | `/daɪˈdʒɛst/` (v.)<br>`/ˈdaɪdʒɛst/` (n.) | v. 消化；理解<br>n. 摘要；文摘    |
...
| different       | `/ˈdɪfərənt/`            | adj. 不同的；各种各样的                 |
...
| spoil         | `/spɔɪl/`          | v. 破坏；宠坏；变质<br>n. 战利品             |
...
| 单词          | 美式发音                 | 词性 + 汉语释义             |
|---------------|----------------------|-----------------------|
| heave         | `/hiːv/`             | v. 举起；拖<br>n. 举起      |
| nauseous      | `/ˈnɔːʃəs/`          | adj. 恶心的              |
| greasy        | `/ˈɡriːsi/`          | adj. 油腻的              |
| count         | `/kaʊnt/`            | v. 计数<br>n. 计数；总数     |
| stimulate     | `/ˈstɪmjəleɪt/`      | v. 刺激；激励              |
| executive     | `/ɪɡˈzekjətɪv/`      | n. 主管<br>adj. 执行的     |
| interest      | `/ˈɪntrɪst/`         | n. 兴趣；利息<br>v. 使感兴趣   |
| impatient     | `/ɪmˈpeɪʃənt/`       | adj. 不耐烦的             |
| patient       | `/ˈpeɪʃənt/`         | n. 病人；患者<br>adj. 有耐心的 |
| complimentary | `/ˌkɑːmpləˈmentəri/` | adj. 免费的；赞美的          |
| elementary    | `/ˌeləˈmentri/`      | adj. 基本的；初级的          |
| podcast       | `/ˈpɑːdkæst/`        | n. 播客                 |
| fight         | `/faɪt/`             | v. 打架；战斗<br>n. 打架；战斗  |
| iconic        | `/aɪˈkɑːnɪk/`        | adj. 图标的；标志性的             |
| icon          | `/ˈaɪkɑːn/`          | n. 图标；偶像              |
| anal          | `/ˈeɪnəl/`           | adj. 肛门的              |
...
|--------------|---------------------------|-------------------------------|
| hawk         | `/hɔːk/`                  | n. 鹰；鹰派人物                     |
| avenue       | `/ˈævənjuː/`              | n. 大街；途径                      |
| imprint      | `/ˈɪmprɪnt/` (n.)<br>`/ɪmˈprɪnt/` (v.) | n. 印记；痕迹<br>v. 盖印             |
| evident      | `/ˈevɪdənt/`              | adj. 明显的；显而易见的                |
| profound     | `/prəˈfaʊnd/`             | adj. 深刻的；深远的                  |
| vaccinate    | `/ˈvæksəneɪt/`            | v. 接种疫苗                       |
| pianist      | `/ˈpiːənɪst/`             | n. 钢琴家                        |
| musician     | `/mjʊˈzɪʃən/`             | n. 音乐家                        |
| proficiency  | `/prəˈfɪʃənsi/`           | n. 熟练；精通                      |
| Japan        | `/dʒəˈpæn/`               | n. 日本                         |
| Japanese     | `/ˌdʒæpəˈniːz/`           | adj. 日本的；日本人的；日语的<br>n. 日本人；日语 |
| renovate     | `/ˈrɛnəˌveɪt/`            | v. 翻新；修复                      |
| renovation   | `/ˌrɛnəˈveɪʃən/`          | n. 翻新；修复                      |
| decorate     | `/ˈdekəreɪt/`             | v. 装饰；布置                      |
...
| 单词             | 美式发音                 | 词类 + 汉语释义              |
|----------------|----------------------|------------------------|
| rebel          | `/ˈrebəl/`           | n. 反叛者; v. 反抗          |
| crew           | `/kruː/`             | n. 全体人员(船、飞机)；一组工作人员   |
| tireless       | `/ˈtaɪərləs/`        | adj. 不知疲倦的             |
| throughout     | `/θruˈaʊt/`          | prep. 遍及；贯穿<br>adv. 始终 |
| festival       | `/ˈfestəvəl/`        | n. 节日；庆祝活动             |
| Christian      | `/ˈkrɪstʃən/`        | n. 基督徒；adj. 基督教的       |
| devout         | `/dɪˈvaʊt/`          | adj. 虔诚的               |
| religion       | `/rɪˈlɪdʒən/`        | n. 宗教，宗教信仰             |
| culture        | `/ˈkʌltʃər/`         | n. 文化                  |
| congregation   | `/ˌkɑːŋɡrəˈɡeɪʃn/`   | n. 会众〔在教堂里聚集的人群〕       |
| congratulation | `/kənˌɡrætʃəˈleɪʃn/` | n. 祝贺; 恭喜（通常用作复数）      |
| vital          | `/ˈvaɪtl/`           | adj. 至关重要的；充满活力的  |
| tourism        | `/ˈtʊrɪzəm/`         | n. 旅游业           |
| facial         | `/ˈfeɪʃəl/`          | adj. 面部的         |
| dwelling       | `/ˈdwɛlɪŋ/`          | n. 住宅            |
| forth          | `/ fɔːrθ/`           | adv. 向前；向外       |
| gaze           | `/ɡeɪz/`             | n. & v. 凝视       |
| soothing       | `/ˈsuːðɪŋ/`          | adj. 安慰的；舒缓的     |
| soothe         | `/suːð/`             | v. 安慰；减轻（痛苦）     |
| erode          | `/ɪˈroʊd/`           | v. 侵蚀；腐蚀         |
...
| 单词            | 美式发音                               | 词性 + 汉语释义                |
|-----------------|------------------------------------|--------------------------|
| rebel           | `/ˈrebəl/` (n.)<br>`/rɪˈbel/` (v.) | n. 反叛者<br>v. 反叛；造反       |
| crew            | `/kruː/`                           | n. 全体船员(船、飞机)；工作人员     |


| tireless        | `/ˈtaɪərləs/`                      | adj. 不知疲倦的               |
| throughout      | `/θruːˈaʊt/`                       | prep. 遍及；贯穿<br>adv. 自始至终 |
| festival        | `/ˈfestəvəl/`                      | n. 节日；庆典                 |
| Christian       | `/ˈkrɪstʃən/`                      | n. 基督徒<br>adj. 基督教的      |
| devout          | `/dɪˈvaʊt/`                        | adj. 虔诚的                 |
| religion        | `/rɪˈlɪdʒən/`                      | n. 宗教                    |
| culture         | `/ˈkʌltʃər/`                       | n. 文化                    |
| congregation    | `/ˌkɑːŋɡrɪˈɡeɪʃən/`                | n. 会众；集会                 |
| congratulation  | `/kənˌɡrætʃəˈleɪʃən/`              | n. 祝贺；恭喜（通常用作复数）         |
| vital           | `/ˈvaɪtəl/`                        | adj. 至关重要的；维持生命所必需的      |
| tourism         | `/ˈtʊərɪzəm/`                      | n. 旅游业                   |
| facial          | `/ˈfeɪʃəl/`                        | adj. 面部的<br>n. 面部护理      |
| dwelling        | `/ˈdwɛlɪŋ/`                        | n. 住所                    |
| forth           | `/fɔːrθ/`                          | adv. 向前；向外               |
| gaze            | `/ɡeɪz/`                           | v. 凝视<br>n. 凝视           |
| soothing        | `/ˈsuːðɪŋ/`                        | adj. 抚慰的；镇静的             |
| soothe          | `/suːð/`                           | v. 安慰；缓和                 |
| erode           | `/ɪˈroʊd/`                         | v. 侵蚀；腐蚀                 |
```
