...
| attribute   | `/ˈætrɪˌbjuːt/` (名词)  `/əˈtrɪˌbjuːt/` (动词) | n. 属性；特征；v. 归因于  |
...
| chief       | `/tʃiːf/`     | **chief** 作为形容词时，通常指最重要的或主要的；<br />作为名词时，指领导或主要负责人，如部门负责人或族长。 | adj. 主要的；n. 首领 |
...
| representation | `/ˌreprɪzenˈteɪʃən/` | n. 代表；表现 |
